...
PYTHONOCC_DEBUG_EXCEPTIONS = _ShapeCustom.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ShapeCustom.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ShapeCustom.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ShapeCustom.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ShapeCustom.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ShapeCustom_Modification_ForceRelease(t):
    return _ShapeCustom.Handle_ShapeCustom_Modification_ForceRelease(t)

def Handle_ShapeCustom_Modification_GetRefCount(t):
    return _ShapeCustom.Handle_ShapeCustom_Modification_GetRefCount(t)
...
def Handle_ShapeCustom_RestrictionParameters_ForceRelease(t):
    return _ShapeCustom.Handle_ShapeCustom_RestrictionParameters_ForceRelease(t)

def Handle_ShapeCustom_RestrictionParameters_GetRefCount(t):
    return _ShapeCustom.Handle_ShapeCustom_RestrictionParameters_GetRefCount(t)
...
def Handle_ShapeCustom_TrsfModification_ForceRelease(t):
    return _ShapeCustom.Handle_ShapeCustom_TrsfModification_ForceRelease(t)

def Handle_ShapeCustom_TrsfModification_GetRefCount(t):
    return _ShapeCustom.Handle_ShapeCustom_TrsfModification_GetRefCount(t)
...
def Handle_ShapeCustom_ConvertToBSpline_ForceRelease(t):
    return _ShapeCustom.Handle_ShapeCustom_ConvertToBSpline_ForceRelease(t)

def Handle_ShapeCustom_ConvertToBSpline_GetRefCount(t):
    return _ShapeCustom.Handle_ShapeCustom_ConvertToBSpline_GetRefCount(t)
...
def Handle_ShapeCustom_DirectModification_ForceRelease(t):
    return _ShapeCustom.Handle_ShapeCustom_DirectModification_ForceRelease(t)

def Handle_ShapeCustom_DirectModification_GetRefCount(t):
    return _ShapeCustom.Handle_ShapeCustom_DirectModification_GetRefCount(t)
