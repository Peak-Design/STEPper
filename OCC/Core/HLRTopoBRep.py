...
PYTHONOCC_DEBUG_EXCEPTIONS = _HLRTopoBRep.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _HLRTopoBRep.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _HLRTopoBRep.get_readable_method_name(method_name)

def get_exception_type(error):
    return _HLRTopoBRep.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _HLRTopoBRep.process_opencascade_exception(error, method_name, class_name)
...
def Handle_HLRTopoBRep_OutLiner_ForceRelease(t):
    return _HLRTopoBRep.Handle_HLRTopoBRep_OutLiner_ForceRelease(t)

def Handle_HLRTopoBRep_OutLiner_GetRefCount(t):
    return _HLRTopoBRep.Handle_HLRTopoBRep_OutLiner_GetRefCount(t)
