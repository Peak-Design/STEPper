...
PYTHONOCC_DEBUG_EXCEPTIONS = _CDM.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _CDM.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _CDM.get_readable_method_name(method_name)

def get_exception_type(error):
    return _CDM.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _CDM.process_opencascade_exception(error, method_name, class_name)
...
def Handle_CDM_Application_ForceRelease(t):
    return _CDM.Handle_CDM_Application_ForceRelease(t)

def Handle_CDM_Application_GetRefCount(t):
    return _CDM.Handle_CDM_Application_GetRefCount(t)
...
def Handle_CDM_Document_ForceRelease(t):
    return _CDM.Handle_CDM_Document_ForceRelease(t)

def Handle_CDM_Document_GetRefCount(t):
    return _CDM.Handle_CDM_Document_GetRefCount(t)
...
def Handle_CDM_MetaData_ForceRelease(t):
    return _CDM.Handle_CDM_MetaData_ForceRelease(t)

def Handle_CDM_MetaData_GetRefCount(t):
    return _CDM.Handle_CDM_MetaData_GetRefCount(t)
...
def Handle_CDM_Reference_ForceRelease(t):
    return _CDM.Handle_CDM_Reference_ForceRelease(t)

def Handle_CDM_Reference_GetRefCount(t):
    return _CDM.Handle_CDM_Reference_GetRefCount(t)
