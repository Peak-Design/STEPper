...
PYTHONOCC_DEBUG_EXCEPTIONS = _GeomEvaluator.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _GeomEvaluator.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _GeomEvaluator.get_readable_method_name(method_name)

def get_exception_type(error):
    return _GeomEvaluator.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _GeomEvaluator.process_opencascade_exception(error, method_name, class_name)
...
def Handle_GeomEvaluator_Curve_ForceRelease(t):
    return _GeomEvaluator.Handle_GeomEvaluator_Curve_ForceRelease(t)

def Handle_GeomEvaluator_Curve_GetRefCount(t):
    return _GeomEvaluator.Handle_GeomEvaluator_Curve_GetRefCount(t)
...
def Handle_GeomEvaluator_Surface_ForceRelease(t):
    return _GeomEvaluator.Handle_GeomEvaluator_Surface_ForceRelease(t)

def Handle_GeomEvaluator_Surface_GetRefCount(t):
    return _GeomEvaluator.Handle_GeomEvaluator_Surface_GetRefCount(t)
...
def Handle_GeomEvaluator_OffsetCurve_ForceRelease(t):
    return _GeomEvaluator.Handle_GeomEvaluator_OffsetCurve_ForceRelease(t)

def Handle_GeomEvaluator_OffsetCurve_GetRefCount(t):
    return _GeomEvaluator.Handle_GeomEvaluator_OffsetCurve_GetRefCount(t)
...
def Handle_GeomEvaluator_OffsetSurface_ForceRelease(t):
    return _GeomEvaluator.Handle_GeomEvaluator_OffsetSurface_ForceRelease(t)

def Handle_GeomEvaluator_OffsetSurface_GetRefCount(t):
    return _GeomEvaluator.Handle_GeomEvaluator_OffsetSurface_GetRefCount(t)
...
def Handle_GeomEvaluator_SurfaceOfExtrusion_ForceRelease(t):
    return _GeomEvaluator.Handle_GeomEvaluator_SurfaceOfExtrusion_ForceRelease(t)

def Handle_GeomEvaluator_SurfaceOfExtrusion_GetRefCount(t):
    return _GeomEvaluator.Handle_GeomEvaluator_SurfaceOfExtrusion_GetRefCount(t)
...
def Handle_GeomEvaluator_SurfaceOfRevolution_ForceRelease(t):
    return _GeomEvaluator.Handle_GeomEvaluator_SurfaceOfRevolution_ForceRelease(t)

def Handle_GeomEvaluator_SurfaceOfRevolution_GetRefCount(t):
    return _GeomEvaluator.Handle_GeomEvaluator_SurfaceOfRevolution_GetRefCount(t)
