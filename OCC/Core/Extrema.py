...
PYTHONOCC_DEBUG_EXCEPTIONS = _Extrema.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Extrema.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Extrema.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Extrema.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Extrema.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Extrema_ExtPExtS_ForceRelease(t):
    return _Extrema.Handle_Extrema_ExtPExtS_ForceRelease(t)

def Handle_Extrema_ExtPExtS_GetRefCount(t):
    return _Extrema.Handle_Extrema_ExtPExtS_GetRefCount(t)
...
def Handle_Extrema_ExtPRevS_ForceRelease(t):
    return _Extrema.Handle_Extrema_ExtPRevS_ForceRelease(t)

def Handle_Extrema_ExtPRevS_GetRefCount(t):
    return _Extrema.Handle_Extrema_ExtPRevS_GetRefCount(t)
...
def Handle_Extrema_HArray1OfPOnCurv_ForceRelease(t):
    return _Extrema.Handle_Extrema_HArray1OfPOnCurv_ForceRelease(t)

def Handle_Extrema_HArray1OfPOnCurv_GetRefCount(t):
    return _Extrema.Handle_Extrema_HArray1OfPOnCurv_GetRefCount(t)
...
def Handle_Extrema_HArray1OfPOnCurv2d_ForceRelease(t):
    return _Extrema.Handle_Extrema_HArray1OfPOnCurv2d_ForceRelease(t)

def Handle_Extrema_HArray1OfPOnCurv2d_GetRefCount(t):
    return _Extrema.Handle_Extrema_HArray1OfPOnCurv2d_GetRefCount(t)
...
def Handle_Extrema_HArray1OfPOnSurf_ForceRelease(t):
    return _Extrema.Handle_Extrema_HArray1OfPOnSurf_ForceRelease(t)

def Handle_Extrema_HArray1OfPOnSurf_GetRefCount(t):
    return _Extrema.Handle_Extrema_HArray1OfPOnSurf_GetRefCount(t)
...
def Handle_Extrema_HArray2OfPOnCurv_ForceRelease(t):
    return _Extrema.Handle_Extrema_HArray2OfPOnCurv_ForceRelease(t)

def Handle_Extrema_HArray2OfPOnCurv_GetRefCount(t):
    return _Extrema.Handle_Extrema_HArray2OfPOnCurv_GetRefCount(t)
...
def Handle_Extrema_HArray2OfPOnCurv2d_ForceRelease(t):
    return _Extrema.Handle_Extrema_HArray2OfPOnCurv2d_ForceRelease(t)

def Handle_Extrema_HArray2OfPOnCurv2d_GetRefCount(t):
    return _Extrema.Handle_Extrema_HArray2OfPOnCurv2d_GetRefCount(t)
...
def Handle_Extrema_HArray2OfPOnSurf_ForceRelease(t):
    return _Extrema.Handle_Extrema_HArray2OfPOnSurf_ForceRelease(t)

def Handle_Extrema_HArray2OfPOnSurf_GetRefCount(t):
    return _Extrema.Handle_Extrema_HArray2OfPOnSurf_GetRefCount(t)
