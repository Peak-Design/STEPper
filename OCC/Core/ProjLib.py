...
PYTHONOCC_DEBUG_EXCEPTIONS = _ProjLib.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ProjLib.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ProjLib.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ProjLib.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ProjLib.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ProjLib_CompProjectedCurve_ForceRelease(t):
    return _ProjLib.Handle_ProjLib_CompProjectedCurve_ForceRelease(t)

def Handle_ProjLib_CompProjectedCurve_GetRefCount(t):
    return _ProjLib.Handle_ProjLib_CompProjectedCurve_GetRefCount(t)
...
def Handle_ProjLib_ProjectOnPlane_ForceRelease(t):
    return _ProjLib.Handle_ProjLib_ProjectOnPlane_ForceRelease(t)

def Handle_ProjLib_ProjectOnPlane_GetRefCount(t):
    return _ProjLib.Handle_ProjLib_ProjectOnPlane_GetRefCount(t)
...
def Handle_ProjLib_ProjectedCurve_ForceRelease(t):
    return _ProjLib.Handle_ProjLib_ProjectedCurve_ForceRelease(t)

def Handle_ProjLib_ProjectedCurve_GetRefCount(t):
    return _ProjLib.Handle_ProjLib_ProjectedCurve_GetRefCount(t)
...
def Handle_ProjLib_HSequenceOfHSequenceOfPnt_ForceRelease(t):
    return _ProjLib.Handle_ProjLib_HSequenceOfHSequenceOfPnt_ForceRelease(t)

def Handle_ProjLib_HSequenceOfHSequenceOfPnt_GetRefCount(t):
    return _ProjLib.Handle_ProjLib_HSequenceOfHSequenceOfPnt_GetRefCount(t)
