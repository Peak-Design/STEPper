...
PYTHONOCC_DEBUG_EXCEPTIONS = _BinLDrivers.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BinLDrivers.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BinLDrivers.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BinLDrivers.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BinLDrivers.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BinLDrivers_DocumentRetrievalDriver_ForceRelease(t):
    return _BinLDrivers.Handle_BinLDrivers_DocumentRetrievalDriver_ForceRelease(t)

def Handle_BinLDrivers_DocumentRetrievalDriver_GetRefCount(t):
    return _BinLDrivers.Handle_BinLDrivers_DocumentRetrievalDriver_GetRefCount(t)
...
def Handle_BinLDrivers_DocumentStorageDriver_ForceRelease(t):
    return _BinLDrivers.Handle_BinLDrivers_DocumentStorageDriver_ForceRelease(t)

def Handle_BinLDrivers_DocumentStorageDriver_GetRefCount(t):
    return _BinLDrivers.Handle_BinLDrivers_DocumentStorageDriver_GetRefCount(t)
