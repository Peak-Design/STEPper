...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepMesh.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepMesh.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepMesh.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepMesh.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepMesh.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepMesh_Classifier_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_Classifier_ForceRelease(t)

def Handle_BRepMesh_Classifier_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_Classifier_GetRefCount(t)
...
def Handle_BRepMesh_DataStructureOfDelaun_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_DataStructureOfDelaun_ForceRelease(t)

def Handle_BRepMesh_DataStructureOfDelaun_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_DataStructureOfDelaun_GetRefCount(t)
...
def Handle_BRepMesh_Deflection_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_Deflection_ForceRelease(t)

def Handle_BRepMesh_Deflection_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_Deflection_GetRefCount(t)
...
def Handle_BRepMesh_DiscretRoot_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_DiscretRoot_ForceRelease(t)

def Handle_BRepMesh_DiscretRoot_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_DiscretRoot_GetRefCount(t)
...
def Handle_BRepMesh_FaceChecker_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_FaceChecker_ForceRelease(t)

def Handle_BRepMesh_FaceChecker_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_FaceChecker_GetRefCount(t)
...
def Handle_BRepMesh_MeshTool_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_MeshTool_ForceRelease(t)

def Handle_BRepMesh_MeshTool_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_MeshTool_GetRefCount(t)
...
def Handle_BRepMesh_SelectorOfDataStructureOfDelaun_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_SelectorOfDataStructureOfDelaun_ForceRelease(t)

def Handle_BRepMesh_SelectorOfDataStructureOfDelaun_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_SelectorOfDataStructureOfDelaun_GetRefCount(t)
...
def Handle_BRepMesh_ShapeTool_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_ShapeTool_ForceRelease(t)

def Handle_BRepMesh_ShapeTool_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_ShapeTool_GetRefCount(t)
...
def Handle_BRepMesh_VertexTool_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_VertexTool_ForceRelease(t)

def Handle_BRepMesh_VertexTool_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_VertexTool_GetRefCount(t)
...
def Handle_BRepMesh_IncrementalMesh_ForceRelease(t):
    return _BRepMesh.Handle_BRepMesh_IncrementalMesh_ForceRelease(t)

def Handle_BRepMesh_IncrementalMesh_GetRefCount(t):
    return _BRepMesh.Handle_BRepMesh_IncrementalMesh_GetRefCount(t)
