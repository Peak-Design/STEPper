...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_stepdimtol.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _StepDimTol.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _StepDimTol.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _StepDimTol.get_readable_method_name(method_name)

def get_exception_type(error):
    return _StepDimTol.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _StepDimTol.process_opencascade_exception(error, method_name, class_name)
...
def Handle_StepDimTol_CommonDatum_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_CommonDatum_ForceRelease(t)

def Handle_StepDimTol_CommonDatum_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_CommonDatum_GetRefCount(t)
...
def Handle_StepDimTol_Datum_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_Datum_ForceRelease(t)

def Handle_StepDimTol_Datum_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_Datum_GetRefCount(t)
...
def Handle_StepDimTol_DatumFeature_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumFeature_ForceRelease(t)

def Handle_StepDimTol_DatumFeature_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumFeature_GetRefCount(t)
...
def Handle_StepDimTol_DatumReference_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumReference_ForceRelease(t)

def Handle_StepDimTol_DatumReference_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumReference_GetRefCount(t)
...
def Handle_StepDimTol_DatumReferenceModifierWithValue_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumReferenceModifierWithValue_ForceRelease(t)

def Handle_StepDimTol_DatumReferenceModifierWithValue_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumReferenceModifierWithValue_GetRefCount(t)
...
def Handle_StepDimTol_DatumSystem_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumSystem_ForceRelease(t)

def Handle_StepDimTol_DatumSystem_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumSystem_GetRefCount(t)
...
def Handle_StepDimTol_DatumTarget_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumTarget_ForceRelease(t)

def Handle_StepDimTol_DatumTarget_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumTarget_GetRefCount(t)
...
def Handle_StepDimTol_GeneralDatumReference_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeneralDatumReference_ForceRelease(t)

def Handle_StepDimTol_GeneralDatumReference_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeneralDatumReference_GetRefCount(t)
...
def Handle_StepDimTol_GeometricTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricTolerance_ForceRelease(t)

def Handle_StepDimTol_GeometricTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricTolerance_GetRefCount(t)
...
def Handle_StepDimTol_GeometricToleranceRelationship_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceRelationship_ForceRelease(t)

def Handle_StepDimTol_GeometricToleranceRelationship_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceRelationship_GetRefCount(t)
...
def Handle_StepDimTol_RunoutZoneOrientation_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_RunoutZoneOrientation_ForceRelease(t)

def Handle_StepDimTol_RunoutZoneOrientation_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_RunoutZoneOrientation_GetRefCount(t)
...
def Handle_StepDimTol_SimpleDatumReferenceModifierMember_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_SimpleDatumReferenceModifierMember_ForceRelease(t)

def Handle_StepDimTol_SimpleDatumReferenceModifierMember_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_SimpleDatumReferenceModifierMember_GetRefCount(t)
...
def Handle_StepDimTol_ToleranceZone_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ToleranceZone_ForceRelease(t)

def Handle_StepDimTol_ToleranceZone_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ToleranceZone_GetRefCount(t)
...
def Handle_StepDimTol_ToleranceZoneDefinition_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ToleranceZoneDefinition_ForceRelease(t)

def Handle_StepDimTol_ToleranceZoneDefinition_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ToleranceZoneDefinition_GetRefCount(t)
...
def Handle_StepDimTol_ToleranceZoneForm_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ToleranceZoneForm_ForceRelease(t)

def Handle_StepDimTol_ToleranceZoneForm_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ToleranceZoneForm_GetRefCount(t)
...
def Handle_StepDimTol_CylindricityTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_CylindricityTolerance_ForceRelease(t)

def Handle_StepDimTol_CylindricityTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_CylindricityTolerance_GetRefCount(t)
...
def Handle_StepDimTol_DatumReferenceCompartment_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumReferenceCompartment_ForceRelease(t)

def Handle_StepDimTol_DatumReferenceCompartment_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumReferenceCompartment_GetRefCount(t)
...
def Handle_StepDimTol_DatumReferenceElement_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_DatumReferenceElement_ForceRelease(t)

def Handle_StepDimTol_DatumReferenceElement_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_DatumReferenceElement_GetRefCount(t)
...
def Handle_StepDimTol_FlatnessTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_FlatnessTolerance_ForceRelease(t)

def Handle_StepDimTol_FlatnessTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_FlatnessTolerance_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthDatRef_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRef_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthDatRef_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRef_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMod_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndModGeoTolAndPosTol_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthMod_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthMod_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthMod_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthMod_GetRefCount(t)
...
def Handle_StepDimTol_GeometricToleranceWithDatumReference_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithDatumReference_ForceRelease(t)

def Handle_StepDimTol_GeometricToleranceWithDatumReference_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithDatumReference_GetRefCount(t)
...
def Handle_StepDimTol_GeometricToleranceWithDefinedUnit_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithDefinedUnit_ForceRelease(t)

def Handle_StepDimTol_GeometricToleranceWithDefinedUnit_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithDefinedUnit_GetRefCount(t)
...
def Handle_StepDimTol_GeometricToleranceWithModifiers_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithModifiers_ForceRelease(t)

def Handle_StepDimTol_GeometricToleranceWithModifiers_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithModifiers_GetRefCount(t)
...
def Handle_StepDimTol_LineProfileTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_LineProfileTolerance_ForceRelease(t)

def Handle_StepDimTol_LineProfileTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_LineProfileTolerance_GetRefCount(t)
...
def Handle_StepDimTol_ModifiedGeometricTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ModifiedGeometricTolerance_ForceRelease(t)

def Handle_StepDimTol_ModifiedGeometricTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ModifiedGeometricTolerance_GetRefCount(t)
...
def Handle_StepDimTol_NonUniformZoneDefinition_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_NonUniformZoneDefinition_ForceRelease(t)

def Handle_StepDimTol_NonUniformZoneDefinition_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_NonUniformZoneDefinition_GetRefCount(t)
...
def Handle_StepDimTol_PlacedDatumTargetFeature_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_PlacedDatumTargetFeature_ForceRelease(t)

def Handle_StepDimTol_PlacedDatumTargetFeature_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_PlacedDatumTargetFeature_GetRefCount(t)
...
def Handle_StepDimTol_PositionTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_PositionTolerance_ForceRelease(t)

def Handle_StepDimTol_PositionTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_PositionTolerance_GetRefCount(t)
...
def Handle_StepDimTol_ProjectedZoneDefinition_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ProjectedZoneDefinition_ForceRelease(t)

def Handle_StepDimTol_ProjectedZoneDefinition_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ProjectedZoneDefinition_GetRefCount(t)
...
def Handle_StepDimTol_RoundnessTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_RoundnessTolerance_ForceRelease(t)

def Handle_StepDimTol_RoundnessTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_RoundnessTolerance_GetRefCount(t)
...
def Handle_StepDimTol_RunoutZoneDefinition_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_RunoutZoneDefinition_ForceRelease(t)

def Handle_StepDimTol_RunoutZoneDefinition_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_RunoutZoneDefinition_GetRefCount(t)
...
def Handle_StepDimTol_StraightnessTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_StraightnessTolerance_ForceRelease(t)

def Handle_StepDimTol_StraightnessTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_StraightnessTolerance_GetRefCount(t)
...
def Handle_StepDimTol_SurfaceProfileTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_SurfaceProfileTolerance_ForceRelease(t)

def Handle_StepDimTol_SurfaceProfileTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_SurfaceProfileTolerance_GetRefCount(t)
...
def Handle_StepDimTol_UnequallyDisposedGeometricTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_UnequallyDisposedGeometricTolerance_ForceRelease(t)

def Handle_StepDimTol_UnequallyDisposedGeometricTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_UnequallyDisposedGeometricTolerance_GetRefCount(t)
...
def Handle_StepDimTol_AngularityTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_AngularityTolerance_ForceRelease(t)

def Handle_StepDimTol_AngularityTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_AngularityTolerance_GetRefCount(t)
...
def Handle_StepDimTol_CircularRunoutTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_CircularRunoutTolerance_ForceRelease(t)

def Handle_StepDimTol_CircularRunoutTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_CircularRunoutTolerance_GetRefCount(t)
...
def Handle_StepDimTol_CoaxialityTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_CoaxialityTolerance_ForceRelease(t)

def Handle_StepDimTol_CoaxialityTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_CoaxialityTolerance_GetRefCount(t)
...
def Handle_StepDimTol_ConcentricityTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ConcentricityTolerance_ForceRelease(t)

def Handle_StepDimTol_ConcentricityTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ConcentricityTolerance_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndGeoTolWthMaxTol_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndUneqDisGeoTol_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndUneqDisGeoTol_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndUneqDisGeoTol_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthDatRefAndUneqDisGeoTol_GetRefCount(t)
...
def Handle_StepDimTol_GeoTolAndGeoTolWthMaxTol_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthMaxTol_ForceRelease(t)

def Handle_StepDimTol_GeoTolAndGeoTolWthMaxTol_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeoTolAndGeoTolWthMaxTol_GetRefCount(t)
...
def Handle_StepDimTol_GeometricToleranceWithDefinedAreaUnit_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithDefinedAreaUnit_ForceRelease(t)

def Handle_StepDimTol_GeometricToleranceWithDefinedAreaUnit_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithDefinedAreaUnit_GetRefCount(t)
...
def Handle_StepDimTol_GeometricToleranceWithMaximumTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithMaximumTolerance_ForceRelease(t)

def Handle_StepDimTol_GeometricToleranceWithMaximumTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_GeometricToleranceWithMaximumTolerance_GetRefCount(t)
...
def Handle_StepDimTol_ParallelismTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_ParallelismTolerance_ForceRelease(t)

def Handle_StepDimTol_ParallelismTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_ParallelismTolerance_GetRefCount(t)
...
def Handle_StepDimTol_PerpendicularityTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_PerpendicularityTolerance_ForceRelease(t)

def Handle_StepDimTol_PerpendicularityTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_PerpendicularityTolerance_GetRefCount(t)
...
def Handle_StepDimTol_SymmetryTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_SymmetryTolerance_ForceRelease(t)

def Handle_StepDimTol_SymmetryTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_SymmetryTolerance_GetRefCount(t)
...
def Handle_StepDimTol_TotalRunoutTolerance_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_TotalRunoutTolerance_ForceRelease(t)

def Handle_StepDimTol_TotalRunoutTolerance_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_TotalRunoutTolerance_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfDatumReference_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReference_ForceRelease(t)

def Handle_StepDimTol_HArray1OfDatumReference_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReference_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfDatumReferenceCompartment_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReferenceCompartment_ForceRelease(t)

def Handle_StepDimTol_HArray1OfDatumReferenceCompartment_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReferenceCompartment_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfDatumReferenceElement_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReferenceElement_ForceRelease(t)

def Handle_StepDimTol_HArray1OfDatumReferenceElement_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReferenceElement_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfDatumReferenceModifier_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReferenceModifier_ForceRelease(t)

def Handle_StepDimTol_HArray1OfDatumReferenceModifier_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumReferenceModifier_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfDatumSystemOrReference_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumSystemOrReference_ForceRelease(t)

def Handle_StepDimTol_HArray1OfDatumSystemOrReference_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfDatumSystemOrReference_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfGeometricToleranceModifier_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfGeometricToleranceModifier_ForceRelease(t)

def Handle_StepDimTol_HArray1OfGeometricToleranceModifier_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfGeometricToleranceModifier_GetRefCount(t)
...
def Handle_StepDimTol_HArray1OfToleranceZoneTarget_ForceRelease(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfToleranceZoneTarget_ForceRelease(t)

def Handle_StepDimTol_HArray1OfToleranceZoneTarget_GetRefCount(t):
    return _StepDimTol.Handle_StepDimTol_HArray1OfToleranceZoneTarget_GetRefCount(t)
