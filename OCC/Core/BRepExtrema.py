...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepExtrema.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepExtrema.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepExtrema.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepExtrema.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepExtrema.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepExtrema_TriangleSet_ForceRelease(t):
    return _BRepExtrema.Handle_BRepExtrema_TriangleSet_ForceRelease(t)

def Handle_BRepExtrema_TriangleSet_GetRefCount(t):
    return _BRepExtrema.Handle_BRepExtrema_TriangleSet_GetRefCount(t)
