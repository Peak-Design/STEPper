...
PYTHONOCC_DEBUG_EXCEPTIONS = _TDataStd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TDataStd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TDataStd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TDataStd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TDataStd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TDataStd_AsciiString_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_AsciiString_ForceRelease(t)

def Handle_TDataStd_AsciiString_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_AsciiString_GetRefCount(t)
...
def Handle_TDataStd_BooleanArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_BooleanArray_ForceRelease(t)

def Handle_TDataStd_BooleanArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_BooleanArray_GetRefCount(t)
...
def Handle_TDataStd_BooleanList_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_BooleanList_ForceRelease(t)

def Handle_TDataStd_BooleanList_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_BooleanList_GetRefCount(t)
...
def Handle_TDataStd_ByteArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_ByteArray_ForceRelease(t)

def Handle_TDataStd_ByteArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_ByteArray_GetRefCount(t)
...
def Handle_TDataStd_Current_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Current_ForceRelease(t)

def Handle_TDataStd_Current_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Current_GetRefCount(t)
...
def Handle_TDataStd_DeltaOnModificationOfByteArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfByteArray_ForceRelease(t)

def Handle_TDataStd_DeltaOnModificationOfByteArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfByteArray_GetRefCount(t)
...
def Handle_TDataStd_DeltaOnModificationOfExtStringArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfExtStringArray_ForceRelease(t)

def Handle_TDataStd_DeltaOnModificationOfExtStringArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfExtStringArray_GetRefCount(t)
...
def Handle_TDataStd_DeltaOnModificationOfIntArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfIntArray_ForceRelease(t)

def Handle_TDataStd_DeltaOnModificationOfIntArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfIntArray_GetRefCount(t)
...
def Handle_TDataStd_DeltaOnModificationOfIntPackedMap_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfIntPackedMap_ForceRelease(t)

def Handle_TDataStd_DeltaOnModificationOfIntPackedMap_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfIntPackedMap_GetRefCount(t)
...
def Handle_TDataStd_DeltaOnModificationOfRealArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfRealArray_ForceRelease(t)

def Handle_TDataStd_DeltaOnModificationOfRealArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_DeltaOnModificationOfRealArray_GetRefCount(t)
...
def Handle_TDataStd_Expression_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Expression_ForceRelease(t)

def Handle_TDataStd_Expression_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Expression_GetRefCount(t)
...
def Handle_TDataStd_ExtStringArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_ExtStringArray_ForceRelease(t)

def Handle_TDataStd_ExtStringArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_ExtStringArray_GetRefCount(t)
...
def Handle_TDataStd_ExtStringList_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_ExtStringList_ForceRelease(t)

def Handle_TDataStd_ExtStringList_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_ExtStringList_GetRefCount(t)
...
def Handle_TDataStd_HDataMapOfStringByte_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringByte_ForceRelease(t)

def Handle_TDataStd_HDataMapOfStringByte_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringByte_GetRefCount(t)
...
def Handle_TDataStd_HDataMapOfStringHArray1OfInteger_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringHArray1OfInteger_ForceRelease(t)

def Handle_TDataStd_HDataMapOfStringHArray1OfInteger_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringHArray1OfInteger_GetRefCount(t)
...
def Handle_TDataStd_HDataMapOfStringHArray1OfReal_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringHArray1OfReal_ForceRelease(t)

def Handle_TDataStd_HDataMapOfStringHArray1OfReal_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringHArray1OfReal_GetRefCount(t)
...
def Handle_TDataStd_HDataMapOfStringInteger_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringInteger_ForceRelease(t)

def Handle_TDataStd_HDataMapOfStringInteger_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringInteger_GetRefCount(t)
...
def Handle_TDataStd_HDataMapOfStringReal_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringReal_ForceRelease(t)

def Handle_TDataStd_HDataMapOfStringReal_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringReal_GetRefCount(t)
...
def Handle_TDataStd_HDataMapOfStringString_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringString_ForceRelease(t)

def Handle_TDataStd_HDataMapOfStringString_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HDataMapOfStringString_GetRefCount(t)
...
def Handle_TDataStd_IntPackedMap_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_IntPackedMap_ForceRelease(t)

def Handle_TDataStd_IntPackedMap_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_IntPackedMap_GetRefCount(t)
...
def Handle_TDataStd_Integer_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Integer_ForceRelease(t)

def Handle_TDataStd_Integer_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Integer_GetRefCount(t)
...
def Handle_TDataStd_IntegerArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_IntegerArray_ForceRelease(t)

def Handle_TDataStd_IntegerArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_IntegerArray_GetRefCount(t)
...
def Handle_TDataStd_IntegerList_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_IntegerList_ForceRelease(t)

def Handle_TDataStd_IntegerList_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_IntegerList_GetRefCount(t)
...
def Handle_TDataStd_NamedData_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_NamedData_ForceRelease(t)

def Handle_TDataStd_NamedData_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_NamedData_GetRefCount(t)
...
def Handle_TDataStd_Real_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Real_ForceRelease(t)

def Handle_TDataStd_Real_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Real_GetRefCount(t)
...
def Handle_TDataStd_RealArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_RealArray_ForceRelease(t)

def Handle_TDataStd_RealArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_RealArray_GetRefCount(t)
...
def Handle_TDataStd_RealList_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_RealList_ForceRelease(t)

def Handle_TDataStd_RealList_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_RealList_GetRefCount(t)
...
def Handle_TDataStd_ReferenceArray_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_ReferenceArray_ForceRelease(t)

def Handle_TDataStd_ReferenceArray_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_ReferenceArray_GetRefCount(t)
...
def Handle_TDataStd_ReferenceList_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_ReferenceList_ForceRelease(t)

def Handle_TDataStd_ReferenceList_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_ReferenceList_GetRefCount(t)
...
def Handle_TDataStd_TreeNode_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_TreeNode_ForceRelease(t)

def Handle_TDataStd_TreeNode_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_TreeNode_GetRefCount(t)
...
def Handle_TDataStd_UAttribute_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_UAttribute_ForceRelease(t)

def Handle_TDataStd_UAttribute_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_UAttribute_GetRefCount(t)
...
def Handle_TDataStd_Variable_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Variable_ForceRelease(t)

def Handle_TDataStd_Variable_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Variable_GetRefCount(t)
...
def Handle_TDataStd_Comment_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Comment_ForceRelease(t)

def Handle_TDataStd_Comment_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Comment_GetRefCount(t)
...
def Handle_TDataStd_Directory_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Directory_ForceRelease(t)

def Handle_TDataStd_Directory_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Directory_GetRefCount(t)
...
def Handle_TDataStd_Name_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Name_ForceRelease(t)

def Handle_TDataStd_Name_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Name_GetRefCount(t)
...
def Handle_TDataStd_NoteBook_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_NoteBook_ForceRelease(t)

def Handle_TDataStd_NoteBook_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_NoteBook_GetRefCount(t)
...
def Handle_TDataStd_Relation_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Relation_ForceRelease(t)

def Handle_TDataStd_Relation_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Relation_GetRefCount(t)
...
def Handle_TDataStd_Tick_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_Tick_ForceRelease(t)

def Handle_TDataStd_Tick_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_Tick_GetRefCount(t)
...
def Handle_TDataStd_HLabelArray1_ForceRelease(t):
    return _TDataStd.Handle_TDataStd_HLabelArray1_ForceRelease(t)

def Handle_TDataStd_HLabelArray1_GetRefCount(t):
    return _TDataStd.Handle_TDataStd_HLabelArray1_GetRefCount(t)
