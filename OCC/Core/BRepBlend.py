...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepBlend.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepBlend.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepBlend.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepBlend.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepBlend.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepBlend_AppFuncRoot_ForceRelease(t):
    return _BRepBlend.Handle_BRepBlend_AppFuncRoot_ForceRelease(t)

def Handle_BRepBlend_AppFuncRoot_GetRefCount(t):
    return _BRepBlend.Handle_BRepBlend_AppFuncRoot_GetRefCount(t)
...
def Handle_BRepBlend_Line_ForceRelease(t):
    return _BRepBlend.Handle_BRepBlend_Line_ForceRelease(t)

def Handle_BRepBlend_Line_GetRefCount(t):
    return _BRepBlend.Handle_BRepBlend_Line_GetRefCount(t)
...
def Handle_BRepBlend_AppFunc_ForceRelease(t):
    return _BRepBlend.Handle_BRepBlend_AppFunc_ForceRelease(t)

def Handle_BRepBlend_AppFunc_GetRefCount(t):
    return _BRepBlend.Handle_BRepBlend_AppFunc_GetRefCount(t)
...
def Handle_BRepBlend_AppFuncRst_ForceRelease(t):
    return _BRepBlend.Handle_BRepBlend_AppFuncRst_ForceRelease(t)

def Handle_BRepBlend_AppFuncRst_GetRefCount(t):
    return _BRepBlend.Handle_BRepBlend_AppFuncRst_GetRefCount(t)
...
def Handle_BRepBlend_AppFuncRstRst_ForceRelease(t):
    return _BRepBlend.Handle_BRepBlend_AppFuncRstRst_ForceRelease(t)

def Handle_BRepBlend_AppFuncRstRst_GetRefCount(t):
    return _BRepBlend.Handle_BRepBlend_AppFuncRstRst_GetRefCount(t)
