...
PYTHONOCC_DEBUG_EXCEPTIONS = _TopOpeBRep.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TopOpeBRep.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TopOpeBRep.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TopOpeBRep.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TopOpeBRep.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TopOpeBRep_FFDumper_ForceRelease(t):
    return _TopOpeBRep.Handle_TopOpeBRep_FFDumper_ForceRelease(t)

def Handle_TopOpeBRep_FFDumper_GetRefCount(t):
    return _TopOpeBRep.Handle_TopOpeBRep_FFDumper_GetRefCount(t)
...
def Handle_TopOpeBRep_Hctxee2d_ForceRelease(t):
    return _TopOpeBRep.Handle_TopOpeBRep_Hctxee2d_ForceRelease(t)

def Handle_TopOpeBRep_Hctxee2d_GetRefCount(t):
    return _TopOpeBRep.Handle_TopOpeBRep_Hctxee2d_GetRefCount(t)
...
def Handle_TopOpeBRep_Hctxff2d_ForceRelease(t):
    return _TopOpeBRep.Handle_TopOpeBRep_Hctxff2d_ForceRelease(t)

def Handle_TopOpeBRep_Hctxff2d_GetRefCount(t):
    return _TopOpeBRep.Handle_TopOpeBRep_Hctxff2d_GetRefCount(t)
...
def Handle_TopOpeBRep_HArray1OfLineInter_ForceRelease(t):
    return _TopOpeBRep.Handle_TopOpeBRep_HArray1OfLineInter_ForceRelease(t)

def Handle_TopOpeBRep_HArray1OfLineInter_GetRefCount(t):
    return _TopOpeBRep.Handle_TopOpeBRep_HArray1OfLineInter_GetRefCount(t)
...
def Handle_TopOpeBRep_HArray1OfVPointInter_ForceRelease(t):
    return _TopOpeBRep.Handle_TopOpeBRep_HArray1OfVPointInter_ForceRelease(t)

def Handle_TopOpeBRep_HArray1OfVPointInter_GetRefCount(t):
    return _TopOpeBRep.Handle_TopOpeBRep_HArray1OfVPointInter_GetRefCount(t)
