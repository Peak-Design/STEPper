...
PYTHONOCC_DEBUG_EXCEPTIONS = _Bisector.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Bisector.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Bisector.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Bisector.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Bisector.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Bisector_Curve_ForceRelease(t):
    return _Bisector.Handle_Bisector_Curve_ForceRelease(t)

def Handle_Bisector_Curve_GetRefCount(t):
    return _Bisector.Handle_Bisector_Curve_GetRefCount(t)
...
def Handle_Bisector_BisecAna_ForceRelease(t):
    return _Bisector.Handle_Bisector_BisecAna_ForceRelease(t)

def Handle_Bisector_BisecAna_GetRefCount(t):
    return _Bisector.Handle_Bisector_BisecAna_GetRefCount(t)
...
def Handle_Bisector_BisecCC_ForceRelease(t):
    return _Bisector.Handle_Bisector_BisecCC_ForceRelease(t)

def Handle_Bisector_BisecCC_GetRefCount(t):
    return _Bisector.Handle_Bisector_BisecCC_GetRefCount(t)
...
def Handle_Bisector_BisecPC_ForceRelease(t):
    return _Bisector.Handle_Bisector_BisecPC_ForceRelease(t)

def Handle_Bisector_BisecPC_GetRefCount(t):
    return _Bisector.Handle_Bisector_BisecPC_GetRefCount(t)
