...
PYTHONOCC_DEBUG_EXCEPTIONS = _IntCurvesFace.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _IntCurvesFace.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _IntCurvesFace.get_readable_method_name(method_name)

def get_exception_type(error):
    return _IntCurvesFace.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _IntCurvesFace.process_opencascade_exception(error, method_name, class_name)
...
def Handle_IntCurvesFace_Intersector_ForceRelease(t):
    return _IntCurvesFace.Handle_IntCurvesFace_Intersector_ForceRelease(t)

def Handle_IntCurvesFace_Intersector_GetRefCount(t):
    return _IntCurvesFace.Handle_IntCurvesFace_Intersector_GetRefCount(t)
