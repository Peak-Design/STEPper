...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_xcafprs.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _XCAFPrs.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XCAFPrs.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XCAFPrs.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XCAFPrs.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XCAFPrs.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XCAFPrs_AISObject_ForceRelease(t):
    return _XCAFPrs.Handle_XCAFPrs_AISObject_ForceRelease(t)

def Handle_XCAFPrs_AISObject_GetRefCount(t):
    return _XCAFPrs.Handle_XCAFPrs_AISObject_GetRefCount(t)
...
def Handle_XCAFPrs_Driver_ForceRelease(t):
    return _XCAFPrs.Handle_XCAFPrs_Driver_ForceRelease(t)

def Handle_XCAFPrs_Driver_GetRefCount(t):
    return _XCAFPrs.Handle_XCAFPrs_Driver_GetRefCount(t)
...
def Handle_XCAFPrs_Texture_ForceRelease(t):
    return _XCAFPrs.Handle_XCAFPrs_Texture_ForceRelease(t)

def Handle_XCAFPrs_Texture_GetRefCount(t):
    return _XCAFPrs.Handle_XCAFPrs_Texture_GetRefCount(t)
