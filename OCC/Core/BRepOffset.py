...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepOffset.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepOffset.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepOffset.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepOffset.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepOffset.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepOffset_SimpleOffset_ForceRelease(t):
    return _BRepOffset.Handle_BRepOffset_SimpleOffset_ForceRelease(t)

def Handle_BRepOffset_SimpleOffset_GetRefCount(t):
    return _BRepOffset.Handle_BRepOffset_SimpleOffset_GetRefCount(t)
