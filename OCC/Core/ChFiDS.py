...
PYTHONOCC_DEBUG_EXCEPTIONS = _ChFiDS.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ChFiDS.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ChFiDS.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ChFiDS.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ChFiDS.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ChFiDS_ElSpine_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_ElSpine_ForceRelease(t)

def Handle_ChFiDS_ElSpine_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_ElSpine_GetRefCount(t)
...
def Handle_ChFiDS_Spine_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_Spine_ForceRelease(t)

def Handle_ChFiDS_Spine_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_Spine_GetRefCount(t)
...
def Handle_ChFiDS_Stripe_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_Stripe_ForceRelease(t)

def Handle_ChFiDS_Stripe_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_Stripe_GetRefCount(t)
...
def Handle_ChFiDS_SurfData_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_SurfData_ForceRelease(t)

def Handle_ChFiDS_SurfData_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_SurfData_GetRefCount(t)
...
def Handle_ChFiDS_ChamfSpine_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_ChamfSpine_ForceRelease(t)

def Handle_ChFiDS_ChamfSpine_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_ChamfSpine_GetRefCount(t)
...
def Handle_ChFiDS_FilSpine_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_FilSpine_ForceRelease(t)

def Handle_ChFiDS_FilSpine_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_FilSpine_GetRefCount(t)
...
def Handle_ChFiDS_SecHArray1_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_SecHArray1_ForceRelease(t)

def Handle_ChFiDS_SecHArray1_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_SecHArray1_GetRefCount(t)
...
def Handle_ChFiDS_HData_ForceRelease(t):
    return _ChFiDS.Handle_ChFiDS_HData_ForceRelease(t)

def Handle_ChFiDS_HData_GetRefCount(t):
    return _ChFiDS.Handle_ChFiDS_HData_GetRefCount(t)
