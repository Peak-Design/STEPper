...
PYTHONOCC_DEBUG_EXCEPTIONS = _TDocStd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TDocStd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TDocStd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TDocStd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TDocStd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TDocStd_Application_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_Application_ForceRelease(t)

def Handle_TDocStd_Application_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_Application_GetRefCount(t)
...
def Handle_TDocStd_ApplicationDelta_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_ApplicationDelta_ForceRelease(t)

def Handle_TDocStd_ApplicationDelta_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_ApplicationDelta_GetRefCount(t)
...
def Handle_TDocStd_CompoundDelta_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_CompoundDelta_ForceRelease(t)

def Handle_TDocStd_CompoundDelta_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_CompoundDelta_GetRefCount(t)
...
def Handle_TDocStd_Document_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_Document_ForceRelease(t)

def Handle_TDocStd_Document_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_Document_GetRefCount(t)
...
def Handle_TDocStd_Modified_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_Modified_ForceRelease(t)

def Handle_TDocStd_Modified_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_Modified_GetRefCount(t)
...
def Handle_TDocStd_MultiTransactionManager_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_MultiTransactionManager_ForceRelease(t)

def Handle_TDocStd_MultiTransactionManager_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_MultiTransactionManager_GetRefCount(t)
...
def Handle_TDocStd_Owner_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_Owner_ForceRelease(t)

def Handle_TDocStd_Owner_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_Owner_GetRefCount(t)
...
def Handle_TDocStd_XLink_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_XLink_ForceRelease(t)

def Handle_TDocStd_XLink_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_XLink_GetRefCount(t)
...
def Handle_TDocStd_XLinkRoot_ForceRelease(t):
    return _TDocStd.Handle_TDocStd_XLinkRoot_ForceRelease(t)

def Handle_TDocStd_XLinkRoot_GetRefCount(t):
    return _TDocStd.Handle_TDocStd_XLinkRoot_GetRefCount(t)
