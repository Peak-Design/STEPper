...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_media.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _Media.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Media.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Media.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Media.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Media.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Media_BufferPool_ForceRelease(t):
    return _Media.Handle_Media_BufferPool_ForceRelease(t)

def Handle_Media_BufferPool_GetRefCount(t):
    return _Media.Handle_Media_BufferPool_GetRefCount(t)
...
def Handle_Media_CodecContext_ForceRelease(t):
    return _Media.Handle_Media_CodecContext_ForceRelease(t)

def Handle_Media_CodecContext_GetRefCount(t):
    return _Media.Handle_Media_CodecContext_GetRefCount(t)
...
def Handle_Media_FormatContext_ForceRelease(t):
    return _Media.Handle_Media_FormatContext_ForceRelease(t)

def Handle_Media_FormatContext_GetRefCount(t):
    return _Media.Handle_Media_FormatContext_GetRefCount(t)
...
def Handle_Media_Frame_ForceRelease(t):
    return _Media.Handle_Media_Frame_ForceRelease(t)

def Handle_Media_Frame_GetRefCount(t):
    return _Media.Handle_Media_Frame_GetRefCount(t)
...
def Handle_Media_Packet_ForceRelease(t):
    return _Media.Handle_Media_Packet_ForceRelease(t)

def Handle_Media_Packet_GetRefCount(t):
    return _Media.Handle_Media_Packet_GetRefCount(t)
...
def Handle_Media_PlayerContext_ForceRelease(t):
    return _Media.Handle_Media_PlayerContext_ForceRelease(t)

def Handle_Media_PlayerContext_GetRefCount(t):
    return _Media.Handle_Media_PlayerContext_GetRefCount(t)
...
def Handle_Media_Scaler_ForceRelease(t):
    return _Media.Handle_Media_Scaler_ForceRelease(t)

def Handle_Media_Scaler_GetRefCount(t):
    return _Media.Handle_Media_Scaler_GetRefCount(t)
...
def Handle_Media_Timer_ForceRelease(t):
    return _Media.Handle_Media_Timer_ForceRelease(t)

def Handle_Media_Timer_GetRefCount(t):
    return _Media.Handle_Media_Timer_GetRefCount(t)
