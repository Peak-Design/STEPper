...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepTopAdaptor.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepTopAdaptor.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepTopAdaptor.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepTopAdaptor.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepTopAdaptor.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepTopAdaptor_HVertex_ForceRelease(t):
    return _BRepTopAdaptor.Handle_BRepTopAdaptor_HVertex_ForceRelease(t)

def Handle_BRepTopAdaptor_HVertex_GetRefCount(t):
    return _BRepTopAdaptor.Handle_BRepTopAdaptor_HVertex_GetRefCount(t)
...
def Handle_BRepTopAdaptor_TopolTool_ForceRelease(t):
    return _BRepTopAdaptor.Handle_BRepTopAdaptor_TopolTool_ForceRelease(t)

def Handle_BRepTopAdaptor_TopolTool_GetRefCount(t):
    return _BRepTopAdaptor.Handle_BRepTopAdaptor_TopolTool_GetRefCount(t)
