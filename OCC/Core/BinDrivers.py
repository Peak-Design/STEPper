...
PYTHONOCC_DEBUG_EXCEPTIONS = _BinDrivers.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BinDrivers.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BinDrivers.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BinDrivers.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BinDrivers.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BinDrivers_DocumentRetrievalDriver_ForceRelease(t):
    return _BinDrivers.Handle_BinDrivers_DocumentRetrievalDriver_ForceRelease(t)

def Handle_BinDrivers_DocumentRetrievalDriver_GetRefCount(t):
    return _BinDrivers.Handle_BinDrivers_DocumentRetrievalDriver_GetRefCount(t)
...
def Handle_BinDrivers_DocumentStorageDriver_ForceRelease(t):
    return _BinDrivers.Handle_BinDrivers_DocumentStorageDriver_ForceRelease(t)

def Handle_BinDrivers_DocumentStorageDriver_GetRefCount(t):
    return _BinDrivers.Handle_BinDrivers_DocumentStorageDriver_GetRefCount(t)
