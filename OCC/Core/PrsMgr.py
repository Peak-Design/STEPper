...
PYTHONOCC_DEBUG_EXCEPTIONS = _PrsMgr.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _PrsMgr.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _PrsMgr.get_readable_method_name(method_name)

def get_exception_type(error):
    return _PrsMgr.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _PrsMgr.process_opencascade_exception(error, method_name, class_name)
...
def Handle_PrsMgr_PresentableObject_ForceRelease(t):
    return _PrsMgr.Handle_PrsMgr_PresentableObject_ForceRelease(t)

def Handle_PrsMgr_PresentableObject_GetRefCount(t):
    return _PrsMgr.Handle_PrsMgr_PresentableObject_GetRefCount(t)
...
def Handle_PrsMgr_Presentation_ForceRelease(t):
    return _PrsMgr.Handle_PrsMgr_Presentation_ForceRelease(t)

def Handle_PrsMgr_Presentation_GetRefCount(t):
    return _PrsMgr.Handle_PrsMgr_Presentation_GetRefCount(t)
...
def Handle_PrsMgr_PresentationManager_ForceRelease(t):
    return _PrsMgr.Handle_PrsMgr_PresentationManager_ForceRelease(t)

def Handle_PrsMgr_PresentationManager_GetRefCount(t):
    return _PrsMgr.Handle_PrsMgr_PresentationManager_GetRefCount(t)
...
class PrsMgr_PresentableObject(OCC.Core.Standard.Standard_Transient):
    ...
    def RecomputeTransformation(self, *args):
        ...
        """
        return _PrsMgr.PrsMgr_PresentableObject_RecomputeTransformation(self, *args)
