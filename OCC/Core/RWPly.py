...
PYTHONOCC_DEBUG_EXCEPTIONS = _RWPly.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _RWPly.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _RWPly.get_readable_method_name(method_name)

def get_exception_type(error):
    return _RWPly.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _RWPly.process_opencascade_exception(error, method_name, class_name)
...
def Handle_RWPly_CafWriter_ForceRelease(t):
    return _RWPly.Handle_RWPly_CafWriter_ForceRelease(t)

def Handle_RWPly_CafWriter_GetRefCount(t):
    return _RWPly.Handle_RWPly_CafWriter_GetRefCount(t)
