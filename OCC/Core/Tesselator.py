...
PYTHONOCC_DEBUG_EXCEPTIONS = _Tesselator.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Tesselator.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Tesselator.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Tesselator.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Tesselator.process_opencascade_exception(error, method_name, class_name)
...
class ShapeTesselator(object):
    ...
    def SetDeviation(self, aDeviation):
        r"""SetDeviation(ShapeTesselator self, double aDeviation)"""
        return _Tesselator.ShapeTesselator_SetDeviation(self, aDeviation)

    def GetDeviation(self):
        r"""GetDeviation(ShapeTesselator self) -> double"""
        return _Tesselator.ShapeTesselator_GetDeviation(self)

    def VerticesList(self):
        r"""VerticesList(ShapeTesselator self) -> float const *"""
        return _Tesselator.ShapeTesselator_VerticesList(self)

    def NormalsList(self):
        r"""NormalsList(ShapeTesselator self) -> float const *"""
        return _Tesselator.ShapeTesselator_NormalsList(self)
