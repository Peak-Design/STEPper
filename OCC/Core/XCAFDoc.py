...
PYTHONOCC_DEBUG_EXCEPTIONS = _XCAFDoc.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XCAFDoc.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XCAFDoc.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XCAFDoc.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XCAFDoc.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XCAFDoc_Area_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Area_ForceRelease(t)

def Handle_XCAFDoc_Area_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Area_GetRefCount(t)
...
def Handle_XCAFDoc_AssemblyGraph_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_AssemblyGraph_ForceRelease(t)

def Handle_XCAFDoc_AssemblyGraph_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_AssemblyGraph_GetRefCount(t)
...
def Handle_XCAFDoc_AssemblyItemRef_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_AssemblyItemRef_ForceRelease(t)

def Handle_XCAFDoc_AssemblyItemRef_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_AssemblyItemRef_GetRefCount(t)
...
def Handle_XCAFDoc_Centroid_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Centroid_ForceRelease(t)

def Handle_XCAFDoc_Centroid_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Centroid_GetRefCount(t)
...
def Handle_XCAFDoc_ClippingPlaneTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_ClippingPlaneTool_ForceRelease(t)

def Handle_XCAFDoc_ClippingPlaneTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_ClippingPlaneTool_GetRefCount(t)
...
def Handle_XCAFDoc_Color_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Color_ForceRelease(t)

def Handle_XCAFDoc_Color_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Color_GetRefCount(t)
...
def Handle_XCAFDoc_ColorTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_ColorTool_ForceRelease(t)

def Handle_XCAFDoc_ColorTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_ColorTool_GetRefCount(t)
...
def Handle_XCAFDoc_Datum_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Datum_ForceRelease(t)

def Handle_XCAFDoc_Datum_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Datum_GetRefCount(t)
...
def Handle_XCAFDoc_DimTol_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_DimTol_ForceRelease(t)

def Handle_XCAFDoc_DimTol_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_DimTol_GetRefCount(t)
...
def Handle_XCAFDoc_DimTolTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_DimTolTool_ForceRelease(t)

def Handle_XCAFDoc_DimTolTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_DimTolTool_GetRefCount(t)
...
def Handle_XCAFDoc_Dimension_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Dimension_ForceRelease(t)

def Handle_XCAFDoc_Dimension_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Dimension_GetRefCount(t)
...
def Handle_XCAFDoc_DocumentTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_DocumentTool_ForceRelease(t)

def Handle_XCAFDoc_DocumentTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_DocumentTool_GetRefCount(t)
...
def Handle_XCAFDoc_GraphNode_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_GraphNode_ForceRelease(t)

def Handle_XCAFDoc_GraphNode_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_GraphNode_GetRefCount(t)
...
def Handle_XCAFDoc_LayerTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_LayerTool_ForceRelease(t)

def Handle_XCAFDoc_LayerTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_LayerTool_GetRefCount(t)
...
def Handle_XCAFDoc_LengthUnit_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_LengthUnit_ForceRelease(t)

def Handle_XCAFDoc_LengthUnit_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_LengthUnit_GetRefCount(t)
...
def Handle_XCAFDoc_Location_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Location_ForceRelease(t)

def Handle_XCAFDoc_Location_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Location_GetRefCount(t)
...
def Handle_XCAFDoc_Material_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Material_ForceRelease(t)

def Handle_XCAFDoc_Material_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Material_GetRefCount(t)
...
def Handle_XCAFDoc_MaterialTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_MaterialTool_ForceRelease(t)

def Handle_XCAFDoc_MaterialTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_MaterialTool_GetRefCount(t)
...
def Handle_XCAFDoc_Note_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Note_ForceRelease(t)

def Handle_XCAFDoc_Note_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Note_GetRefCount(t)
...
def Handle_XCAFDoc_NotesTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_NotesTool_ForceRelease(t)

def Handle_XCAFDoc_NotesTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_NotesTool_GetRefCount(t)
...
def Handle_XCAFDoc_ShapeMapTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_ShapeMapTool_ForceRelease(t)

def Handle_XCAFDoc_ShapeMapTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_ShapeMapTool_GetRefCount(t)
...
def Handle_XCAFDoc_ShapeTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_ShapeTool_ForceRelease(t)

def Handle_XCAFDoc_ShapeTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_ShapeTool_GetRefCount(t)
...
def Handle_XCAFDoc_View_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_View_ForceRelease(t)

def Handle_XCAFDoc_View_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_View_GetRefCount(t)
...
def Handle_XCAFDoc_ViewTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_ViewTool_ForceRelease(t)

def Handle_XCAFDoc_ViewTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_ViewTool_GetRefCount(t)
...
def Handle_XCAFDoc_VisMaterial_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_VisMaterial_ForceRelease(t)

def Handle_XCAFDoc_VisMaterial_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_VisMaterial_GetRefCount(t)
...
def Handle_XCAFDoc_VisMaterialTool_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_VisMaterialTool_ForceRelease(t)

def Handle_XCAFDoc_VisMaterialTool_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_VisMaterialTool_GetRefCount(t)
...
def Handle_XCAFDoc_Volume_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_Volume_ForceRelease(t)

def Handle_XCAFDoc_Volume_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_Volume_GetRefCount(t)
...
def Handle_XCAFDoc_NoteBinData_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_NoteBinData_ForceRelease(t)

def Handle_XCAFDoc_NoteBinData_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_NoteBinData_GetRefCount(t)
...
def Handle_XCAFDoc_NoteComment_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_NoteComment_ForceRelease(t)

def Handle_XCAFDoc_NoteComment_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_NoteComment_GetRefCount(t)
...
def Handle_XCAFDoc_NoteBalloon_ForceRelease(t):
    return _XCAFDoc.Handle_XCAFDoc_NoteBalloon_ForceRelease(t)

def Handle_XCAFDoc_NoteBalloon_GetRefCount(t):
    return _XCAFDoc.Handle_XCAFDoc_NoteBalloon_GetRefCount(t)
...
class XCAFDoc_ColorTool(object):
    ...
    def GetColor(self, *args):
        ...
        """
        # Patched: TDF_Label overloads are static in OCCT 7.9+ and don't expect self
    ...
    def GetColors(self, *args):
        ...
        """
        # Patched: static method in OCCT 7.9+
...
class XCAFDoc_Editor(object):
    ...
    def FilterShapeTree(*args):
        ...
        """
        return _XCAFDoc.XCAFDoc_Editor_FilterShapeTree(*args)

    @staticmethod
    def GetChildShapeLabels(*args):
        r"""
        ...
        """
        return _XCAFDoc.XCAFDoc_Editor_GetChildShapeLabels(*args)

    @staticmethod
    def GetParentShapeLabels(*args):
        r"""
        ...
        """
        return _XCAFDoc.XCAFDoc_Editor_GetParentShapeLabels(*args)
