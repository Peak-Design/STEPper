...
PYTHONOCC_DEBUG_EXCEPTIONS = _XCAFApp.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XCAFApp.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XCAFApp.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XCAFApp.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XCAFApp.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XCAFApp_Application_ForceRelease(t):
    return _XCAFApp.Handle_XCAFApp_Application_ForceRelease(t)

def Handle_XCAFApp_Application_GetRefCount(t):
    return _XCAFApp.Handle_XCAFApp_Application_GetRefCount(t)
