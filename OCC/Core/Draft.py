...
PYTHONOCC_DEBUG_EXCEPTIONS = _Draft.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Draft.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Draft.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Draft.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Draft.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Draft_Modification_ForceRelease(t):
    return _Draft.Handle_Draft_Modification_ForceRelease(t)

def Handle_Draft_Modification_GetRefCount(t):
    return _Draft.Handle_Draft_Modification_GetRefCount(t)
