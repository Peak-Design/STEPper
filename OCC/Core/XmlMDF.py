...
PYTHONOCC_DEBUG_EXCEPTIONS = _XmlMDF.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XmlMDF.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XmlMDF.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XmlMDF.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XmlMDF.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XmlMDF_ADriver_ForceRelease(t):
    return _XmlMDF.Handle_XmlMDF_ADriver_ForceRelease(t)

def Handle_XmlMDF_ADriver_GetRefCount(t):
    return _XmlMDF.Handle_XmlMDF_ADriver_GetRefCount(t)
...
def Handle_XmlMDF_ADriverTable_ForceRelease(t):
    return _XmlMDF.Handle_XmlMDF_ADriverTable_ForceRelease(t)

def Handle_XmlMDF_ADriverTable_GetRefCount(t):
    return _XmlMDF.Handle_XmlMDF_ADriverTable_GetRefCount(t)
...
def Handle_XmlMDF_DerivedDriver_ForceRelease(t):
    return _XmlMDF.Handle_XmlMDF_DerivedDriver_ForceRelease(t)

def Handle_XmlMDF_DerivedDriver_GetRefCount(t):
    return _XmlMDF.Handle_XmlMDF_DerivedDriver_GetRefCount(t)
...
def Handle_XmlMDF_ReferenceDriver_ForceRelease(t):
    return _XmlMDF.Handle_XmlMDF_ReferenceDriver_ForceRelease(t)

def Handle_XmlMDF_ReferenceDriver_GetRefCount(t):
    return _XmlMDF.Handle_XmlMDF_ReferenceDriver_GetRefCount(t)
...
def Handle_XmlMDF_TagSourceDriver_ForceRelease(t):
    return _XmlMDF.Handle_XmlMDF_TagSourceDriver_ForceRelease(t)

def Handle_XmlMDF_TagSourceDriver_GetRefCount(t):
    return _XmlMDF.Handle_XmlMDF_TagSourceDriver_GetRefCount(t)
