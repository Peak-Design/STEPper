...
PYTHONOCC_DEBUG_EXCEPTIONS = _Visualization.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Visualization.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Visualization.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Visualization.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Visualization.process_opencascade_exception(error, method_name, class_name)
...
def Handle_AIS_InteractiveContext_ForceRelease(t):
    return _Visualization.Handle_AIS_InteractiveContext_ForceRelease(t)

def Handle_AIS_InteractiveContext_GetRefCount(t):
    return _Visualization.Handle_AIS_InteractiveContext_GetRefCount(t)
...
def Handle_V3d_View_ForceRelease(t):
    return _Visualization.Handle_V3d_View_ForceRelease(t)

def Handle_V3d_View_GetRefCount(t):
    return _Visualization.Handle_V3d_View_GetRefCount(t)
...
def Handle_V3d_Viewer_ForceRelease(t):
    return _Visualization.Handle_V3d_Viewer_ForceRelease(t)

def Handle_V3d_Viewer_GetRefCount(t):
    return _Visualization.Handle_V3d_Viewer_GetRefCount(t)
...
def Handle_Graphic3d_Camera_ForceRelease(t):
    return _Visualization.Handle_Graphic3d_Camera_ForceRelease(t)

def Handle_Graphic3d_Camera_GetRefCount(t):
    return _Visualization.Handle_Graphic3d_Camera_GetRefCount(t)
...
def Handle_Graphic3d_StructureManager_ForceRelease(t):
    return _Visualization.Handle_Graphic3d_StructureManager_ForceRelease(t)

def Handle_Graphic3d_StructureManager_GetRefCount(t):
    return _Visualization.Handle_Graphic3d_StructureManager_GetRefCount(t)
class Display3d(object):
    ...
    def SetCoreProfileEnabled(self, theEnabled):
        r"""SetCoreProfileEnabled(Display3d self, bool theEnabled)"""
        return _Visualization.Display3d_SetCoreProfileEnabled(self, theEnabled)

    def SetContextCompatible(self, theCompatible):
        r"""SetContextCompatible(Display3d self, bool theCompatible)"""
        return _Visualization.Display3d_SetContextCompatible(self, theCompatible)

    def SetFfpEnable(self, theEnabled):
        r"""SetFfpEnable(Display3d self, bool theEnabled)"""
        return _Visualization.Display3d_SetFfpEnable(self, theEnabled)

    def SetBuffersNoSwap(self, theNoSwap):
        r"""SetBuffersNoSwap(Display3d self, bool theNoSwap)"""
        return _Visualization.Display3d_SetBuffersNoSwap(self, theNoSwap)

    def SetSRGBDisabled(self, theDisabled):
        r"""SetSRGBDisabled(Display3d self, bool theDisabled)"""
        return _Visualization.Display3d_SetSRGBDisabled(self, theDisabled)
