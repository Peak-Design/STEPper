...
PYTHONOCC_DEBUG_EXCEPTIONS = _Standard.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Standard.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Standard.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Standard.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Standard.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Standard_Transient_ForceRelease(t):
    return _Standard.Handle_Standard_Transient_ForceRelease(t)

def Handle_Standard_Transient_GetRefCount(t):
    return _Standard.Handle_Standard_Transient_GetRefCount(t)
...
def Handle_Standard_Failure_ForceRelease(t):
    return _Standard.Handle_Standard_Failure_ForceRelease(t)

def Handle_Standard_Failure_GetRefCount(t):
    return _Standard.Handle_Standard_Failure_GetRefCount(t)
...
def Handle_Standard_OutOfMemory_ForceRelease(t):
    return _Standard.Handle_Standard_OutOfMemory_ForceRelease(t)

def Handle_Standard_OutOfMemory_GetRefCount(t):
    return _Standard.Handle_Standard_OutOfMemory_GetRefCount(t)
...
def Handle_Standard_Persistent_ForceRelease(t):
    return _Standard.Handle_Standard_Persistent_ForceRelease(t)

def Handle_Standard_Persistent_GetRefCount(t):
    return _Standard.Handle_Standard_Persistent_GetRefCount(t)
...
def Handle_Standard_Type_ForceRelease(t):
    return _Standard.Handle_Standard_Type_ForceRelease(t)

def Handle_Standard_Type_GetRefCount(t):
    return _Standard.Handle_Standard_Type_GetRefCount(t)
...
class Standard_Transient(object):
    ...
    def __eq_wrapper__(self, other):
        return _Standard.Standard_Transient___eq_wrapper__(self, other)

    def __ne_wrapper__(self, other):
        return _Standard.Standard_Transient___ne_wrapper__(self, other)
