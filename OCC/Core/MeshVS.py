...
PYTHONOCC_DEBUG_EXCEPTIONS = _MeshVS.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _MeshVS.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _MeshVS.get_readable_method_name(method_name)

def get_exception_type(error):
    return _MeshVS.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _MeshVS.process_opencascade_exception(error, method_name, class_name)
...
def Handle_MeshVS_CommonSensitiveEntity_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_CommonSensitiveEntity_ForceRelease(t)

def Handle_MeshVS_CommonSensitiveEntity_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_CommonSensitiveEntity_GetRefCount(t)
...
def Handle_MeshVS_DataSource_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_DataSource_ForceRelease(t)

def Handle_MeshVS_DataSource_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_DataSource_GetRefCount(t)
...
def Handle_MeshVS_Drawer_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_Drawer_ForceRelease(t)

def Handle_MeshVS_Drawer_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_Drawer_GetRefCount(t)
...
def Handle_MeshVS_DummySensitiveEntity_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_DummySensitiveEntity_ForceRelease(t)

def Handle_MeshVS_DummySensitiveEntity_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_DummySensitiveEntity_GetRefCount(t)
...
def Handle_MeshVS_Mesh_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_Mesh_ForceRelease(t)

def Handle_MeshVS_Mesh_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_Mesh_GetRefCount(t)
...
def Handle_MeshVS_MeshEntityOwner_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_MeshEntityOwner_ForceRelease(t)

def Handle_MeshVS_MeshEntityOwner_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_MeshEntityOwner_GetRefCount(t)
...
def Handle_MeshVS_MeshOwner_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_MeshOwner_ForceRelease(t)

def Handle_MeshVS_MeshOwner_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_MeshOwner_GetRefCount(t)
...
def Handle_MeshVS_PrsBuilder_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_PrsBuilder_ForceRelease(t)

def Handle_MeshVS_PrsBuilder_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_PrsBuilder_GetRefCount(t)
...
def Handle_MeshVS_SensitiveFace_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_SensitiveFace_ForceRelease(t)

def Handle_MeshVS_SensitiveFace_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_SensitiveFace_GetRefCount(t)
...
def Handle_MeshVS_SensitiveMesh_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_SensitiveMesh_ForceRelease(t)

def Handle_MeshVS_SensitiveMesh_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_SensitiveMesh_GetRefCount(t)
...
def Handle_MeshVS_SensitivePolyhedron_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_SensitivePolyhedron_ForceRelease(t)

def Handle_MeshVS_SensitivePolyhedron_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_SensitivePolyhedron_GetRefCount(t)
...
def Handle_MeshVS_SensitiveQuad_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_SensitiveQuad_ForceRelease(t)

def Handle_MeshVS_SensitiveQuad_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_SensitiveQuad_GetRefCount(t)
...
def Handle_MeshVS_SensitiveSegment_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_SensitiveSegment_ForceRelease(t)

def Handle_MeshVS_SensitiveSegment_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_SensitiveSegment_GetRefCount(t)
...
def Handle_MeshVS_DataSource3D_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_DataSource3D_ForceRelease(t)

def Handle_MeshVS_DataSource3D_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_DataSource3D_GetRefCount(t)
...
def Handle_MeshVS_DeformedDataSource_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_DeformedDataSource_ForceRelease(t)

def Handle_MeshVS_DeformedDataSource_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_DeformedDataSource_GetRefCount(t)
...
def Handle_MeshVS_ElementalColorPrsBuilder_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_ElementalColorPrsBuilder_ForceRelease(t)

def Handle_MeshVS_ElementalColorPrsBuilder_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_ElementalColorPrsBuilder_GetRefCount(t)
...
def Handle_MeshVS_MeshPrsBuilder_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_MeshPrsBuilder_ForceRelease(t)

def Handle_MeshVS_MeshPrsBuilder_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_MeshPrsBuilder_GetRefCount(t)
...
def Handle_MeshVS_NodalColorPrsBuilder_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_NodalColorPrsBuilder_ForceRelease(t)

def Handle_MeshVS_NodalColorPrsBuilder_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_NodalColorPrsBuilder_GetRefCount(t)
...
def Handle_MeshVS_TextPrsBuilder_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_TextPrsBuilder_ForceRelease(t)

def Handle_MeshVS_TextPrsBuilder_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_TextPrsBuilder_GetRefCount(t)
...
def Handle_MeshVS_VectorPrsBuilder_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_VectorPrsBuilder_ForceRelease(t)

def Handle_MeshVS_VectorPrsBuilder_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_VectorPrsBuilder_GetRefCount(t)
...
def Handle_MeshVS_HArray1OfSequenceOfInteger_ForceRelease(t):
    return _MeshVS.Handle_MeshVS_HArray1OfSequenceOfInteger_ForceRelease(t)

def Handle_MeshVS_HArray1OfSequenceOfInteger_GetRefCount(t):
    return _MeshVS.Handle_MeshVS_HArray1OfSequenceOfInteger_GetRefCount(t)
