...
PYTHONOCC_DEBUG_EXCEPTIONS = _GeomTools.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _GeomTools.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _GeomTools.get_readable_method_name(method_name)

def get_exception_type(error):
    return _GeomTools.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _GeomTools.process_opencascade_exception(error, method_name, class_name)
...
def Handle_GeomTools_UndefinedTypeHandler_ForceRelease(t):
    return _GeomTools.Handle_GeomTools_UndefinedTypeHandler_ForceRelease(t)

def Handle_GeomTools_UndefinedTypeHandler_GetRefCount(t):
    return _GeomTools.Handle_GeomTools_UndefinedTypeHandler_GetRefCount(t)
