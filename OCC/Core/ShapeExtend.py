...
PYTHONOCC_DEBUG_EXCEPTIONS = _ShapeExtend.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ShapeExtend.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ShapeExtend.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ShapeExtend.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ShapeExtend.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ShapeExtend_BasicMsgRegistrator_ForceRelease(t):
    return _ShapeExtend.Handle_ShapeExtend_BasicMsgRegistrator_ForceRelease(t)

def Handle_ShapeExtend_BasicMsgRegistrator_GetRefCount(t):
    return _ShapeExtend.Handle_ShapeExtend_BasicMsgRegistrator_GetRefCount(t)
...
def Handle_ShapeExtend_ComplexCurve_ForceRelease(t):
    return _ShapeExtend.Handle_ShapeExtend_ComplexCurve_ForceRelease(t)

def Handle_ShapeExtend_ComplexCurve_GetRefCount(t):
    return _ShapeExtend.Handle_ShapeExtend_ComplexCurve_GetRefCount(t)
...
def Handle_ShapeExtend_CompositeSurface_ForceRelease(t):
    return _ShapeExtend.Handle_ShapeExtend_CompositeSurface_ForceRelease(t)

def Handle_ShapeExtend_CompositeSurface_GetRefCount(t):
    return _ShapeExtend.Handle_ShapeExtend_CompositeSurface_GetRefCount(t)
...
def Handle_ShapeExtend_WireData_ForceRelease(t):
    return _ShapeExtend.Handle_ShapeExtend_WireData_ForceRelease(t)

def Handle_ShapeExtend_WireData_GetRefCount(t):
    return _ShapeExtend.Handle_ShapeExtend_WireData_GetRefCount(t)
...
def Handle_ShapeExtend_MsgRegistrator_ForceRelease(t):
    return _ShapeExtend.Handle_ShapeExtend_MsgRegistrator_ForceRelease(t)

def Handle_ShapeExtend_MsgRegistrator_GetRefCount(t):
    return _ShapeExtend.Handle_ShapeExtend_MsgRegistrator_GetRefCount(t)
