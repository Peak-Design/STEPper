...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepCheck.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepCheck.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepCheck.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepCheck.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepCheck.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepCheck_Result_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Result_ForceRelease(t)

def Handle_BRepCheck_Result_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Result_GetRefCount(t)
...
def Handle_BRepCheck_Edge_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Edge_ForceRelease(t)

def Handle_BRepCheck_Edge_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Edge_GetRefCount(t)
...
def Handle_BRepCheck_Face_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Face_ForceRelease(t)

def Handle_BRepCheck_Face_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Face_GetRefCount(t)
...
def Handle_BRepCheck_Shell_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Shell_ForceRelease(t)

def Handle_BRepCheck_Shell_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Shell_GetRefCount(t)
...
def Handle_BRepCheck_Solid_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Solid_ForceRelease(t)

def Handle_BRepCheck_Solid_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Solid_GetRefCount(t)
...
def Handle_BRepCheck_Vertex_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Vertex_ForceRelease(t)

def Handle_BRepCheck_Vertex_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Vertex_GetRefCount(t)
...
def Handle_BRepCheck_Wire_ForceRelease(t):
    return _BRepCheck.Handle_BRepCheck_Wire_ForceRelease(t)

def Handle_BRepCheck_Wire_GetRefCount(t):
    return _BRepCheck.Handle_BRepCheck_Wire_GetRefCount(t)
