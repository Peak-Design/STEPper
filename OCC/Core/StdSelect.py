...
PYTHONOCC_DEBUG_EXCEPTIONS = _StdSelect.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _StdSelect.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _StdSelect.get_readable_method_name(method_name)

def get_exception_type(error):
    return _StdSelect.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _StdSelect.process_opencascade_exception(error, method_name, class_name)
...
def Handle_StdSelect_BRepOwner_ForceRelease(t):
    return _StdSelect.Handle_StdSelect_BRepOwner_ForceRelease(t)

def Handle_StdSelect_BRepOwner_GetRefCount(t):
    return _StdSelect.Handle_StdSelect_BRepOwner_GetRefCount(t)
...
def Handle_StdSelect_EdgeFilter_ForceRelease(t):
    return _StdSelect.Handle_StdSelect_EdgeFilter_ForceRelease(t)

def Handle_StdSelect_EdgeFilter_GetRefCount(t):
    return _StdSelect.Handle_StdSelect_EdgeFilter_GetRefCount(t)
...
def Handle_StdSelect_FaceFilter_ForceRelease(t):
    return _StdSelect.Handle_StdSelect_FaceFilter_ForceRelease(t)

def Handle_StdSelect_FaceFilter_GetRefCount(t):
    return _StdSelect.Handle_StdSelect_FaceFilter_GetRefCount(t)
...
def Handle_StdSelect_Shape_ForceRelease(t):
    return _StdSelect.Handle_StdSelect_Shape_ForceRelease(t)

def Handle_StdSelect_Shape_GetRefCount(t):
    return _StdSelect.Handle_StdSelect_Shape_GetRefCount(t)
...
def Handle_StdSelect_ShapeTypeFilter_ForceRelease(t):
    return _StdSelect.Handle_StdSelect_ShapeTypeFilter_ForceRelease(t)

def Handle_StdSelect_ShapeTypeFilter_GetRefCount(t):
    return _StdSelect.Handle_StdSelect_ShapeTypeFilter_GetRefCount(t)
