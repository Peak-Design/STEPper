...
PYTHONOCC_DEBUG_EXCEPTIONS = _GeomAdaptor.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _GeomAdaptor.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _GeomAdaptor.get_readable_method_name(method_name)

def get_exception_type(error):
    return _GeomAdaptor.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _GeomAdaptor.process_opencascade_exception(error, method_name, class_name)
...
def Handle_GeomAdaptor_Curve_ForceRelease(t):
    return _GeomAdaptor.Handle_GeomAdaptor_Curve_ForceRelease(t)

def Handle_GeomAdaptor_Curve_GetRefCount(t):
    return _GeomAdaptor.Handle_GeomAdaptor_Curve_GetRefCount(t)
...
def Handle_GeomAdaptor_Surface_ForceRelease(t):
    return _GeomAdaptor.Handle_GeomAdaptor_Surface_ForceRelease(t)

def Handle_GeomAdaptor_Surface_GetRefCount(t):
    return _GeomAdaptor.Handle_GeomAdaptor_Surface_GetRefCount(t)
...
def Handle_GeomAdaptor_SurfaceOfLinearExtrusion_ForceRelease(t):
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfLinearExtrusion_ForceRelease(t)

def Handle_GeomAdaptor_SurfaceOfLinearExtrusion_GetRefCount(t):
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfLinearExtrusion_GetRefCount(t)
...
def Handle_GeomAdaptor_SurfaceOfRevolution_ForceRelease(t):
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfRevolution_ForceRelease(t)

def Handle_GeomAdaptor_SurfaceOfRevolution_GetRefCount(t):
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfRevolution_GetRefCount(t)
