...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_xmlmdataxtd.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _XmlMDataXtd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XmlMDataXtd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XmlMDataXtd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XmlMDataXtd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XmlMDataXtd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XmlMDataXtd_ConstraintDriver_ForceRelease(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_ConstraintDriver_ForceRelease(t)

def Handle_XmlMDataXtd_ConstraintDriver_GetRefCount(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_ConstraintDriver_GetRefCount(t)
...
def Handle_XmlMDataXtd_GeometryDriver_ForceRelease(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_GeometryDriver_ForceRelease(t)

def Handle_XmlMDataXtd_GeometryDriver_GetRefCount(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_GeometryDriver_GetRefCount(t)
...
def Handle_XmlMDataXtd_PatternStdDriver_ForceRelease(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_PatternStdDriver_ForceRelease(t)

def Handle_XmlMDataXtd_PatternStdDriver_GetRefCount(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_PatternStdDriver_GetRefCount(t)
...
def Handle_XmlMDataXtd_PositionDriver_ForceRelease(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_PositionDriver_ForceRelease(t)

def Handle_XmlMDataXtd_PositionDriver_GetRefCount(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_PositionDriver_GetRefCount(t)
...
def Handle_XmlMDataXtd_PresentationDriver_ForceRelease(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_PresentationDriver_ForceRelease(t)

def Handle_XmlMDataXtd_PresentationDriver_GetRefCount(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_PresentationDriver_GetRefCount(t)
...
def Handle_XmlMDataXtd_TriangulationDriver_ForceRelease(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_TriangulationDriver_ForceRelease(t)

def Handle_XmlMDataXtd_TriangulationDriver_GetRefCount(t):
    return _XmlMDataXtd.Handle_XmlMDataXtd_TriangulationDriver_GetRefCount(t)
