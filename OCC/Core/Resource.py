...
PYTHONOCC_DEBUG_EXCEPTIONS = _Resource.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Resource.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Resource.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Resource.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Resource.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Resource_Manager_ForceRelease(t):
    return _Resource.Handle_Resource_Manager_ForceRelease(t)

def Handle_Resource_Manager_GetRefCount(t):
    return _Resource.Handle_Resource_Manager_GetRefCount(t)
...
class Resource_Manager(OCC.Core.Standard.Standard_Transient):
    ...
    def IsInitialized(self, *args):
        ...
        """
        return _Resource.Resource_Manager_IsInitialized(self, *args)
