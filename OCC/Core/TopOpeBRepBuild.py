...
PYTHONOCC_DEBUG_EXCEPTIONS = _TopOpeBRepBuild.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TopOpeBRepBuild.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TopOpeBRepBuild.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TopOpeBRepBuild.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TopOpeBRepBuild.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TopOpeBRepBuild_HBuilder_ForceRelease(t):
    return _TopOpeBRepBuild.Handle_TopOpeBRepBuild_HBuilder_ForceRelease(t)

def Handle_TopOpeBRepBuild_HBuilder_GetRefCount(t):
    return _TopOpeBRepBuild.Handle_TopOpeBRepBuild_HBuilder_GetRefCount(t)
...
def Handle_TopOpeBRepBuild_Loop_ForceRelease(t):
    return _TopOpeBRepBuild.Handle_TopOpeBRepBuild_Loop_ForceRelease(t)

def Handle_TopOpeBRepBuild_Loop_GetRefCount(t):
    return _TopOpeBRepBuild.Handle_TopOpeBRepBuild_Loop_GetRefCount(t)
...
def Handle_TopOpeBRepBuild_Pave_ForceRelease(t):
    return _TopOpeBRepBuild.Handle_TopOpeBRepBuild_Pave_ForceRelease(t)

def Handle_TopOpeBRepBuild_Pave_GetRefCount(t):
    return _TopOpeBRepBuild.Handle_TopOpeBRepBuild_Pave_GetRefCount(t)
