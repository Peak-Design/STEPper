...
PYTHONOCC_DEBUG_EXCEPTIONS = _BOPDS.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BOPDS.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BOPDS.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BOPDS.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BOPDS.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BOPDS_CommonBlock_ForceRelease(t):
    return _BOPDS.Handle_BOPDS_CommonBlock_ForceRelease(t)

def Handle_BOPDS_CommonBlock_GetRefCount(t):
    return _BOPDS.Handle_BOPDS_CommonBlock_GetRefCount(t)
...
def Handle_BOPDS_PaveBlock_ForceRelease(t):
    return _BOPDS.Handle_BOPDS_PaveBlock_ForceRelease(t)

def Handle_BOPDS_PaveBlock_GetRefCount(t):
    return _BOPDS.Handle_BOPDS_PaveBlock_GetRefCount(t)
