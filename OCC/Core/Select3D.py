...
PYTHONOCC_DEBUG_EXCEPTIONS = _Select3D.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Select3D.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Select3D.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Select3D.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Select3D.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Select3D_BVHIndexBuffer_ForceRelease(t):
    return _Select3D.Handle_Select3D_BVHIndexBuffer_ForceRelease(t)

def Handle_Select3D_BVHIndexBuffer_GetRefCount(t):
    return _Select3D.Handle_Select3D_BVHIndexBuffer_GetRefCount(t)
...
def Handle_Select3D_SensitiveBox_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveBox_ForceRelease(t)

def Handle_Select3D_SensitiveBox_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveBox_GetRefCount(t)
...
def Handle_Select3D_SensitiveCylinder_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveCylinder_ForceRelease(t)

def Handle_Select3D_SensitiveCylinder_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveCylinder_GetRefCount(t)
...
def Handle_Select3D_SensitiveFace_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveFace_ForceRelease(t)

def Handle_Select3D_SensitiveFace_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveFace_GetRefCount(t)
...
def Handle_Select3D_SensitivePoint_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitivePoint_ForceRelease(t)

def Handle_Select3D_SensitivePoint_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitivePoint_GetRefCount(t)
...
def Handle_Select3D_SensitiveSegment_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveSegment_ForceRelease(t)

def Handle_Select3D_SensitiveSegment_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveSegment_GetRefCount(t)
...
def Handle_Select3D_SensitiveSphere_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveSphere_ForceRelease(t)

def Handle_Select3D_SensitiveSphere_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveSphere_GetRefCount(t)
...
def Handle_Select3D_SensitiveTriangle_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveTriangle_ForceRelease(t)

def Handle_Select3D_SensitiveTriangle_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveTriangle_GetRefCount(t)
...
def Handle_Select3D_InteriorSensitivePointSet_ForceRelease(t):
    return _Select3D.Handle_Select3D_InteriorSensitivePointSet_ForceRelease(t)

def Handle_Select3D_InteriorSensitivePointSet_GetRefCount(t):
    return _Select3D.Handle_Select3D_InteriorSensitivePointSet_GetRefCount(t)
...
def Handle_Select3D_SensitiveGroup_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveGroup_ForceRelease(t)

def Handle_Select3D_SensitiveGroup_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveGroup_GetRefCount(t)
...
def Handle_Select3D_SensitivePoly_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitivePoly_ForceRelease(t)

def Handle_Select3D_SensitivePoly_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitivePoly_GetRefCount(t)
...
def Handle_Select3D_SensitivePrimitiveArray_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitivePrimitiveArray_ForceRelease(t)

def Handle_Select3D_SensitivePrimitiveArray_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitivePrimitiveArray_GetRefCount(t)
...
def Handle_Select3D_SensitiveWire_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveWire_ForceRelease(t)

def Handle_Select3D_SensitiveWire_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveWire_GetRefCount(t)
...
def Handle_Select3D_SensitiveCurve_ForceRelease(t):
    return _Select3D.Handle_Select3D_SensitiveCurve_ForceRelease(t)

def Handle_Select3D_SensitiveCurve_GetRefCount(t):
    return _Select3D.Handle_Select3D_SensitiveCurve_GetRefCount(t)
...
class Select3D_SensitiveCylinder(object):
    ...
    def GetConnected(self, *args):
        ...
        """
        return _Select3D.Select3D_SensitiveCylinder_GetConnected(self, *args)
