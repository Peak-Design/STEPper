...
PYTHONOCC_DEBUG_EXCEPTIONS = _LocOpe.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _LocOpe.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _LocOpe.get_readable_method_name(method_name)

def get_exception_type(error):
    return _LocOpe.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _LocOpe.process_opencascade_exception(error, method_name, class_name)
...
def Handle_LocOpe_GeneratedShape_ForceRelease(t):
    return _LocOpe.Handle_LocOpe_GeneratedShape_ForceRelease(t)

def Handle_LocOpe_GeneratedShape_GetRefCount(t):
    return _LocOpe.Handle_LocOpe_GeneratedShape_GetRefCount(t)
...
def Handle_LocOpe_WiresOnShape_ForceRelease(t):
    return _LocOpe.Handle_LocOpe_WiresOnShape_ForceRelease(t)

def Handle_LocOpe_WiresOnShape_GetRefCount(t):
    return _LocOpe.Handle_LocOpe_WiresOnShape_GetRefCount(t)
...
def Handle_LocOpe_GluedShape_ForceRelease(t):
    return _LocOpe.Handle_LocOpe_GluedShape_ForceRelease(t)

def Handle_LocOpe_GluedShape_GetRefCount(t):
    return _LocOpe.Handle_LocOpe_GluedShape_GetRefCount(t)
