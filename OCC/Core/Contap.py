...
PYTHONOCC_DEBUG_EXCEPTIONS = _Contap.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Contap.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Contap.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Contap.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Contap.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Contap_TheIWLineOfTheIWalking_ForceRelease(t):
    return _Contap.Handle_Contap_TheIWLineOfTheIWalking_ForceRelease(t)

def Handle_Contap_TheIWLineOfTheIWalking_GetRefCount(t):
    return _Contap.Handle_Contap_TheIWLineOfTheIWalking_GetRefCount(t)
...
def Handle_Contap_TheHSequenceOfPoint_ForceRelease(t):
    return _Contap.Handle_Contap_TheHSequenceOfPoint_ForceRelease(t)

def Handle_Contap_TheHSequenceOfPoint_GetRefCount(t):
    return _Contap.Handle_Contap_TheHSequenceOfPoint_GetRefCount(t)
