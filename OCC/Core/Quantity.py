...
PYTHONOCC_DEBUG_EXCEPTIONS = _Quantity.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Quantity.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Quantity.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Quantity.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Quantity.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Quantity_HArray1OfColor_ForceRelease(t):
    return _Quantity.Handle_Quantity_HArray1OfColor_ForceRelease(t)

def Handle_Quantity_HArray1OfColor_GetRefCount(t):
    return _Quantity.Handle_Quantity_HArray1OfColor_GetRefCount(t)
