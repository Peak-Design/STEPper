...
PYTHONOCC_DEBUG_EXCEPTIONS = _Poly.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Poly.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Poly.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Poly.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Poly.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Poly_CoherentTriangulation_ForceRelease(t):
    return _Poly.Handle_Poly_CoherentTriangulation_ForceRelease(t)

def Handle_Poly_CoherentTriangulation_GetRefCount(t):
    return _Poly.Handle_Poly_CoherentTriangulation_GetRefCount(t)
...
def Handle_Poly_MergeNodesTool_ForceRelease(t):
    return _Poly.Handle_Poly_MergeNodesTool_ForceRelease(t)

def Handle_Poly_MergeNodesTool_GetRefCount(t):
    return _Poly.Handle_Poly_MergeNodesTool_GetRefCount(t)
...
def Handle_Poly_Polygon2D_ForceRelease(t):
    return _Poly.Handle_Poly_Polygon2D_ForceRelease(t)

def Handle_Poly_Polygon2D_GetRefCount(t):
    return _Poly.Handle_Poly_Polygon2D_GetRefCount(t)
...
def Handle_Poly_Polygon3D_ForceRelease(t):
    return _Poly.Handle_Poly_Polygon3D_ForceRelease(t)

def Handle_Poly_Polygon3D_GetRefCount(t):
    return _Poly.Handle_Poly_Polygon3D_GetRefCount(t)
...
def Handle_Poly_PolygonOnTriangulation_ForceRelease(t):
    return _Poly.Handle_Poly_PolygonOnTriangulation_ForceRelease(t)

def Handle_Poly_PolygonOnTriangulation_GetRefCount(t):
    return _Poly.Handle_Poly_PolygonOnTriangulation_GetRefCount(t)
...
def Handle_Poly_Triangulation_ForceRelease(t):
    return _Poly.Handle_Poly_Triangulation_ForceRelease(t)

def Handle_Poly_Triangulation_GetRefCount(t):
    return _Poly.Handle_Poly_Triangulation_GetRefCount(t)
...
def Handle_Poly_TriangulationParameters_ForceRelease(t):
    return _Poly.Handle_Poly_TriangulationParameters_ForceRelease(t)

def Handle_Poly_TriangulationParameters_GetRefCount(t):
    return _Poly.Handle_Poly_TriangulationParameters_GetRefCount(t)
...
def Handle_Poly_HArray1OfTriangle_ForceRelease(t):
    return _Poly.Handle_Poly_HArray1OfTriangle_ForceRelease(t)

def Handle_Poly_HArray1OfTriangle_GetRefCount(t):
    return _Poly.Handle_Poly_HArray1OfTriangle_GetRefCount(t)
class Poly_Array1OfTriangle(object):
    ...
    def AddDataFromNumpyArray(self, numpyArray2):
        return _Poly.Poly_Array1OfTriangle_AddDataFromNumpyArray(self, numpyArray2)

    def BuildNumpyArray(self, numpyArray2Argout, nRows2Argout, nDims2Argout):
        return _Poly.Poly_Array1OfTriangle_BuildNumpyArray(self, numpyArray2Argout, nRows2Argout, nDims2Argout)
