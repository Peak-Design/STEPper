...
PYTHONOCC_DEBUG_EXCEPTIONS = _IntSurf.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _IntSurf.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _IntSurf.get_readable_method_name(method_name)

def get_exception_type(error):
    return _IntSurf.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _IntSurf.process_opencascade_exception(error, method_name, class_name)
...
def Handle_IntSurf_LineOn2S_ForceRelease(t):
    return _IntSurf.Handle_IntSurf_LineOn2S_ForceRelease(t)

def Handle_IntSurf_LineOn2S_GetRefCount(t):
    return _IntSurf.Handle_IntSurf_LineOn2S_GetRefCount(t)
