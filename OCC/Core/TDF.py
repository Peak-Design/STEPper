...
PYTHONOCC_DEBUG_EXCEPTIONS = _TDF.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TDF.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TDF.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TDF.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TDF.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TDF_Attribute_ForceRelease(t):
    return _TDF.Handle_TDF_Attribute_ForceRelease(t)

def Handle_TDF_Attribute_GetRefCount(t):
    return _TDF.Handle_TDF_Attribute_GetRefCount(t)
...
def Handle_TDF_AttributeDelta_ForceRelease(t):
    return _TDF.Handle_TDF_AttributeDelta_ForceRelease(t)

def Handle_TDF_AttributeDelta_GetRefCount(t):
    return _TDF.Handle_TDF_AttributeDelta_GetRefCount(t)
...
def Handle_TDF_Data_ForceRelease(t):
    return _TDF.Handle_TDF_Data_ForceRelease(t)

def Handle_TDF_Data_GetRefCount(t):
    return _TDF.Handle_TDF_Data_GetRefCount(t)
...
def Handle_TDF_DataSet_ForceRelease(t):
    return _TDF.Handle_TDF_DataSet_ForceRelease(t)

def Handle_TDF_DataSet_GetRefCount(t):
    return _TDF.Handle_TDF_DataSet_GetRefCount(t)
...
def Handle_TDF_Delta_ForceRelease(t):
    return _TDF.Handle_TDF_Delta_ForceRelease(t)

def Handle_TDF_Delta_GetRefCount(t):
    return _TDF.Handle_TDF_Delta_GetRefCount(t)
...
def Handle_TDF_RelocationTable_ForceRelease(t):
    return _TDF.Handle_TDF_RelocationTable_ForceRelease(t)

def Handle_TDF_RelocationTable_GetRefCount(t):
    return _TDF.Handle_TDF_RelocationTable_GetRefCount(t)
...
def Handle_TDF_DeltaOnAddition_ForceRelease(t):
    return _TDF.Handle_TDF_DeltaOnAddition_ForceRelease(t)

def Handle_TDF_DeltaOnAddition_GetRefCount(t):
    return _TDF.Handle_TDF_DeltaOnAddition_GetRefCount(t)
...
def Handle_TDF_DeltaOnForget_ForceRelease(t):
    return _TDF.Handle_TDF_DeltaOnForget_ForceRelease(t)

def Handle_TDF_DeltaOnForget_GetRefCount(t):
    return _TDF.Handle_TDF_DeltaOnForget_GetRefCount(t)
...
def Handle_TDF_DeltaOnModification_ForceRelease(t):
    return _TDF.Handle_TDF_DeltaOnModification_ForceRelease(t)

def Handle_TDF_DeltaOnModification_GetRefCount(t):
    return _TDF.Handle_TDF_DeltaOnModification_GetRefCount(t)
...
def Handle_TDF_DeltaOnRemoval_ForceRelease(t):
    return _TDF.Handle_TDF_DeltaOnRemoval_ForceRelease(t)

def Handle_TDF_DeltaOnRemoval_GetRefCount(t):
    return _TDF.Handle_TDF_DeltaOnRemoval_GetRefCount(t)
...
def Handle_TDF_DeltaOnResume_ForceRelease(t):
    return _TDF.Handle_TDF_DeltaOnResume_ForceRelease(t)

def Handle_TDF_DeltaOnResume_GetRefCount(t):
    return _TDF.Handle_TDF_DeltaOnResume_GetRefCount(t)
...
def Handle_TDF_Reference_ForceRelease(t):
    return _TDF.Handle_TDF_Reference_ForceRelease(t)

def Handle_TDF_Reference_GetRefCount(t):
    return _TDF.Handle_TDF_Reference_GetRefCount(t)
...
def Handle_TDF_TagSource_ForceRelease(t):
    return _TDF.Handle_TDF_TagSource_ForceRelease(t)

def Handle_TDF_TagSource_GetRefCount(t):
    return _TDF.Handle_TDF_TagSource_GetRefCount(t)
...
def Handle_TDF_DefaultDeltaOnModification_ForceRelease(t):
    return _TDF.Handle_TDF_DefaultDeltaOnModification_ForceRelease(t)

def Handle_TDF_DefaultDeltaOnModification_GetRefCount(t):
    return _TDF.Handle_TDF_DefaultDeltaOnModification_GetRefCount(t)
...
def Handle_TDF_DefaultDeltaOnRemoval_ForceRelease(t):
    return _TDF.Handle_TDF_DefaultDeltaOnRemoval_ForceRelease(t)

def Handle_TDF_DefaultDeltaOnRemoval_GetRefCount(t):
    return _TDF.Handle_TDF_DefaultDeltaOnRemoval_GetRefCount(t)
...
def Handle_TDF_HAttributeArray1_ForceRelease(t):
    return _TDF.Handle_TDF_HAttributeArray1_ForceRelease(t)

def Handle_TDF_HAttributeArray1_GetRefCount(t):
    return _TDF.Handle_TDF_HAttributeArray1_GetRefCount(t)
