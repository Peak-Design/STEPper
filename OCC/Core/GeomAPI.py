...
PYTHONOCC_DEBUG_EXCEPTIONS = _GeomAPI.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _GeomAPI.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _GeomAPI.get_readable_method_name(method_name)

def get_exception_type(error):
    return _GeomAPI.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _GeomAPI.process_opencascade_exception(error, method_name, class_name)
