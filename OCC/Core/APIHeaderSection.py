...
PYTHONOCC_DEBUG_EXCEPTIONS = _APIHeaderSection.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _APIHeaderSection.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _APIHeaderSection.get_readable_method_name(method_name)

def get_exception_type(error):
    return _APIHeaderSection.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _APIHeaderSection.process_opencascade_exception(error, method_name, class_name)
...
def Handle_APIHeaderSection_EditHeader_ForceRelease(t):
    return _APIHeaderSection.Handle_APIHeaderSection_EditHeader_ForceRelease(t)

def Handle_APIHeaderSection_EditHeader_GetRefCount(t):
    return _APIHeaderSection.Handle_APIHeaderSection_EditHeader_GetRefCount(t)
