...
PYTHONOCC_DEBUG_EXCEPTIONS = _SelectMgr.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _SelectMgr.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _SelectMgr.get_readable_method_name(method_name)

def get_exception_type(error):
    return _SelectMgr.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _SelectMgr.process_opencascade_exception(error, method_name, class_name)
...
def Handle_SelectMgr_BVHThreadPool_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_BVHThreadPool_ForceRelease(t)

def Handle_SelectMgr_BVHThreadPool_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_BVHThreadPool_GetRefCount(t)
...
def Handle_SelectMgr_BaseIntersector_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_BaseIntersector_ForceRelease(t)

def Handle_SelectMgr_BaseIntersector_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_BaseIntersector_GetRefCount(t)
...
def Handle_SelectMgr_EntityOwner_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_EntityOwner_ForceRelease(t)

def Handle_SelectMgr_EntityOwner_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_EntityOwner_GetRefCount(t)
...
def Handle_SelectMgr_Filter_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_Filter_ForceRelease(t)

def Handle_SelectMgr_Filter_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_Filter_GetRefCount(t)

def Handle_SelectMgr_FrustumBuilder_Create():
    return _SelectMgr.Handle_SelectMgr_FrustumBuilder_Create()

def Handle_SelectMgr_FrustumBuilder_DownCast(t):
    return _SelectMgr.Handle_SelectMgr_FrustumBuilder_DownCast(t)

def Handle_SelectMgr_FrustumBuilder_IsNull(t):
    return _SelectMgr.Handle_SelectMgr_FrustumBuilder_IsNull(t)

def Handle_SelectMgr_FrustumBuilder_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_FrustumBuilder_ForceRelease(t)

def Handle_SelectMgr_FrustumBuilder_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_FrustumBuilder_GetRefCount(t)
...
def Handle_SelectMgr_SelectableObject_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_SelectableObject_ForceRelease(t)

def Handle_SelectMgr_SelectableObject_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_SelectableObject_GetRefCount(t)
...
def Handle_SelectMgr_Selection_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_Selection_ForceRelease(t)

def Handle_SelectMgr_Selection_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_Selection_GetRefCount(t)
...
def Handle_SelectMgr_SelectionImageFiller_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_SelectionImageFiller_ForceRelease(t)

def Handle_SelectMgr_SelectionImageFiller_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_SelectionImageFiller_GetRefCount(t)
...
def Handle_SelectMgr_SelectionManager_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_SelectionManager_ForceRelease(t)

def Handle_SelectMgr_SelectionManager_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_SelectionManager_GetRefCount(t)
...
def Handle_SelectMgr_SensitiveEntity_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_SensitiveEntity_ForceRelease(t)

def Handle_SelectMgr_SensitiveEntity_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_SensitiveEntity_GetRefCount(t)

def Handle_SelectMgr_ViewerSelector_Create():
    return _SelectMgr.Handle_SelectMgr_ViewerSelector_Create()

def Handle_SelectMgr_ViewerSelector_DownCast(t):
    return _SelectMgr.Handle_SelectMgr_ViewerSelector_DownCast(t)

def Handle_SelectMgr_ViewerSelector_IsNull(t):
    return _SelectMgr.Handle_SelectMgr_ViewerSelector_IsNull(t)

def Handle_SelectMgr_ViewerSelector_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_ViewerSelector_ForceRelease(t)

def Handle_SelectMgr_ViewerSelector_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_ViewerSelector_GetRefCount(t)
...
def Handle_SelectMgr_AxisIntersector_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_AxisIntersector_ForceRelease(t)

def Handle_SelectMgr_AxisIntersector_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_AxisIntersector_GetRefCount(t)
...
def Handle_SelectMgr_CompositionFilter_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_CompositionFilter_ForceRelease(t)

def Handle_SelectMgr_CompositionFilter_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_CompositionFilter_GetRefCount(t)
...
def Handle_SelectMgr_AndFilter_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_AndFilter_ForceRelease(t)

def Handle_SelectMgr_AndFilter_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_AndFilter_GetRefCount(t)
...
def Handle_SelectMgr_AndOrFilter_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_AndOrFilter_ForceRelease(t)

def Handle_SelectMgr_AndOrFilter_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_AndOrFilter_GetRefCount(t)
...
def Handle_SelectMgr_OrFilter_ForceRelease(t):
    return _SelectMgr.Handle_SelectMgr_OrFilter_ForceRelease(t)

def Handle_SelectMgr_OrFilter_GetRefCount(t):
    return _SelectMgr.Handle_SelectMgr_OrFilter_GetRefCount(t)
...
class SelectMgr_BaseIntersector(OCC.Core.Standard.Standard_Transient):
    ...
    def CopyWithBuilder(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_BaseIntersector_CopyWithBuilder(self, *args)
...
class SelectMgr_FrustumBuilder(OCC.Core.Standard.Standard_Transient):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        ...
        """
        _SelectMgr.SelectMgr_FrustumBuilder_swiginit(self, _SelectMgr.new_SelectMgr_FrustumBuilder(*args))
    ...
    def Camera(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_FrustumBuilder_Camera(self, *args)
    ...
    def SetCamera(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_FrustumBuilder_SetCamera(self, *args)
    ...
    @staticmethod
    def DownCast(t):
      return Handle_SelectMgr_FrustumBuilder_DownCast(t)
...
# Register SelectMgr_FrustumBuilder in _SelectMgr:
_SelectMgr.SelectMgr_FrustumBuilder_swigregister(SelectMgr_FrustumBuilder)
...
class SelectMgr_SelectableObjectSet(object):
    ...
    BVHSubset_ortho3dPersistent = _SelectMgr.SelectMgr_SelectableObjectSet_BVHSubset_ortho3dPersistent
    BVHSubset_ortho2dPersistent = _SelectMgr.SelectMgr_SelectableObjectSet_BVHSubset_ortho2dPersistent
...
class SelectMgr_SelectingVolumeManager(OCC.Core.SelectBasics.SelectBasics_SelectingVolumeManager):
    ...
    def CopyWithBuilder(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_SelectingVolumeManager_CopyWithBuilder(self, *args)
...
class SelectMgr_SensitiveEntitySet(object):
    ...
    def __init__(self, *args):
        ...
        """
        _SelectMgr.SelectMgr_SensitiveEntitySet_swiginit(self, _SelectMgr.new_SelectMgr_SensitiveEntitySet(*args))
    ...
    def GetSensitiveById(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_SensitiveEntitySet_GetSensitiveById(self, *args)

    def HasEntityWithPersistence(self, *args):
        r"""
        Return
        -------
        bool
        ...
        """
        return _SelectMgr.SelectMgr_SensitiveEntitySet_HasEntityWithPersistence(self, *args)

    def Owners(self, *args):
        r"""
        Return
        -------
        ...
        """
        return _SelectMgr.SelectMgr_SensitiveEntitySet_Owners(self, *args)
    ...
    def Sensitives(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_SensitiveEntitySet_Sensitives(self, *args)
...
# Register SelectMgr_SensitiveEntitySet in _SelectMgr:
_SelectMgr.SelectMgr_SensitiveEntitySet_swigregister(SelectMgr_SensitiveEntitySet)
...
class SelectMgr_ToleranceMap(object):
    ...
    def __init__(self, *args):
        ...
        """
        _SelectMgr.SelectMgr_ToleranceMap_swiginit(self, _SelectMgr.new_SelectMgr_ToleranceMap(*args))
...
# Register SelectMgr_ToleranceMap in _SelectMgr:
_SelectMgr.SelectMgr_ToleranceMap_swigregister(SelectMgr_ToleranceMap)
...
class SelectMgr_ViewerSelector(OCC.Core.Standard.Standard_Transient):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        ...
        """
        _SelectMgr.SelectMgr_ViewerSelector_swiginit(self, _SelectMgr.new_SelectMgr_ViewerSelector(*args))
    ...
    def ClearSensitive(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_ClearSensitive(self, *args)
    ...
    def CustomPixelTolerance(self, *args):
        r"""
        Return
        -------
        int
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_CustomPixelTolerance(self, *args)

    def DepthTolerance(self, *args):
        r"""
        Return
        -------
        float
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_DepthTolerance(self, *args)

    def DepthToleranceType(self, *args):
        r"""
        Return
        -------
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_DepthToleranceType(self, *args)
    ...
    def DisplaySensitive(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_DisplaySensitive(self, *args)
    ...
    def DumpJson(self, depth=-1):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_DumpJson(self, depth)
    ...
    def Pick(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_Pick(self, *args)
    ...
    def PickedData(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_PickedData(self, *args)
    ...
    def PickedEntity(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_PickedEntity(self, *args)
    ...
    def PixelTolerance(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_PixelTolerance(self, *args)

    def QueueBVHBuild(self, *args):
        r"""
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_QueueBVHBuild(self, *args)
    ...
    def RemovePicked(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_RemovePicked(self, *args)
    ...
    def SelectableObjects(self, *args):
        r"""
        Return
        -------
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_SelectableObjects(self, *args)
    ...
    def SetDepthTolerance(self, *args):
        r"""
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_SetDepthTolerance(self, *args)
    ...
    def SetPixelTolerance(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_SetPixelTolerance(self, *args)

    def SetToPrebuildBVH(self, *args):
        r"""
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_SetToPrebuildBVH(self, *args)
    ...
    def ToPickClosest(self, *args):
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_ToPickClosest(self, *args)

    def ToPrebuildBVH(self, *args):
        r"""
        Return
        -------
        bool
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_ToPrebuildBVH(self, *args)

    def WaitForBVHBuild(self, *args):
        r"""
        Return
        -------
        None
        ...
        """
        return _SelectMgr.SelectMgr_ViewerSelector_WaitForBVHBuild(self, *args)
...
# Register SelectMgr_ViewerSelector in _SelectMgr:
_SelectMgr.SelectMgr_ViewerSelector_swigregister(SelectMgr_ViewerSelector)
