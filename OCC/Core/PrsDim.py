...
PYTHONOCC_DEBUG_EXCEPTIONS = _PrsDim.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _PrsDim.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _PrsDim.get_readable_method_name(method_name)

def get_exception_type(error):
    return _PrsDim.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _PrsDim.process_opencascade_exception(error, method_name, class_name)
...
def Handle_PrsDim_Dimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_Dimension_ForceRelease(t)

def Handle_PrsDim_Dimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_Dimension_GetRefCount(t)
...
def Handle_PrsDim_DimensionOwner_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_DimensionOwner_ForceRelease(t)

def Handle_PrsDim_DimensionOwner_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_DimensionOwner_GetRefCount(t)
...
def Handle_PrsDim_Relation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_Relation_ForceRelease(t)

def Handle_PrsDim_Relation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_Relation_GetRefCount(t)
...
def Handle_PrsDim_AngleDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_AngleDimension_ForceRelease(t)

def Handle_PrsDim_AngleDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_AngleDimension_GetRefCount(t)
...
def Handle_PrsDim_Chamf2dDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_Chamf2dDimension_ForceRelease(t)

def Handle_PrsDim_Chamf2dDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_Chamf2dDimension_GetRefCount(t)
...
def Handle_PrsDim_Chamf3dDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_Chamf3dDimension_ForceRelease(t)

def Handle_PrsDim_Chamf3dDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_Chamf3dDimension_GetRefCount(t)
...
def Handle_PrsDim_ConcentricRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_ConcentricRelation_ForceRelease(t)

def Handle_PrsDim_ConcentricRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_ConcentricRelation_GetRefCount(t)
...
def Handle_PrsDim_DiameterDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_DiameterDimension_ForceRelease(t)

def Handle_PrsDim_DiameterDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_DiameterDimension_GetRefCount(t)
...
def Handle_PrsDim_EllipseRadiusDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_EllipseRadiusDimension_ForceRelease(t)

def Handle_PrsDim_EllipseRadiusDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_EllipseRadiusDimension_GetRefCount(t)
...
def Handle_PrsDim_EqualDistanceRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_EqualDistanceRelation_ForceRelease(t)

def Handle_PrsDim_EqualDistanceRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_EqualDistanceRelation_GetRefCount(t)
...
def Handle_PrsDim_EqualRadiusRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_EqualRadiusRelation_ForceRelease(t)

def Handle_PrsDim_EqualRadiusRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_EqualRadiusRelation_GetRefCount(t)
...
def Handle_PrsDim_FixRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_FixRelation_ForceRelease(t)

def Handle_PrsDim_FixRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_FixRelation_GetRefCount(t)
...
def Handle_PrsDim_IdenticRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_IdenticRelation_ForceRelease(t)

def Handle_PrsDim_IdenticRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_IdenticRelation_GetRefCount(t)
...
def Handle_PrsDim_LengthDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_LengthDimension_ForceRelease(t)

def Handle_PrsDim_LengthDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_LengthDimension_GetRefCount(t)
...
def Handle_PrsDim_MidPointRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_MidPointRelation_ForceRelease(t)

def Handle_PrsDim_MidPointRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_MidPointRelation_GetRefCount(t)
...
def Handle_PrsDim_OffsetDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_OffsetDimension_ForceRelease(t)

def Handle_PrsDim_OffsetDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_OffsetDimension_GetRefCount(t)
...
def Handle_PrsDim_ParallelRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_ParallelRelation_ForceRelease(t)

def Handle_PrsDim_ParallelRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_ParallelRelation_GetRefCount(t)
...
def Handle_PrsDim_PerpendicularRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_PerpendicularRelation_ForceRelease(t)

def Handle_PrsDim_PerpendicularRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_PerpendicularRelation_GetRefCount(t)
...
def Handle_PrsDim_RadiusDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_RadiusDimension_ForceRelease(t)

def Handle_PrsDim_RadiusDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_RadiusDimension_GetRefCount(t)
...
def Handle_PrsDim_SymmetricRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_SymmetricRelation_ForceRelease(t)

def Handle_PrsDim_SymmetricRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_SymmetricRelation_GetRefCount(t)
...
def Handle_PrsDim_TangentRelation_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_TangentRelation_ForceRelease(t)

def Handle_PrsDim_TangentRelation_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_TangentRelation_GetRefCount(t)
...
def Handle_PrsDim_MaxRadiusDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_MaxRadiusDimension_ForceRelease(t)

def Handle_PrsDim_MaxRadiusDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_MaxRadiusDimension_GetRefCount(t)
...
def Handle_PrsDim_MinRadiusDimension_ForceRelease(t):
    return _PrsDim.Handle_PrsDim_MinRadiusDimension_ForceRelease(t)

def Handle_PrsDim_MinRadiusDimension_GetRefCount(t):
    return _PrsDim.Handle_PrsDim_MinRadiusDimension_GetRefCount(t)
class prsdim(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
