...
PYTHONOCC_DEBUG_EXCEPTIONS = _TColGeom.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TColGeom.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TColGeom.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TColGeom.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TColGeom.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TColGeom_HArray1OfBSplineCurve_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HArray1OfBSplineCurve_ForceRelease(t)

def Handle_TColGeom_HArray1OfBSplineCurve_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HArray1OfBSplineCurve_GetRefCount(t)
...
def Handle_TColGeom_HArray1OfBezierCurve_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HArray1OfBezierCurve_ForceRelease(t)

def Handle_TColGeom_HArray1OfBezierCurve_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HArray1OfBezierCurve_GetRefCount(t)
...
def Handle_TColGeom_HArray1OfCurve_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HArray1OfCurve_ForceRelease(t)

def Handle_TColGeom_HArray1OfCurve_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HArray1OfCurve_GetRefCount(t)
...
def Handle_TColGeom_HArray1OfSurface_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HArray1OfSurface_ForceRelease(t)

def Handle_TColGeom_HArray1OfSurface_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HArray1OfSurface_GetRefCount(t)
...
def Handle_TColGeom_HArray2OfSurface_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HArray2OfSurface_ForceRelease(t)

def Handle_TColGeom_HArray2OfSurface_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HArray2OfSurface_GetRefCount(t)
...
def Handle_TColGeom_HSequenceOfBoundedCurve_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HSequenceOfBoundedCurve_ForceRelease(t)

def Handle_TColGeom_HSequenceOfBoundedCurve_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HSequenceOfBoundedCurve_GetRefCount(t)
...
def Handle_TColGeom_HSequenceOfCurve_ForceRelease(t):
    return _TColGeom.Handle_TColGeom_HSequenceOfCurve_ForceRelease(t)

def Handle_TColGeom_HSequenceOfCurve_GetRefCount(t):
    return _TColGeom.Handle_TColGeom_HSequenceOfCurve_GetRefCount(t)
