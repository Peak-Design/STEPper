...
PYTHONOCC_DEBUG_EXCEPTIONS = _TFunction.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TFunction.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TFunction.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TFunction.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TFunction.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TFunction_Driver_ForceRelease(t):
    return _TFunction.Handle_TFunction_Driver_ForceRelease(t)

def Handle_TFunction_Driver_GetRefCount(t):
    return _TFunction.Handle_TFunction_Driver_GetRefCount(t)
...
def Handle_TFunction_DriverTable_ForceRelease(t):
    return _TFunction.Handle_TFunction_DriverTable_ForceRelease(t)

def Handle_TFunction_DriverTable_GetRefCount(t):
    return _TFunction.Handle_TFunction_DriverTable_GetRefCount(t)
...
def Handle_TFunction_Function_ForceRelease(t):
    return _TFunction.Handle_TFunction_Function_ForceRelease(t)

def Handle_TFunction_Function_GetRefCount(t):
    return _TFunction.Handle_TFunction_Function_GetRefCount(t)
...
def Handle_TFunction_GraphNode_ForceRelease(t):
    return _TFunction.Handle_TFunction_GraphNode_ForceRelease(t)

def Handle_TFunction_GraphNode_GetRefCount(t):
    return _TFunction.Handle_TFunction_GraphNode_GetRefCount(t)
...
def Handle_TFunction_Logbook_ForceRelease(t):
    return _TFunction.Handle_TFunction_Logbook_ForceRelease(t)

def Handle_TFunction_Logbook_GetRefCount(t):
    return _TFunction.Handle_TFunction_Logbook_GetRefCount(t)
...
def Handle_TFunction_Scope_ForceRelease(t):
    return _TFunction.Handle_TFunction_Scope_ForceRelease(t)

def Handle_TFunction_Scope_GetRefCount(t):
    return _TFunction.Handle_TFunction_Scope_GetRefCount(t)
...
def Handle_TFunction_HArray1OfDataMapOfGUIDDriver_ForceRelease(t):
    return _TFunction.Handle_TFunction_HArray1OfDataMapOfGUIDDriver_ForceRelease(t)

def Handle_TFunction_HArray1OfDataMapOfGUIDDriver_GetRefCount(t):
    return _TFunction.Handle_TFunction_HArray1OfDataMapOfGUIDDriver_GetRefCount(t)
