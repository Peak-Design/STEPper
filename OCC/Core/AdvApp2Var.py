...
PYTHONOCC_DEBUG_EXCEPTIONS = _AdvApp2Var.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _AdvApp2Var.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _AdvApp2Var.get_readable_method_name(method_name)

def get_exception_type(error):
    return _AdvApp2Var.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _AdvApp2Var.process_opencascade_exception(error, method_name, class_name)
...
def Handle_AdvApp2Var_Node_ForceRelease(t):
    return _AdvApp2Var.Handle_AdvApp2Var_Node_ForceRelease(t)

def Handle_AdvApp2Var_Node_GetRefCount(t):
    return _AdvApp2Var.Handle_AdvApp2Var_Node_GetRefCount(t)
...
def Handle_AdvApp2Var_Patch_ForceRelease(t):
    return _AdvApp2Var.Handle_AdvApp2Var_Patch_ForceRelease(t)

def Handle_AdvApp2Var_Patch_GetRefCount(t):
    return _AdvApp2Var.Handle_AdvApp2Var_Patch_GetRefCount(t)
