...
PYTHONOCC_DEBUG_EXCEPTIONS = _Aspect.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Aspect.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Aspect.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Aspect.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Aspect.process_opencascade_exception(error, method_name, class_name)
...
Aspect_XRGenericAction_NB = _Aspect.Aspect_XRGenericAction_NB
...
def Handle_Aspect_DisplayConnection_ForceRelease(t):
    return _Aspect.Handle_Aspect_DisplayConnection_ForceRelease(t)

def Handle_Aspect_DisplayConnection_GetRefCount(t):
    return _Aspect.Handle_Aspect_DisplayConnection_GetRefCount(t)
...
def Handle_Aspect_Grid_ForceRelease(t):
    return _Aspect.Handle_Aspect_Grid_ForceRelease(t)

def Handle_Aspect_Grid_GetRefCount(t):
    return _Aspect.Handle_Aspect_Grid_GetRefCount(t)
...
def Handle_Aspect_VKeySet_ForceRelease(t):
    return _Aspect.Handle_Aspect_VKeySet_ForceRelease(t)

def Handle_Aspect_VKeySet_GetRefCount(t):
    return _Aspect.Handle_Aspect_VKeySet_GetRefCount(t)
...
def Handle_Aspect_Window_ForceRelease(t):
    return _Aspect.Handle_Aspect_Window_ForceRelease(t)

def Handle_Aspect_Window_GetRefCount(t):
    return _Aspect.Handle_Aspect_Window_GetRefCount(t)
...
def Handle_Aspect_XRAction_ForceRelease(t):
    return _Aspect.Handle_Aspect_XRAction_ForceRelease(t)

def Handle_Aspect_XRAction_GetRefCount(t):
    return _Aspect.Handle_Aspect_XRAction_GetRefCount(t)
...
def Handle_Aspect_XRActionSet_ForceRelease(t):
    return _Aspect.Handle_Aspect_XRActionSet_ForceRelease(t)

def Handle_Aspect_XRActionSet_GetRefCount(t):
    return _Aspect.Handle_Aspect_XRActionSet_GetRefCount(t)
...
def Handle_Aspect_XRSession_ForceRelease(t):
    return _Aspect.Handle_Aspect_XRSession_ForceRelease(t)

def Handle_Aspect_XRSession_GetRefCount(t):
    return _Aspect.Handle_Aspect_XRSession_GetRefCount(t)
...
def Handle_Aspect_OpenVRSession_ForceRelease(t):
    return _Aspect.Handle_Aspect_OpenVRSession_ForceRelease(t)

def Handle_Aspect_OpenVRSession_GetRefCount(t):
    return _Aspect.Handle_Aspect_OpenVRSession_GetRefCount(t)
