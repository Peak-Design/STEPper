...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_binmdatastd.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _BinMDataStd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BinMDataStd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BinMDataStd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BinMDataStd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BinMDataStd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BinMDataStd_AsciiStringDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_AsciiStringDriver_ForceRelease(t)

def Handle_BinMDataStd_AsciiStringDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_AsciiStringDriver_GetRefCount(t)
...
def Handle_BinMDataStd_BooleanArrayDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_BooleanArrayDriver_ForceRelease(t)

def Handle_BinMDataStd_BooleanArrayDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_BooleanArrayDriver_GetRefCount(t)
...
def Handle_BinMDataStd_BooleanListDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_BooleanListDriver_ForceRelease(t)

def Handle_BinMDataStd_BooleanListDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_BooleanListDriver_GetRefCount(t)
...
def Handle_BinMDataStd_ByteArrayDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_ByteArrayDriver_ForceRelease(t)

def Handle_BinMDataStd_ByteArrayDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_ByteArrayDriver_GetRefCount(t)
...
def Handle_BinMDataStd_ExpressionDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_ExpressionDriver_ForceRelease(t)

def Handle_BinMDataStd_ExpressionDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_ExpressionDriver_GetRefCount(t)
...
def Handle_BinMDataStd_ExtStringArrayDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_ExtStringArrayDriver_ForceRelease(t)

def Handle_BinMDataStd_ExtStringArrayDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_ExtStringArrayDriver_GetRefCount(t)
...
def Handle_BinMDataStd_ExtStringListDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_ExtStringListDriver_ForceRelease(t)

def Handle_BinMDataStd_ExtStringListDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_ExtStringListDriver_GetRefCount(t)
...
def Handle_BinMDataStd_GenericEmptyDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_GenericEmptyDriver_ForceRelease(t)

def Handle_BinMDataStd_GenericEmptyDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_GenericEmptyDriver_GetRefCount(t)
...
def Handle_BinMDataStd_GenericExtStringDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_GenericExtStringDriver_ForceRelease(t)

def Handle_BinMDataStd_GenericExtStringDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_GenericExtStringDriver_GetRefCount(t)
...
def Handle_BinMDataStd_IntPackedMapDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_IntPackedMapDriver_ForceRelease(t)

def Handle_BinMDataStd_IntPackedMapDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_IntPackedMapDriver_GetRefCount(t)
...
def Handle_BinMDataStd_IntegerArrayDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_IntegerArrayDriver_ForceRelease(t)

def Handle_BinMDataStd_IntegerArrayDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_IntegerArrayDriver_GetRefCount(t)
...
def Handle_BinMDataStd_IntegerDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_IntegerDriver_ForceRelease(t)

def Handle_BinMDataStd_IntegerDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_IntegerDriver_GetRefCount(t)
...
def Handle_BinMDataStd_IntegerListDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_IntegerListDriver_ForceRelease(t)

def Handle_BinMDataStd_IntegerListDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_IntegerListDriver_GetRefCount(t)
...
def Handle_BinMDataStd_NamedDataDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_NamedDataDriver_ForceRelease(t)

def Handle_BinMDataStd_NamedDataDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_NamedDataDriver_GetRefCount(t)
...
def Handle_BinMDataStd_RealArrayDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_RealArrayDriver_ForceRelease(t)

def Handle_BinMDataStd_RealArrayDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_RealArrayDriver_GetRefCount(t)
...
def Handle_BinMDataStd_RealDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_RealDriver_ForceRelease(t)

def Handle_BinMDataStd_RealDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_RealDriver_GetRefCount(t)
...
def Handle_BinMDataStd_RealListDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_RealListDriver_ForceRelease(t)

def Handle_BinMDataStd_RealListDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_RealListDriver_GetRefCount(t)
...
def Handle_BinMDataStd_ReferenceArrayDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_ReferenceArrayDriver_ForceRelease(t)

def Handle_BinMDataStd_ReferenceArrayDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_ReferenceArrayDriver_GetRefCount(t)
...
def Handle_BinMDataStd_ReferenceListDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_ReferenceListDriver_ForceRelease(t)

def Handle_BinMDataStd_ReferenceListDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_ReferenceListDriver_GetRefCount(t)
...
def Handle_BinMDataStd_TreeNodeDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_TreeNodeDriver_ForceRelease(t)

def Handle_BinMDataStd_TreeNodeDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_TreeNodeDriver_GetRefCount(t)
...
def Handle_BinMDataStd_UAttributeDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_UAttributeDriver_ForceRelease(t)

def Handle_BinMDataStd_UAttributeDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_UAttributeDriver_GetRefCount(t)
...
def Handle_BinMDataStd_VariableDriver_ForceRelease(t):
    return _BinMDataStd.Handle_BinMDataStd_VariableDriver_ForceRelease(t)

def Handle_BinMDataStd_VariableDriver_GetRefCount(t):
    return _BinMDataStd.Handle_BinMDataStd_VariableDriver_GetRefCount(t)
