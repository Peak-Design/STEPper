...
PYTHONOCC_DEBUG_EXCEPTIONS = _TShort.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TShort.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TShort.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TShort.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TShort.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TShort_HArray1OfShortReal_ForceRelease(t):
    return _TShort.Handle_TShort_HArray1OfShortReal_ForceRelease(t)

def Handle_TShort_HArray1OfShortReal_GetRefCount(t):
    return _TShort.Handle_TShort_HArray1OfShortReal_GetRefCount(t)
...
def Handle_TShort_HArray2OfShortReal_ForceRelease(t):
    return _TShort.Handle_TShort_HArray2OfShortReal_ForceRelease(t)

def Handle_TShort_HArray2OfShortReal_GetRefCount(t):
    return _TShort.Handle_TShort_HArray2OfShortReal_GetRefCount(t)
...
def Handle_TShort_HSequenceOfShortReal_ForceRelease(t):
    return _TShort.Handle_TShort_HSequenceOfShortReal_ForceRelease(t)

def Handle_TShort_HSequenceOfShortReal_GetRefCount(t):
    return _TShort.Handle_TShort_HSequenceOfShortReal_GetRefCount(t)
class TShort_Array1OfShortReal(object):
    ...
    def AddDataFromNumpyArray(self, numpyArray1):
        return _TShort.TShort_Array1OfShortReal_AddDataFromNumpyArray(self, numpyArray1)

    def BuildNumpyArray(self, numpyArray1Argout):
        return _TShort.TShort_Array1OfShortReal_BuildNumpyArray(self, numpyArray1Argout)
...
class TShort_Array2OfShortReal(TShort_Array1OfShortReal):
    ...
    def AddDataFromNumpyArray(self, numpyArray2):
        return _TShort.TShort_Array2OfShortReal_AddDataFromNumpyArray(self, numpyArray2)

    def BuildNumpyArray(self, numpyArray2Argout, nRows2Argout, nCols2Argout):
        return _TShort.TShort_Array2OfShortReal_BuildNumpyArray(self, numpyArray2Argout, nRows2Argout, nCols2Argout)
