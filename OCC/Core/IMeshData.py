...
PYTHONOCC_DEBUG_EXCEPTIONS = _IMeshData.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _IMeshData.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _IMeshData.get_readable_method_name(method_name)

def get_exception_type(error):
    return _IMeshData.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _IMeshData.process_opencascade_exception(error, method_name, class_name)
...
def Handle_IMeshData_ParametersList_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_ParametersList_ForceRelease(t)

def Handle_IMeshData_ParametersList_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_ParametersList_GetRefCount(t)
...
def Handle_IMeshData_Shape_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_Shape_ForceRelease(t)

def Handle_IMeshData_Shape_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_Shape_GetRefCount(t)
...
def Handle_IMeshData_Curve_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_Curve_ForceRelease(t)

def Handle_IMeshData_Curve_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_Curve_GetRefCount(t)
...
def Handle_IMeshData_Model_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_Model_ForceRelease(t)

def Handle_IMeshData_Model_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_Model_GetRefCount(t)
...
def Handle_IMeshData_PCurve_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_PCurve_ForceRelease(t)

def Handle_IMeshData_PCurve_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_PCurve_GetRefCount(t)
...
def Handle_IMeshData_TessellatedShape_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_TessellatedShape_ForceRelease(t)

def Handle_IMeshData_TessellatedShape_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_TessellatedShape_GetRefCount(t)
...
def Handle_IMeshData_Edge_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_Edge_ForceRelease(t)

def Handle_IMeshData_Edge_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_Edge_GetRefCount(t)
...
def Handle_IMeshData_Face_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_Face_ForceRelease(t)

def Handle_IMeshData_Face_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_Face_GetRefCount(t)
...
def Handle_IMeshData_Wire_ForceRelease(t):
    return _IMeshData.Handle_IMeshData_Wire_ForceRelease(t)

def Handle_IMeshData_Wire_GetRefCount(t):
    return _IMeshData.Handle_IMeshData_Wire_GetRefCount(t)
