...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepApprox.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepApprox.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepApprox.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepApprox.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepApprox.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepApprox_ApproxLine_ForceRelease(t):
    return _BRepApprox.Handle_BRepApprox_ApproxLine_ForceRelease(t)

def Handle_BRepApprox_ApproxLine_GetRefCount(t):
    return _BRepApprox.Handle_BRepApprox_ApproxLine_GetRefCount(t)
