...
PYTHONOCC_DEBUG_EXCEPTIONS = _AppDef.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _AppDef.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _AppDef.get_readable_method_name(method_name)

def get_exception_type(error):
    return _AppDef.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _AppDef.process_opencascade_exception(error, method_name, class_name)
...
def Handle_AppDef_SmoothCriterion_ForceRelease(t):
    return _AppDef.Handle_AppDef_SmoothCriterion_ForceRelease(t)

def Handle_AppDef_SmoothCriterion_GetRefCount(t):
    return _AppDef.Handle_AppDef_SmoothCriterion_GetRefCount(t)
...
def Handle_AppDef_LinearCriteria_ForceRelease(t):
    return _AppDef.Handle_AppDef_LinearCriteria_ForceRelease(t)

def Handle_AppDef_LinearCriteria_GetRefCount(t):
    return _AppDef.Handle_AppDef_LinearCriteria_GetRefCount(t)
...
def Handle_AppDef_HArray1OfMultiPointConstraint_ForceRelease(t):
    return _AppDef.Handle_AppDef_HArray1OfMultiPointConstraint_ForceRelease(t)

def Handle_AppDef_HArray1OfMultiPointConstraint_GetRefCount(t):
    return _AppDef.Handle_AppDef_HArray1OfMultiPointConstraint_GetRefCount(t)
