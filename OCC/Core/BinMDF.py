...
PYTHONOCC_DEBUG_EXCEPTIONS = _BinMDF.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BinMDF.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BinMDF.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BinMDF.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BinMDF.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BinMDF_ADriver_ForceRelease(t):
    return _BinMDF.Handle_BinMDF_ADriver_ForceRelease(t)

def Handle_BinMDF_ADriver_GetRefCount(t):
    return _BinMDF.Handle_BinMDF_ADriver_GetRefCount(t)
...
def Handle_BinMDF_ADriverTable_ForceRelease(t):
    return _BinMDF.Handle_BinMDF_ADriverTable_ForceRelease(t)

def Handle_BinMDF_ADriverTable_GetRefCount(t):
    return _BinMDF.Handle_BinMDF_ADriverTable_GetRefCount(t)
...
def Handle_BinMDF_DerivedDriver_ForceRelease(t):
    return _BinMDF.Handle_BinMDF_DerivedDriver_ForceRelease(t)

def Handle_BinMDF_DerivedDriver_GetRefCount(t):
    return _BinMDF.Handle_BinMDF_DerivedDriver_GetRefCount(t)
...
def Handle_BinMDF_ReferenceDriver_ForceRelease(t):
    return _BinMDF.Handle_BinMDF_ReferenceDriver_ForceRelease(t)

def Handle_BinMDF_ReferenceDriver_GetRefCount(t):
    return _BinMDF.Handle_BinMDF_ReferenceDriver_GetRefCount(t)
...
def Handle_BinMDF_TagSourceDriver_ForceRelease(t):
    return _BinMDF.Handle_BinMDF_TagSourceDriver_ForceRelease(t)

def Handle_BinMDF_TagSourceDriver_GetRefCount(t):
    return _BinMDF.Handle_BinMDF_TagSourceDriver_GetRefCount(t)
