...
PYTHONOCC_DEBUG_EXCEPTIONS = _ShapeProcess.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ShapeProcess.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ShapeProcess.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ShapeProcess.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ShapeProcess.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ShapeProcess_Context_ForceRelease(t):
    return _ShapeProcess.Handle_ShapeProcess_Context_ForceRelease(t)

def Handle_ShapeProcess_Context_GetRefCount(t):
    return _ShapeProcess.Handle_ShapeProcess_Context_GetRefCount(t)
...
def Handle_ShapeProcess_Operator_ForceRelease(t):
    return _ShapeProcess.Handle_ShapeProcess_Operator_ForceRelease(t)

def Handle_ShapeProcess_Operator_GetRefCount(t):
    return _ShapeProcess.Handle_ShapeProcess_Operator_GetRefCount(t)
...
def Handle_ShapeProcess_ShapeContext_ForceRelease(t):
    return _ShapeProcess.Handle_ShapeProcess_ShapeContext_ForceRelease(t)

def Handle_ShapeProcess_ShapeContext_GetRefCount(t):
    return _ShapeProcess.Handle_ShapeProcess_ShapeContext_GetRefCount(t)
...
def Handle_ShapeProcess_UOperator_ForceRelease(t):
    return _ShapeProcess.Handle_ShapeProcess_UOperator_ForceRelease(t)

def Handle_ShapeProcess_UOperator_GetRefCount(t):
    return _ShapeProcess.Handle_ShapeProcess_UOperator_GetRefCount(t)
class shapeprocess(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    First = _ShapeProcess.shapeprocess_First
    DirectFaces = _ShapeProcess.shapeprocess_DirectFaces
    SameParameter = _ShapeProcess.shapeprocess_SameParameter
    SetTolerance = _ShapeProcess.shapeprocess_SetTolerance
    SplitAngle = _ShapeProcess.shapeprocess_SplitAngle
    BSplineRestriction = _ShapeProcess.shapeprocess_BSplineRestriction
    ElementaryToRevolution = _ShapeProcess.shapeprocess_ElementaryToRevolution
    SweptToElementary = _ShapeProcess.shapeprocess_SweptToElementary
    SurfaceToBSpline = _ShapeProcess.shapeprocess_SurfaceToBSpline
    ToBezier = _ShapeProcess.shapeprocess_ToBezier
    SplitContinuity = _ShapeProcess.shapeprocess_SplitContinuity
    SplitClosedFaces = _ShapeProcess.shapeprocess_SplitClosedFaces
    FixWireGaps = _ShapeProcess.shapeprocess_FixWireGaps
    FixFaceSize = _ShapeProcess.shapeprocess_FixFaceSize
    DropSmallSolids = _ShapeProcess.shapeprocess_DropSmallSolids
    DropSmallEdges = _ShapeProcess.shapeprocess_DropSmallEdges
    FixShape = _ShapeProcess.shapeprocess_FixShape
    SplitClosedEdges = _ShapeProcess.shapeprocess_SplitClosedEdges
    SplitCommonVertex = _ShapeProcess.shapeprocess_SplitCommonVertex
    Last = _ShapeProcess.shapeprocess_Last
    ...
    def ToOperationFlag(*args):
        ...
        """
        return _ShapeProcess.shapeprocess_ToOperationFlag(*args)
