...
PYTHONOCC_DEBUG_EXCEPTIONS = _AppStdL.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _AppStdL.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _AppStdL.get_readable_method_name(method_name)

def get_exception_type(error):
    return _AppStdL.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _AppStdL.process_opencascade_exception(error, method_name, class_name)
...
def Handle_AppStdL_Application_ForceRelease(t):
    return _AppStdL.Handle_AppStdL_Application_ForceRelease(t)

def Handle_AppStdL_Application_GetRefCount(t):
    return _AppStdL.Handle_AppStdL_Application_GetRefCount(t)
