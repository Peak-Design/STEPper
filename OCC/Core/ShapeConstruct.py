...
PYTHONOCC_DEBUG_EXCEPTIONS = _ShapeConstruct.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ShapeConstruct.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ShapeConstruct.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ShapeConstruct.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ShapeConstruct.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ShapeConstruct_ProjectCurveOnSurface_ForceRelease(t):
    return _ShapeConstruct.Handle_ShapeConstruct_ProjectCurveOnSurface_ForceRelease(t)

def Handle_ShapeConstruct_ProjectCurveOnSurface_GetRefCount(t):
    return _ShapeConstruct.Handle_ShapeConstruct_ProjectCurveOnSurface_GetRefCount(t)
