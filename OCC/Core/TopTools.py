...
PYTHONOCC_DEBUG_EXCEPTIONS = _TopTools.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TopTools.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TopTools.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TopTools.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TopTools.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TopTools_HArray1OfListOfShape_ForceRelease(t):
    return _TopTools.Handle_TopTools_HArray1OfListOfShape_ForceRelease(t)

def Handle_TopTools_HArray1OfListOfShape_GetRefCount(t):
    return _TopTools.Handle_TopTools_HArray1OfListOfShape_GetRefCount(t)
...
def Handle_TopTools_HArray1OfShape_ForceRelease(t):
    return _TopTools.Handle_TopTools_HArray1OfShape_ForceRelease(t)

def Handle_TopTools_HArray1OfShape_GetRefCount(t):
    return _TopTools.Handle_TopTools_HArray1OfShape_GetRefCount(t)
...
def Handle_TopTools_HArray2OfShape_ForceRelease(t):
    return _TopTools.Handle_TopTools_HArray2OfShape_ForceRelease(t)

def Handle_TopTools_HArray2OfShape_GetRefCount(t):
    return _TopTools.Handle_TopTools_HArray2OfShape_GetRefCount(t)
...
def Handle_TopTools_HSequenceOfShape_ForceRelease(t):
    return _TopTools.Handle_TopTools_HSequenceOfShape_ForceRelease(t)

def Handle_TopTools_HSequenceOfShape_GetRefCount(t):
    return _TopTools.Handle_TopTools_HSequenceOfShape_GetRefCount(t)
