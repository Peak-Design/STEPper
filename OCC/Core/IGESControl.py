...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_igescontrol.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _IGESControl.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _IGESControl.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _IGESControl.get_readable_method_name(method_name)

def get_exception_type(error):
    return _IGESControl.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _IGESControl.process_opencascade_exception(error, method_name, class_name)
...
def Handle_IGESControl_ActorWrite_ForceRelease(t):
    return _IGESControl.Handle_IGESControl_ActorWrite_ForceRelease(t)

def Handle_IGESControl_ActorWrite_GetRefCount(t):
    return _IGESControl.Handle_IGESControl_ActorWrite_GetRefCount(t)
...
def Handle_IGESControl_AlgoContainer_ForceRelease(t):
    return _IGESControl.Handle_IGESControl_AlgoContainer_ForceRelease(t)

def Handle_IGESControl_AlgoContainer_GetRefCount(t):
    return _IGESControl.Handle_IGESControl_AlgoContainer_GetRefCount(t)
...
def Handle_IGESControl_Controller_ForceRelease(t):
    return _IGESControl.Handle_IGESControl_Controller_ForceRelease(t)

def Handle_IGESControl_Controller_GetRefCount(t):
    return _IGESControl.Handle_IGESControl_Controller_GetRefCount(t)
...
def Handle_IGESControl_IGESBoundary_ForceRelease(t):
    return _IGESControl.Handle_IGESControl_IGESBoundary_ForceRelease(t)

def Handle_IGESControl_IGESBoundary_GetRefCount(t):
    return _IGESControl.Handle_IGESControl_IGESBoundary_GetRefCount(t)
...
def Handle_IGESControl_ToolContainer_ForceRelease(t):
    return _IGESControl.Handle_IGESControl_ToolContainer_ForceRelease(t)

def Handle_IGESControl_ToolContainer_GetRefCount(t):
    return _IGESControl.Handle_IGESControl_ToolContainer_GetRefCount(t)
...
class IGESControl_Writer(object):
    ...
    def GetShapeFixParameters(self, *args):
        ...
        """
        return _IGESControl.IGESControl_Writer_GetShapeFixParameters(self, *args)
    ...
    def GetShapeProcessFlags(self, *args):
        ...
        """
        return _IGESControl.IGESControl_Writer_GetShapeProcessFlags(self, *args)
    ...
    def SetShapeFixParameters(self, *args):
        ...
        """
        return _IGESControl.IGESControl_Writer_SetShapeFixParameters(self, *args)
    ...
    def SetShapeProcessFlags(self, *args):
        ...
        """
        return _IGESControl.IGESControl_Writer_SetShapeProcessFlags(self, *args)
