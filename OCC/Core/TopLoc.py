...
PYTHONOCC_DEBUG_EXCEPTIONS = _TopLoc.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TopLoc.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TopLoc.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TopLoc.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TopLoc.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TopLoc_Datum3D_ForceRelease(t):
    return _TopLoc.Handle_TopLoc_Datum3D_ForceRelease(t)

def Handle_TopLoc_Datum3D_GetRefCount(t):
    return _TopLoc.Handle_TopLoc_Datum3D_GetRefCount(t)
...
def Handle_TopLoc_SListNodeOfItemLocation_ForceRelease(t):
    return _TopLoc.Handle_TopLoc_SListNodeOfItemLocation_ForceRelease(t)

def Handle_TopLoc_SListNodeOfItemLocation_GetRefCount(t):
    return _TopLoc.Handle_TopLoc_SListNodeOfItemLocation_GetRefCount(t)
