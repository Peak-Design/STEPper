...
PYTHONOCC_DEBUG_EXCEPTIONS = _HLRBRep.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _HLRBRep.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _HLRBRep.get_readable_method_name(method_name)

def get_exception_type(error):
    return _HLRBRep.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _HLRBRep.process_opencascade_exception(error, method_name, class_name)
...
def Handle_HLRBRep_AreaLimit_ForceRelease(t):
    return _HLRBRep.Handle_HLRBRep_AreaLimit_ForceRelease(t)

def Handle_HLRBRep_AreaLimit_GetRefCount(t):
    return _HLRBRep.Handle_HLRBRep_AreaLimit_GetRefCount(t)
...
def Handle_HLRBRep_Data_ForceRelease(t):
    return _HLRBRep.Handle_HLRBRep_Data_ForceRelease(t)

def Handle_HLRBRep_Data_GetRefCount(t):
    return _HLRBRep.Handle_HLRBRep_Data_GetRefCount(t)
...
def Handle_HLRBRep_InternalAlgo_ForceRelease(t):
    return _HLRBRep.Handle_HLRBRep_InternalAlgo_ForceRelease(t)

def Handle_HLRBRep_InternalAlgo_GetRefCount(t):
    return _HLRBRep.Handle_HLRBRep_InternalAlgo_GetRefCount(t)
...
def Handle_HLRBRep_PolyAlgo_ForceRelease(t):
    return _HLRBRep.Handle_HLRBRep_PolyAlgo_ForceRelease(t)

def Handle_HLRBRep_PolyAlgo_GetRefCount(t):
    return _HLRBRep.Handle_HLRBRep_PolyAlgo_GetRefCount(t)
...
def Handle_HLRBRep_Algo_ForceRelease(t):
    return _HLRBRep.Handle_HLRBRep_Algo_ForceRelease(t)

def Handle_HLRBRep_Algo_GetRefCount(t):
    return _HLRBRep.Handle_HLRBRep_Algo_GetRefCount(t)
