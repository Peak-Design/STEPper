...
PYTHONOCC_DEBUG_EXCEPTIONS = _STEPSelections.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _STEPSelections.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _STEPSelections.get_readable_method_name(method_name)

def get_exception_type(error):
    return _STEPSelections.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _STEPSelections.process_opencascade_exception(error, method_name, class_name)
...
def Handle_STEPSelections_AssemblyComponent_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_AssemblyComponent_ForceRelease(t)

def Handle_STEPSelections_AssemblyComponent_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_AssemblyComponent_GetRefCount(t)
...
def Handle_STEPSelections_AssemblyLink_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_AssemblyLink_ForceRelease(t)

def Handle_STEPSelections_AssemblyLink_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_AssemblyLink_GetRefCount(t)
...
def Handle_STEPSelections_SelectAssembly_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_SelectAssembly_ForceRelease(t)

def Handle_STEPSelections_SelectAssembly_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_SelectAssembly_GetRefCount(t)
...
def Handle_STEPSelections_SelectDerived_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_SelectDerived_ForceRelease(t)

def Handle_STEPSelections_SelectDerived_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_SelectDerived_GetRefCount(t)
...
def Handle_STEPSelections_SelectFaces_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_SelectFaces_ForceRelease(t)

def Handle_STEPSelections_SelectFaces_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_SelectFaces_GetRefCount(t)
...
def Handle_STEPSelections_SelectForTransfer_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_SelectForTransfer_ForceRelease(t)

def Handle_STEPSelections_SelectForTransfer_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_SelectForTransfer_GetRefCount(t)
...
def Handle_STEPSelections_SelectGSCurves_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_SelectGSCurves_ForceRelease(t)

def Handle_STEPSelections_SelectGSCurves_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_SelectGSCurves_GetRefCount(t)
...
def Handle_STEPSelections_SelectInstances_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_SelectInstances_ForceRelease(t)

def Handle_STEPSelections_SelectInstances_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_SelectInstances_GetRefCount(t)
...
def Handle_STEPSelections_HSequenceOfAssemblyLink_ForceRelease(t):
    return _STEPSelections.Handle_STEPSelections_HSequenceOfAssemblyLink_ForceRelease(t)

def Handle_STEPSelections_HSequenceOfAssemblyLink_GetRefCount(t):
    return _STEPSelections.Handle_STEPSelections_HSequenceOfAssemblyLink_GetRefCount(t)
