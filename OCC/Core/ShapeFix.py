...
PYTHONOCC_DEBUG_EXCEPTIONS = _ShapeFix.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ShapeFix.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ShapeFix.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ShapeFix.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ShapeFix.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ShapeFix_Edge_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Edge_ForceRelease(t)

def Handle_ShapeFix_Edge_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Edge_GetRefCount(t)
...
def Handle_ShapeFix_EdgeProjAux_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_EdgeProjAux_ForceRelease(t)

def Handle_ShapeFix_EdgeProjAux_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_EdgeProjAux_GetRefCount(t)
...
def Handle_ShapeFix_Root_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Root_ForceRelease(t)

def Handle_ShapeFix_Root_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Root_GetRefCount(t)
...
def Handle_ShapeFix_ComposeShell_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_ComposeShell_ForceRelease(t)

def Handle_ShapeFix_ComposeShell_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_ComposeShell_GetRefCount(t)
...
def Handle_ShapeFix_Face_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Face_ForceRelease(t)

def Handle_ShapeFix_Face_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Face_GetRefCount(t)
...
def Handle_ShapeFix_FixSmallFace_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_FixSmallFace_ForceRelease(t)

def Handle_ShapeFix_FixSmallFace_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_FixSmallFace_GetRefCount(t)
...
def Handle_ShapeFix_FixSmallSolid_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_FixSmallSolid_ForceRelease(t)

def Handle_ShapeFix_FixSmallSolid_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_FixSmallSolid_GetRefCount(t)
...
def Handle_ShapeFix_Shape_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Shape_ForceRelease(t)

def Handle_ShapeFix_Shape_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Shape_GetRefCount(t)
...
def Handle_ShapeFix_Shell_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Shell_ForceRelease(t)

def Handle_ShapeFix_Shell_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Shell_GetRefCount(t)
...
def Handle_ShapeFix_Solid_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Solid_ForceRelease(t)

def Handle_ShapeFix_Solid_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Solid_GetRefCount(t)
...
def Handle_ShapeFix_SplitCommonVertex_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_SplitCommonVertex_ForceRelease(t)

def Handle_ShapeFix_SplitCommonVertex_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_SplitCommonVertex_GetRefCount(t)
...
def Handle_ShapeFix_Wire_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Wire_ForceRelease(t)

def Handle_ShapeFix_Wire_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Wire_GetRefCount(t)
...
def Handle_ShapeFix_Wireframe_ForceRelease(t):
    return _ShapeFix.Handle_ShapeFix_Wireframe_ForceRelease(t)

def Handle_ShapeFix_Wireframe_GetRefCount(t):
    return _ShapeFix.Handle_ShapeFix_Wireframe_GetRefCount(t)
