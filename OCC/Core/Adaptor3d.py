...
PYTHONOCC_DEBUG_EXCEPTIONS = _Adaptor3d.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Adaptor3d.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Adaptor3d.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Adaptor3d.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Adaptor3d.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Adaptor3d_Curve_ForceRelease(t):
    return _Adaptor3d.Handle_Adaptor3d_Curve_ForceRelease(t)

def Handle_Adaptor3d_Curve_GetRefCount(t):
    return _Adaptor3d.Handle_Adaptor3d_Curve_GetRefCount(t)
...
def Handle_Adaptor3d_HVertex_ForceRelease(t):
    return _Adaptor3d.Handle_Adaptor3d_HVertex_ForceRelease(t)

def Handle_Adaptor3d_HVertex_GetRefCount(t):
    return _Adaptor3d.Handle_Adaptor3d_HVertex_GetRefCount(t)
...
def Handle_Adaptor3d_Surface_ForceRelease(t):
    return _Adaptor3d.Handle_Adaptor3d_Surface_ForceRelease(t)

def Handle_Adaptor3d_Surface_GetRefCount(t):
    return _Adaptor3d.Handle_Adaptor3d_Surface_GetRefCount(t)
...
def Handle_Adaptor3d_TopolTool_ForceRelease(t):
    return _Adaptor3d.Handle_Adaptor3d_TopolTool_ForceRelease(t)

def Handle_Adaptor3d_TopolTool_GetRefCount(t):
    return _Adaptor3d.Handle_Adaptor3d_TopolTool_GetRefCount(t)
...
def Handle_Adaptor3d_CurveOnSurface_ForceRelease(t):
    return _Adaptor3d.Handle_Adaptor3d_CurveOnSurface_ForceRelease(t)

def Handle_Adaptor3d_CurveOnSurface_GetRefCount(t):
    return _Adaptor3d.Handle_Adaptor3d_CurveOnSurface_GetRefCount(t)
...
def Handle_Adaptor3d_IsoCurve_ForceRelease(t):
    return _Adaptor3d.Handle_Adaptor3d_IsoCurve_ForceRelease(t)

def Handle_Adaptor3d_IsoCurve_GetRefCount(t):
    return _Adaptor3d.Handle_Adaptor3d_IsoCurve_GetRefCount(t)
