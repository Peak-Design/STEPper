...
PYTHONOCC_DEBUG_EXCEPTIONS = _DE.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _DE.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _DE.get_readable_method_name(method_name)

def get_exception_type(error):
    return _DE.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _DE.process_opencascade_exception(error, method_name, class_name)
...
def Handle_DE_ConfigurationContext_ForceRelease(t):
    return _DE.Handle_DE_ConfigurationContext_ForceRelease(t)

def Handle_DE_ConfigurationContext_GetRefCount(t):
    return _DE.Handle_DE_ConfigurationContext_GetRefCount(t)
...
def Handle_DE_ConfigurationNode_ForceRelease(t):
    return _DE.Handle_DE_ConfigurationNode_ForceRelease(t)

def Handle_DE_ConfigurationNode_GetRefCount(t):
    return _DE.Handle_DE_ConfigurationNode_GetRefCount(t)
...
def Handle_DE_Provider_ForceRelease(t):
    return _DE.Handle_DE_Provider_ForceRelease(t)

def Handle_DE_Provider_GetRefCount(t):
    return _DE.Handle_DE_Provider_GetRefCount(t)
...
def Handle_DE_Wrapper_ForceRelease(t):
    return _DE.Handle_DE_Wrapper_ForceRelease(t)

def Handle_DE_Wrapper_GetRefCount(t):
    return _DE.Handle_DE_Wrapper_GetRefCount(t)
...
class DE_ConfigurationNode(OCC.Core.Standard.Standard_Transient):
    ...
    def CustomActivation(self, *args):
        r"""
        ...
        """
        return _DE.DE_ConfigurationNode_CustomActivation(self, *args)
