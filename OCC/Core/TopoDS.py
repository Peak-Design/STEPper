...
PYTHONOCC_DEBUG_EXCEPTIONS = _TopoDS.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TopoDS.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TopoDS.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TopoDS.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TopoDS.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TopoDS_AlertAttribute_Create():
    return _TopoDS.Handle_TopoDS_AlertAttribute_Create()

def Handle_TopoDS_AlertAttribute_DownCast(t):
    return _TopoDS.Handle_TopoDS_AlertAttribute_DownCast(t)

def Handle_TopoDS_AlertAttribute_IsNull(t):
    return _TopoDS.Handle_TopoDS_AlertAttribute_IsNull(t)

def Handle_TopoDS_AlertAttribute_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_AlertAttribute_ForceRelease(t)

def Handle_TopoDS_AlertAttribute_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_AlertAttribute_GetRefCount(t)

def Handle_TopoDS_AlertWithShape_Create():
    return _TopoDS.Handle_TopoDS_AlertWithShape_Create()

def Handle_TopoDS_AlertWithShape_DownCast(t):
    return _TopoDS.Handle_TopoDS_AlertWithShape_DownCast(t)

def Handle_TopoDS_AlertWithShape_IsNull(t):
    return _TopoDS.Handle_TopoDS_AlertWithShape_IsNull(t)

def Handle_TopoDS_AlertWithShape_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_AlertWithShape_ForceRelease(t)

def Handle_TopoDS_AlertWithShape_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_AlertWithShape_GetRefCount(t)
...
def Handle_TopoDS_HShape_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_HShape_ForceRelease(t)

def Handle_TopoDS_HShape_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_HShape_GetRefCount(t)
...
def Handle_TopoDS_TShape_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TShape_ForceRelease(t)

def Handle_TopoDS_TShape_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TShape_GetRefCount(t)
...
def Handle_TopoDS_TCompSolid_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TCompSolid_ForceRelease(t)

def Handle_TopoDS_TCompSolid_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TCompSolid_GetRefCount(t)
...
def Handle_TopoDS_TCompound_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TCompound_ForceRelease(t)

def Handle_TopoDS_TCompound_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TCompound_GetRefCount(t)
...
def Handle_TopoDS_TEdge_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TEdge_ForceRelease(t)

def Handle_TopoDS_TEdge_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TEdge_GetRefCount(t)
...
def Handle_TopoDS_TFace_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TFace_ForceRelease(t)

def Handle_TopoDS_TFace_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TFace_GetRefCount(t)
...
def Handle_TopoDS_TShell_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TShell_ForceRelease(t)

def Handle_TopoDS_TShell_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TShell_GetRefCount(t)
...
def Handle_TopoDS_TSolid_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TSolid_ForceRelease(t)

def Handle_TopoDS_TSolid_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TSolid_GetRefCount(t)
...
def Handle_TopoDS_TVertex_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TVertex_ForceRelease(t)

def Handle_TopoDS_TVertex_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TVertex_GetRefCount(t)
...
def Handle_TopoDS_TWire_ForceRelease(t):
    return _TopoDS.Handle_TopoDS_TWire_ForceRelease(t)

def Handle_TopoDS_TWire_GetRefCount(t):
    return _TopoDS.Handle_TopoDS_TWire_GetRefCount(t)
class TopoDS_AlertAttribute(OCC.Core.Message.Message_AttributeStream):
    ...
    @staticmethod
    def DownCast(t):
      return Handle_TopoDS_AlertAttribute_DownCast(t)
...
class TopoDS_AlertWithShape(OCC.Core.Message.Message_Alert):
    ...
    @staticmethod
    def DownCast(t):
      return Handle_TopoDS_AlertWithShape_DownCast(t)
