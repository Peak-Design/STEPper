...
PYTHONOCC_DEBUG_EXCEPTIONS = _Bnd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Bnd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Bnd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Bnd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Bnd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Bnd_HArray1OfBox_ForceRelease(t):
    return _Bnd.Handle_Bnd_HArray1OfBox_ForceRelease(t)

def Handle_Bnd_HArray1OfBox_GetRefCount(t):
    return _Bnd.Handle_Bnd_HArray1OfBox_GetRefCount(t)
...
def Handle_Bnd_HArray1OfBox2d_ForceRelease(t):
    return _Bnd.Handle_Bnd_HArray1OfBox2d_ForceRelease(t)

def Handle_Bnd_HArray1OfBox2d_GetRefCount(t):
    return _Bnd.Handle_Bnd_HArray1OfBox2d_GetRefCount(t)
...
def Handle_Bnd_HArray1OfSphere_ForceRelease(t):
    return _Bnd.Handle_Bnd_HArray1OfSphere_ForceRelease(t)

def Handle_Bnd_HArray1OfSphere_GetRefCount(t):
    return _Bnd.Handle_Bnd_HArray1OfSphere_GetRefCount(t)
