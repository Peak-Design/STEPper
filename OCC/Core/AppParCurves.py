...
PYTHONOCC_DEBUG_EXCEPTIONS = _AppParCurves.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _AppParCurves.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _AppParCurves.get_readable_method_name(method_name)

def get_exception_type(error):
    return _AppParCurves.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _AppParCurves.process_opencascade_exception(error, method_name, class_name)
...
def Handle_AppParCurves_HArray1OfConstraintCouple_ForceRelease(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfConstraintCouple_ForceRelease(t)

def Handle_AppParCurves_HArray1OfConstraintCouple_GetRefCount(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfConstraintCouple_GetRefCount(t)
...
def Handle_AppParCurves_HArray1OfMultiBSpCurve_ForceRelease(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfMultiBSpCurve_ForceRelease(t)

def Handle_AppParCurves_HArray1OfMultiBSpCurve_GetRefCount(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfMultiBSpCurve_GetRefCount(t)
...
def Handle_AppParCurves_HArray1OfMultiCurve_ForceRelease(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfMultiCurve_ForceRelease(t)

def Handle_AppParCurves_HArray1OfMultiCurve_GetRefCount(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfMultiCurve_GetRefCount(t)
...
def Handle_AppParCurves_HArray1OfMultiPoint_ForceRelease(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfMultiPoint_ForceRelease(t)

def Handle_AppParCurves_HArray1OfMultiPoint_GetRefCount(t):
    return _AppParCurves.Handle_AppParCurves_HArray1OfMultiPoint_GetRefCount(t)
