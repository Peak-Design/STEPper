...
PYTHONOCC_DEBUG_EXCEPTIONS = _IntTools.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _IntTools.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _IntTools.get_readable_method_name(method_name)

def get_exception_type(error):
    return _IntTools.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _IntTools.process_opencascade_exception(error, method_name, class_name)
...
def Handle_IntTools_Context_ForceRelease(t):
    return _IntTools.Handle_IntTools_Context_ForceRelease(t)

def Handle_IntTools_Context_GetRefCount(t):
    return _IntTools.Handle_IntTools_Context_GetRefCount(t)
...
def Handle_IntTools_TopolTool_ForceRelease(t):
    return _IntTools.Handle_IntTools_TopolTool_ForceRelease(t)

def Handle_IntTools_TopolTool_GetRefCount(t):
    return _IntTools.Handle_IntTools_TopolTool_GetRefCount(t)
