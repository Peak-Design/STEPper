...
PYTHONOCC_DEBUG_EXCEPTIONS = _XCAFDimTolObjects.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XCAFDimTolObjects.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XCAFDimTolObjects.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XCAFDimTolObjects.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XCAFDimTolObjects.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XCAFDimTolObjects_DatumObject_ForceRelease(t):
    return _XCAFDimTolObjects.Handle_XCAFDimTolObjects_DatumObject_ForceRelease(t)

def Handle_XCAFDimTolObjects_DatumObject_GetRefCount(t):
    return _XCAFDimTolObjects.Handle_XCAFDimTolObjects_DatumObject_GetRefCount(t)
...
def Handle_XCAFDimTolObjects_DimensionObject_ForceRelease(t):
    return _XCAFDimTolObjects.Handle_XCAFDimTolObjects_DimensionObject_ForceRelease(t)

def Handle_XCAFDimTolObjects_DimensionObject_GetRefCount(t):
    return _XCAFDimTolObjects.Handle_XCAFDimTolObjects_DimensionObject_GetRefCount(t)
...
def Handle_XCAFDimTolObjects_GeomToleranceObject_ForceRelease(t):
    return _XCAFDimTolObjects.Handle_XCAFDimTolObjects_GeomToleranceObject_ForceRelease(t)

def Handle_XCAFDimTolObjects_GeomToleranceObject_GetRefCount(t):
    return _XCAFDimTolObjects.Handle_XCAFDimTolObjects_GeomToleranceObject_GetRefCount(t)
