...
PYTHONOCC_DEBUG_EXCEPTIONS = _Message.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Message.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Message.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Message.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Message.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Message_Alert_ForceRelease(t):
    return _Message.Handle_Message_Alert_ForceRelease(t)

def Handle_Message_Alert_GetRefCount(t):
    return _Message.Handle_Message_Alert_GetRefCount(t)
...
def Handle_Message_Algorithm_ForceRelease(t):
    return _Message.Handle_Message_Algorithm_ForceRelease(t)

def Handle_Message_Algorithm_GetRefCount(t):
    return _Message.Handle_Message_Algorithm_GetRefCount(t)
...
def Handle_Message_Attribute_ForceRelease(t):
    return _Message.Handle_Message_Attribute_ForceRelease(t)

def Handle_Message_Attribute_GetRefCount(t):
    return _Message.Handle_Message_Attribute_GetRefCount(t)
...
def Handle_Message_CompositeAlerts_ForceRelease(t):
    return _Message.Handle_Message_CompositeAlerts_ForceRelease(t)

def Handle_Message_CompositeAlerts_GetRefCount(t):
    return _Message.Handle_Message_CompositeAlerts_GetRefCount(t)
...
def Handle_Message_Messenger_ForceRelease(t):
    return _Message.Handle_Message_Messenger_ForceRelease(t)

def Handle_Message_Messenger_GetRefCount(t):
    return _Message.Handle_Message_Messenger_GetRefCount(t)
...
def Handle_Message_Printer_ForceRelease(t):
    return _Message.Handle_Message_Printer_ForceRelease(t)

def Handle_Message_Printer_GetRefCount(t):
    return _Message.Handle_Message_Printer_GetRefCount(t)
...
def Handle_Message_ProgressIndicator_ForceRelease(t):
    return _Message.Handle_Message_ProgressIndicator_ForceRelease(t)

def Handle_Message_ProgressIndicator_GetRefCount(t):
    return _Message.Handle_Message_ProgressIndicator_GetRefCount(t)
...
def Handle_Message_Report_ForceRelease(t):
    return _Message.Handle_Message_Report_ForceRelease(t)

def Handle_Message_Report_GetRefCount(t):
    return _Message.Handle_Message_Report_GetRefCount(t)
...
def Handle_Message_AlertExtended_ForceRelease(t):
    return _Message.Handle_Message_AlertExtended_ForceRelease(t)

def Handle_Message_AlertExtended_GetRefCount(t):
    return _Message.Handle_Message_AlertExtended_GetRefCount(t)
...
def Handle_Message_AttributeMeter_ForceRelease(t):
    return _Message.Handle_Message_AttributeMeter_ForceRelease(t)

def Handle_Message_AttributeMeter_GetRefCount(t):
    return _Message.Handle_Message_AttributeMeter_GetRefCount(t)
...
def Handle_Message_AttributeObject_ForceRelease(t):
    return _Message.Handle_Message_AttributeObject_ForceRelease(t)

def Handle_Message_AttributeObject_GetRefCount(t):
    return _Message.Handle_Message_AttributeObject_GetRefCount(t)
...
def Handle_Message_AttributeStream_ForceRelease(t):
    return _Message.Handle_Message_AttributeStream_ForceRelease(t)

def Handle_Message_AttributeStream_GetRefCount(t):
    return _Message.Handle_Message_AttributeStream_GetRefCount(t)
...
def Handle_Message_PrinterOStream_ForceRelease(t):
    return _Message.Handle_Message_PrinterOStream_ForceRelease(t)

def Handle_Message_PrinterOStream_GetRefCount(t):
    return _Message.Handle_Message_PrinterOStream_GetRefCount(t)
...
def Handle_Message_PrinterSystemLog_ForceRelease(t):
    return _Message.Handle_Message_PrinterSystemLog_ForceRelease(t)

def Handle_Message_PrinterSystemLog_GetRefCount(t):
    return _Message.Handle_Message_PrinterSystemLog_GetRefCount(t)
...
def Handle_Message_PrinterToReport_ForceRelease(t):
    return _Message.Handle_Message_PrinterToReport_ForceRelease(t)

def Handle_Message_PrinterToReport_GetRefCount(t):
    return _Message.Handle_Message_PrinterToReport_GetRefCount(t)
