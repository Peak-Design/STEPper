...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepAdaptor.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepAdaptor.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepAdaptor.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepAdaptor.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepAdaptor.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepAdaptor_CompCurve_ForceRelease(t):
    return _BRepAdaptor.Handle_BRepAdaptor_CompCurve_ForceRelease(t)

def Handle_BRepAdaptor_CompCurve_GetRefCount(t):
    return _BRepAdaptor.Handle_BRepAdaptor_CompCurve_GetRefCount(t)
...
def Handle_BRepAdaptor_Curve_ForceRelease(t):
    return _BRepAdaptor.Handle_BRepAdaptor_Curve_ForceRelease(t)

def Handle_BRepAdaptor_Curve_GetRefCount(t):
    return _BRepAdaptor.Handle_BRepAdaptor_Curve_GetRefCount(t)
...
def Handle_BRepAdaptor_Curve2d_ForceRelease(t):
    return _BRepAdaptor.Handle_BRepAdaptor_Curve2d_ForceRelease(t)

def Handle_BRepAdaptor_Curve2d_GetRefCount(t):
    return _BRepAdaptor.Handle_BRepAdaptor_Curve2d_GetRefCount(t)
...
def Handle_BRepAdaptor_Surface_ForceRelease(t):
    return _BRepAdaptor.Handle_BRepAdaptor_Surface_ForceRelease(t)

def Handle_BRepAdaptor_Surface_GetRefCount(t):
    return _BRepAdaptor.Handle_BRepAdaptor_Surface_GetRefCount(t)
...
def Handle_BRepAdaptor_HArray1OfCurve_ForceRelease(t):
    return _BRepAdaptor.Handle_BRepAdaptor_HArray1OfCurve_ForceRelease(t)

def Handle_BRepAdaptor_HArray1OfCurve_GetRefCount(t):
    return _BRepAdaptor.Handle_BRepAdaptor_HArray1OfCurve_GetRefCount(t)
