...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_rwobj.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _RWObj.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _RWObj.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _RWObj.get_readable_method_name(method_name)

def get_exception_type(error):
    return _RWObj.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _RWObj.process_opencascade_exception(error, method_name, class_name)
...
def Handle_RWObj_CafWriter_ForceRelease(t):
    return _RWObj.Handle_RWObj_CafWriter_ForceRelease(t)

def Handle_RWObj_CafWriter_GetRefCount(t):
    return _RWObj.Handle_RWObj_CafWriter_GetRefCount(t)
...
def Handle_RWObj_ObjMaterialMap_ForceRelease(t):
    return _RWObj.Handle_RWObj_ObjMaterialMap_ForceRelease(t)

def Handle_RWObj_ObjMaterialMap_GetRefCount(t):
    return _RWObj.Handle_RWObj_ObjMaterialMap_GetRefCount(t)
...
def Handle_RWObj_Reader_ForceRelease(t):
    return _RWObj.Handle_RWObj_Reader_ForceRelease(t)

def Handle_RWObj_Reader_GetRefCount(t):
    return _RWObj.Handle_RWObj_Reader_GetRefCount(t)
...
def Handle_RWObj_CafReader_ForceRelease(t):
    return _RWObj.Handle_RWObj_CafReader_ForceRelease(t)

def Handle_RWObj_CafReader_GetRefCount(t):
    return _RWObj.Handle_RWObj_CafReader_GetRefCount(t)
...
def Handle_RWObj_TriangulationReader_ForceRelease(t):
    return _RWObj.Handle_RWObj_TriangulationReader_ForceRelease(t)

def Handle_RWObj_TriangulationReader_GetRefCount(t):
    return _RWObj.Handle_RWObj_TriangulationReader_GetRefCount(t)
class rwobj(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
