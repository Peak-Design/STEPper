...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_plate.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _Plate.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Plate.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Plate.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Plate.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Plate.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Plate_HArray1OfPinpointConstraint_ForceRelease(t):
    return _Plate.Handle_Plate_HArray1OfPinpointConstraint_ForceRelease(t)

def Handle_Plate_HArray1OfPinpointConstraint_GetRefCount(t):
    return _Plate.Handle_Plate_HArray1OfPinpointConstraint_GetRefCount(t)
