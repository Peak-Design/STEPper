...
PYTHONOCC_DEBUG_EXCEPTIONS = _MAT2d.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _MAT2d.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _MAT2d.get_readable_method_name(method_name)

def get_exception_type(error):
    return _MAT2d.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _MAT2d.process_opencascade_exception(error, method_name, class_name)
...
def Handle_MAT2d_Circuit_ForceRelease(t):
    return _MAT2d.Handle_MAT2d_Circuit_ForceRelease(t)

def Handle_MAT2d_Circuit_GetRefCount(t):
    return _MAT2d.Handle_MAT2d_Circuit_GetRefCount(t)
...
def Handle_MAT2d_Connexion_ForceRelease(t):
    return _MAT2d.Handle_MAT2d_Connexion_ForceRelease(t)

def Handle_MAT2d_Connexion_GetRefCount(t):
    return _MAT2d.Handle_MAT2d_Connexion_GetRefCount(t)
