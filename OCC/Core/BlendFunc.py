...
PYTHONOCC_DEBUG_EXCEPTIONS = _BlendFunc.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BlendFunc.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BlendFunc.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BlendFunc.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BlendFunc.process_opencascade_exception(error, method_name, class_name)
