...
PYTHONOCC_DEBUG_EXCEPTIONS = _ShapeAlgo.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _ShapeAlgo.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _ShapeAlgo.get_readable_method_name(method_name)

def get_exception_type(error):
    return _ShapeAlgo.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _ShapeAlgo.process_opencascade_exception(error, method_name, class_name)
...
def Handle_ShapeAlgo_ToolContainer_ForceRelease(t):
    return _ShapeAlgo.Handle_ShapeAlgo_ToolContainer_ForceRelease(t)

def Handle_ShapeAlgo_ToolContainer_GetRefCount(t):
    return _ShapeAlgo.Handle_ShapeAlgo_ToolContainer_GetRefCount(t)
