...
PYTHONOCC_DEBUG_EXCEPTIONS = _TNaming.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TNaming.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TNaming.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TNaming.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TNaming.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TNaming_DeltaOnModification_ForceRelease(t):
    return _TNaming.Handle_TNaming_DeltaOnModification_ForceRelease(t)

def Handle_TNaming_DeltaOnModification_GetRefCount(t):
    return _TNaming.Handle_TNaming_DeltaOnModification_GetRefCount(t)
...
def Handle_TNaming_DeltaOnRemoval_ForceRelease(t):
    return _TNaming.Handle_TNaming_DeltaOnRemoval_ForceRelease(t)

def Handle_TNaming_DeltaOnRemoval_GetRefCount(t):
    return _TNaming.Handle_TNaming_DeltaOnRemoval_GetRefCount(t)
...
def Handle_TNaming_NamedShape_ForceRelease(t):
    return _TNaming.Handle_TNaming_NamedShape_ForceRelease(t)

def Handle_TNaming_NamedShape_GetRefCount(t):
    return _TNaming.Handle_TNaming_NamedShape_GetRefCount(t)
...
def Handle_TNaming_Naming_ForceRelease(t):
    return _TNaming.Handle_TNaming_Naming_ForceRelease(t)

def Handle_TNaming_Naming_GetRefCount(t):
    return _TNaming.Handle_TNaming_Naming_GetRefCount(t)
...
def Handle_TNaming_TranslateTool_ForceRelease(t):
    return _TNaming.Handle_TNaming_TranslateTool_ForceRelease(t)

def Handle_TNaming_TranslateTool_GetRefCount(t):
    return _TNaming.Handle_TNaming_TranslateTool_GetRefCount(t)
...
def Handle_TNaming_UsedShapes_ForceRelease(t):
    return _TNaming.Handle_TNaming_UsedShapes_ForceRelease(t)

def Handle_TNaming_UsedShapes_GetRefCount(t):
    return _TNaming.Handle_TNaming_UsedShapes_GetRefCount(t)
