...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_xscontrol.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _XSControl.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XSControl.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XSControl.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XSControl.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XSControl.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XSControl_ConnectedShapes_ForceRelease(t):
    return _XSControl.Handle_XSControl_ConnectedShapes_ForceRelease(t)

def Handle_XSControl_ConnectedShapes_GetRefCount(t):
    return _XSControl.Handle_XSControl_ConnectedShapes_GetRefCount(t)
...
def Handle_XSControl_Controller_ForceRelease(t):
    return _XSControl.Handle_XSControl_Controller_ForceRelease(t)

def Handle_XSControl_Controller_GetRefCount(t):
    return _XSControl.Handle_XSControl_Controller_GetRefCount(t)
...
def Handle_XSControl_SelectForTransfer_ForceRelease(t):
    return _XSControl.Handle_XSControl_SelectForTransfer_ForceRelease(t)

def Handle_XSControl_SelectForTransfer_GetRefCount(t):
    return _XSControl.Handle_XSControl_SelectForTransfer_GetRefCount(t)
...
def Handle_XSControl_SignTransferStatus_ForceRelease(t):
    return _XSControl.Handle_XSControl_SignTransferStatus_ForceRelease(t)

def Handle_XSControl_SignTransferStatus_GetRefCount(t):
    return _XSControl.Handle_XSControl_SignTransferStatus_GetRefCount(t)
...
def Handle_XSControl_TransferReader_ForceRelease(t):
    return _XSControl.Handle_XSControl_TransferReader_ForceRelease(t)

def Handle_XSControl_TransferReader_GetRefCount(t):
    return _XSControl.Handle_XSControl_TransferReader_GetRefCount(t)
...
def Handle_XSControl_TransferWriter_ForceRelease(t):
    return _XSControl.Handle_XSControl_TransferWriter_ForceRelease(t)

def Handle_XSControl_TransferWriter_GetRefCount(t):
    return _XSControl.Handle_XSControl_TransferWriter_GetRefCount(t)
...
def Handle_XSControl_Vars_ForceRelease(t):
    return _XSControl.Handle_XSControl_Vars_ForceRelease(t)

def Handle_XSControl_Vars_GetRefCount(t):
    return _XSControl.Handle_XSControl_Vars_GetRefCount(t)
...
def Handle_XSControl_WorkSession_ForceRelease(t):
    return _XSControl.Handle_XSControl_WorkSession_ForceRelease(t)

def Handle_XSControl_WorkSession_GetRefCount(t):
    return _XSControl.Handle_XSControl_WorkSession_GetRefCount(t)
...
class XSControl_Reader(object):
    ...
    def GetShapeFixParameters(self, *args):
        ...
        """
        return _XSControl.XSControl_Reader_GetShapeFixParameters(self, *args)
    ...
    def GetShapeProcessFlags(self, *args):
        ...
        """
        return _XSControl.XSControl_Reader_GetShapeProcessFlags(self, *args)
    ...
    def SetShapeFixParameters(self, *args):
        ...
        """
        return _XSControl.XSControl_Reader_SetShapeFixParameters(self, *args)
    ...
    def SetShapeProcessFlags(self, *args):
        ...
        """
        return _XSControl.XSControl_Reader_SetShapeProcessFlags(self, *args)
