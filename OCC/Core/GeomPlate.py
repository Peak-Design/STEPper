...
PYTHONOCC_DEBUG_EXCEPTIONS = _GeomPlate.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _GeomPlate.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _GeomPlate.get_readable_method_name(method_name)

def get_exception_type(error):
    return _GeomPlate.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _GeomPlate.process_opencascade_exception(error, method_name, class_name)
...
def Handle_GeomPlate_CurveConstraint_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_CurveConstraint_ForceRelease(t)

def Handle_GeomPlate_CurveConstraint_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_CurveConstraint_GetRefCount(t)
...
def Handle_GeomPlate_PointConstraint_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_PointConstraint_ForceRelease(t)

def Handle_GeomPlate_PointConstraint_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_PointConstraint_GetRefCount(t)
...
def Handle_GeomPlate_Surface_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_Surface_ForceRelease(t)

def Handle_GeomPlate_Surface_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_Surface_GetRefCount(t)
...
def Handle_GeomPlate_HArray1OfHCurve_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_HArray1OfHCurve_ForceRelease(t)

def Handle_GeomPlate_HArray1OfHCurve_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_HArray1OfHCurve_GetRefCount(t)
...
def Handle_GeomPlate_HArray1OfSequenceOfReal_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_HArray1OfSequenceOfReal_ForceRelease(t)

def Handle_GeomPlate_HArray1OfSequenceOfReal_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_HArray1OfSequenceOfReal_GetRefCount(t)
...
def Handle_GeomPlate_HSequenceOfCurveConstraint_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_HSequenceOfCurveConstraint_ForceRelease(t)

def Handle_GeomPlate_HSequenceOfCurveConstraint_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_HSequenceOfCurveConstraint_GetRefCount(t)
...
def Handle_GeomPlate_HSequenceOfPointConstraint_ForceRelease(t):
    return _GeomPlate.Handle_GeomPlate_HSequenceOfPointConstraint_ForceRelease(t)

def Handle_GeomPlate_HSequenceOfPointConstraint_GetRefCount(t):
    return _GeomPlate.Handle_GeomPlate_HSequenceOfPointConstraint_GetRefCount(t)
