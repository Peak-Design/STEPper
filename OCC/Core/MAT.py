...
PYTHONOCC_DEBUG_EXCEPTIONS = _MAT.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _MAT.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _MAT.get_readable_method_name(method_name)

def get_exception_type(error):
    return _MAT.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _MAT.process_opencascade_exception(error, method_name, class_name)
...
def Handle_MAT_Arc_ForceRelease(t):
    return _MAT.Handle_MAT_Arc_ForceRelease(t)

def Handle_MAT_Arc_GetRefCount(t):
    return _MAT.Handle_MAT_Arc_GetRefCount(t)
...
def Handle_MAT_BasicElt_ForceRelease(t):
    return _MAT.Handle_MAT_BasicElt_ForceRelease(t)

def Handle_MAT_BasicElt_GetRefCount(t):
    return _MAT.Handle_MAT_BasicElt_GetRefCount(t)
...
def Handle_MAT_Bisector_ForceRelease(t):
    return _MAT.Handle_MAT_Bisector_ForceRelease(t)

def Handle_MAT_Bisector_GetRefCount(t):
    return _MAT.Handle_MAT_Bisector_GetRefCount(t)
...
def Handle_MAT_Edge_ForceRelease(t):
    return _MAT.Handle_MAT_Edge_ForceRelease(t)

def Handle_MAT_Edge_GetRefCount(t):
    return _MAT.Handle_MAT_Edge_GetRefCount(t)
...
def Handle_MAT_Graph_ForceRelease(t):
    return _MAT.Handle_MAT_Graph_ForceRelease(t)

def Handle_MAT_Graph_GetRefCount(t):
    return _MAT.Handle_MAT_Graph_GetRefCount(t)
...
def Handle_MAT_ListOfBisector_ForceRelease(t):
    return _MAT.Handle_MAT_ListOfBisector_ForceRelease(t)

def Handle_MAT_ListOfBisector_GetRefCount(t):
    return _MAT.Handle_MAT_ListOfBisector_GetRefCount(t)
...
def Handle_MAT_ListOfEdge_ForceRelease(t):
    return _MAT.Handle_MAT_ListOfEdge_ForceRelease(t)

def Handle_MAT_ListOfEdge_GetRefCount(t):
    return _MAT.Handle_MAT_ListOfEdge_GetRefCount(t)
...
def Handle_MAT_Node_ForceRelease(t):
    return _MAT.Handle_MAT_Node_ForceRelease(t)

def Handle_MAT_Node_GetRefCount(t):
    return _MAT.Handle_MAT_Node_GetRefCount(t)
...
def Handle_MAT_TListNodeOfListOfBisector_ForceRelease(t):
    return _MAT.Handle_MAT_TListNodeOfListOfBisector_ForceRelease(t)

def Handle_MAT_TListNodeOfListOfBisector_GetRefCount(t):
    return _MAT.Handle_MAT_TListNodeOfListOfBisector_GetRefCount(t)
...
def Handle_MAT_TListNodeOfListOfEdge_ForceRelease(t):
    return _MAT.Handle_MAT_TListNodeOfListOfEdge_ForceRelease(t)

def Handle_MAT_TListNodeOfListOfEdge_GetRefCount(t):
    return _MAT.Handle_MAT_TListNodeOfListOfEdge_GetRefCount(t)
...
def Handle_MAT_Zone_ForceRelease(t):
    return _MAT.Handle_MAT_Zone_ForceRelease(t)

def Handle_MAT_Zone_GetRefCount(t):
    return _MAT.Handle_MAT_Zone_GetRefCount(t)
