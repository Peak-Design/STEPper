...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_imeshtools.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _IMeshTools.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _IMeshTools.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _IMeshTools.get_readable_method_name(method_name)

def get_exception_type(error):
    return _IMeshTools.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _IMeshTools.process_opencascade_exception(error, method_name, class_name)
...
def Handle_IMeshTools_Context_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_Context_ForceRelease(t)

def Handle_IMeshTools_Context_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_Context_GetRefCount(t)
...
def Handle_IMeshTools_CurveTessellator_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_CurveTessellator_ForceRelease(t)

def Handle_IMeshTools_CurveTessellator_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_CurveTessellator_GetRefCount(t)
...
def Handle_IMeshTools_MeshAlgo_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_MeshAlgo_ForceRelease(t)

def Handle_IMeshTools_MeshAlgo_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_MeshAlgo_GetRefCount(t)
...
def Handle_IMeshTools_MeshAlgoFactory_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_MeshAlgoFactory_ForceRelease(t)

def Handle_IMeshTools_MeshAlgoFactory_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_MeshAlgoFactory_GetRefCount(t)

def Handle_IMeshTools_MeshBuilder_Create():
    return _IMeshTools.Handle_IMeshTools_MeshBuilder_Create()

def Handle_IMeshTools_MeshBuilder_DownCast(t):
    return _IMeshTools.Handle_IMeshTools_MeshBuilder_DownCast(t)

def Handle_IMeshTools_MeshBuilder_IsNull(t):
    return _IMeshTools.Handle_IMeshTools_MeshBuilder_IsNull(t)

def Handle_IMeshTools_MeshBuilder_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_MeshBuilder_ForceRelease(t)

def Handle_IMeshTools_MeshBuilder_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_MeshBuilder_GetRefCount(t)
...
def Handle_IMeshTools_ModelAlgo_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_ModelAlgo_ForceRelease(t)

def Handle_IMeshTools_ModelAlgo_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_ModelAlgo_GetRefCount(t)

def Handle_IMeshTools_ModelBuilder_Create():
    return _IMeshTools.Handle_IMeshTools_ModelBuilder_Create()

def Handle_IMeshTools_ModelBuilder_DownCast(t):
    return _IMeshTools.Handle_IMeshTools_ModelBuilder_DownCast(t)

def Handle_IMeshTools_ModelBuilder_IsNull(t):
    return _IMeshTools.Handle_IMeshTools_ModelBuilder_IsNull(t)

def Handle_IMeshTools_ModelBuilder_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_ModelBuilder_ForceRelease(t)

def Handle_IMeshTools_ModelBuilder_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_ModelBuilder_GetRefCount(t)
...
def Handle_IMeshTools_ShapeExplorer_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_ShapeExplorer_ForceRelease(t)

def Handle_IMeshTools_ShapeExplorer_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_ShapeExplorer_GetRefCount(t)
...
def Handle_IMeshTools_ShapeVisitor_ForceRelease(t):
    return _IMeshTools.Handle_IMeshTools_ShapeVisitor_ForceRelease(t)

def Handle_IMeshTools_ShapeVisitor_GetRefCount(t):
    return _IMeshTools.Handle_IMeshTools_ShapeVisitor_GetRefCount(t)
class IMeshTools_Context(OCC.Core.IMeshData.IMeshData_Shape):
    ...
    def GetModelBuilder(self, *args):
        r"""
        Return
        -------
        opencascade::handle<IMeshTools_ModelBuilder>
    ...
    def SetEdgeDiscret(self, *args):
        ...
        Parameters
        ----------
        theEdgeDiscret: IMeshTools_ModelAlgo
    ...
    def SetModelBuilder(self, *args):
        ...
        Parameters
        ----------
        theBuilder: IMeshTools_ModelBuilder
...
class IMeshTools_MeshBuilder(OCC.Core.Message.Message_Algorithm):
    ...
    def GetContext(self, *args):
        ...
        Return
        -------
        opencascade::handle<IMeshTools_Context>
    ...
    @staticmethod
    def DownCast(t):
      return Handle_IMeshTools_MeshBuilder_DownCast(t)
...
class IMeshTools_ModelBuilder(OCC.Core.Message.Message_Algorithm):
    ...
    @staticmethod
    def DownCast(t):
      return Handle_IMeshTools_ModelBuilder_DownCast(t)
...
class IMeshTools_ShapeExplorer(OCC.Core.IMeshData.IMeshData_Shape):
    ...
    def Accept(self, *args):
        ...
        Parameters
        ----------
        theVisitor: IMeshTools_ShapeVisitor
