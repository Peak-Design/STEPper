...
PYTHONOCC_DEBUG_EXCEPTIONS = _TDataXtd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TDataXtd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TDataXtd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TDataXtd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TDataXtd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TDataXtd_Axis_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Axis_ForceRelease(t)

def Handle_TDataXtd_Axis_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Axis_GetRefCount(t)
...
def Handle_TDataXtd_Constraint_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Constraint_ForceRelease(t)

def Handle_TDataXtd_Constraint_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Constraint_GetRefCount(t)
...
def Handle_TDataXtd_Geometry_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Geometry_ForceRelease(t)

def Handle_TDataXtd_Geometry_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Geometry_GetRefCount(t)
...
def Handle_TDataXtd_Pattern_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Pattern_ForceRelease(t)

def Handle_TDataXtd_Pattern_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Pattern_GetRefCount(t)
...
def Handle_TDataXtd_Placement_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Placement_ForceRelease(t)

def Handle_TDataXtd_Placement_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Placement_GetRefCount(t)
...
def Handle_TDataXtd_Plane_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Plane_ForceRelease(t)

def Handle_TDataXtd_Plane_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Plane_GetRefCount(t)
...
def Handle_TDataXtd_Point_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Point_ForceRelease(t)

def Handle_TDataXtd_Point_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Point_GetRefCount(t)
...
def Handle_TDataXtd_Position_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Position_ForceRelease(t)

def Handle_TDataXtd_Position_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Position_GetRefCount(t)
...
def Handle_TDataXtd_Presentation_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Presentation_ForceRelease(t)

def Handle_TDataXtd_Presentation_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Presentation_GetRefCount(t)
...
def Handle_TDataXtd_Shape_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Shape_ForceRelease(t)

def Handle_TDataXtd_Shape_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Shape_GetRefCount(t)
...
def Handle_TDataXtd_Triangulation_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_Triangulation_ForceRelease(t)

def Handle_TDataXtd_Triangulation_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_Triangulation_GetRefCount(t)
...
def Handle_TDataXtd_PatternStd_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_PatternStd_ForceRelease(t)

def Handle_TDataXtd_PatternStd_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_PatternStd_GetRefCount(t)
...
def Handle_TDataXtd_HArray1OfTrsf_ForceRelease(t):
    return _TDataXtd.Handle_TDataXtd_HArray1OfTrsf_ForceRelease(t)

def Handle_TDataXtd_HArray1OfTrsf_GetRefCount(t):
    return _TDataXtd.Handle_TDataXtd_HArray1OfTrsf_GetRefCount(t)
