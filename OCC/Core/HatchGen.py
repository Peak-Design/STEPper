...
PYTHONOCC_DEBUG_EXCEPTIONS = _HatchGen.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _HatchGen.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _HatchGen.get_readable_method_name(method_name)

def get_exception_type(error):
    return _HatchGen.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _HatchGen.process_opencascade_exception(error, method_name, class_name)
