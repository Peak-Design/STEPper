...
PYTHONOCC_DEBUG_EXCEPTIONS = _TopOpeBRepTool.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TopOpeBRepTool.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TopOpeBRepTool.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TopOpeBRepTool.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TopOpeBRepTool.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TopOpeBRepTool_HBoxTool_ForceRelease(t):
    return _TopOpeBRepTool.Handle_TopOpeBRepTool_HBoxTool_ForceRelease(t)

def Handle_TopOpeBRepTool_HBoxTool_GetRefCount(t):
    return _TopOpeBRepTool.Handle_TopOpeBRepTool_HBoxTool_GetRefCount(t)
