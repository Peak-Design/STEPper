...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_tobj.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _TObj.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TObj.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TObj.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TObj.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TObj.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TObj_Application_ForceRelease(t):
    return _TObj.Handle_TObj_Application_ForceRelease(t)

def Handle_TObj_Application_GetRefCount(t):
    return _TObj.Handle_TObj_Application_GetRefCount(t)
...
def Handle_TObj_CheckModel_ForceRelease(t):
    return _TObj.Handle_TObj_CheckModel_ForceRelease(t)

def Handle_TObj_CheckModel_GetRefCount(t):
    return _TObj.Handle_TObj_CheckModel_GetRefCount(t)
...
def Handle_TObj_Model_ForceRelease(t):
    return _TObj.Handle_TObj_Model_ForceRelease(t)

def Handle_TObj_Model_GetRefCount(t):
    return _TObj.Handle_TObj_Model_GetRefCount(t)
...
def Handle_TObj_Object_ForceRelease(t):
    return _TObj.Handle_TObj_Object_ForceRelease(t)

def Handle_TObj_Object_GetRefCount(t):
    return _TObj.Handle_TObj_Object_GetRefCount(t)
...
def Handle_TObj_ObjectIterator_ForceRelease(t):
    return _TObj.Handle_TObj_ObjectIterator_ForceRelease(t)

def Handle_TObj_ObjectIterator_GetRefCount(t):
    return _TObj.Handle_TObj_ObjectIterator_GetRefCount(t)
...
def Handle_TObj_TIntSparseArray_ForceRelease(t):
    return _TObj.Handle_TObj_TIntSparseArray_ForceRelease(t)

def Handle_TObj_TIntSparseArray_GetRefCount(t):
    return _TObj.Handle_TObj_TIntSparseArray_GetRefCount(t)
...
def Handle_TObj_TModel_ForceRelease(t):
    return _TObj.Handle_TObj_TModel_ForceRelease(t)

def Handle_TObj_TModel_GetRefCount(t):
    return _TObj.Handle_TObj_TModel_GetRefCount(t)
...
def Handle_TObj_TNameContainer_ForceRelease(t):
    return _TObj.Handle_TObj_TNameContainer_ForceRelease(t)

def Handle_TObj_TNameContainer_GetRefCount(t):
    return _TObj.Handle_TObj_TNameContainer_GetRefCount(t)
...
def Handle_TObj_TObject_ForceRelease(t):
    return _TObj.Handle_TObj_TObject_ForceRelease(t)

def Handle_TObj_TObject_GetRefCount(t):
    return _TObj.Handle_TObj_TObject_GetRefCount(t)
...
def Handle_TObj_TReference_ForceRelease(t):
    return _TObj.Handle_TObj_TReference_ForceRelease(t)

def Handle_TObj_TReference_GetRefCount(t):
    return _TObj.Handle_TObj_TReference_GetRefCount(t)
...
def Handle_TObj_TXYZ_ForceRelease(t):
    return _TObj.Handle_TObj_TXYZ_ForceRelease(t)

def Handle_TObj_TXYZ_GetRefCount(t):
    return _TObj.Handle_TObj_TXYZ_GetRefCount(t)
...
def Handle_TObj_LabelIterator_ForceRelease(t):
    return _TObj.Handle_TObj_LabelIterator_ForceRelease(t)

def Handle_TObj_LabelIterator_GetRefCount(t):
    return _TObj.Handle_TObj_LabelIterator_GetRefCount(t)
...
def Handle_TObj_ModelIterator_ForceRelease(t):
    return _TObj.Handle_TObj_ModelIterator_ForceRelease(t)

def Handle_TObj_ModelIterator_GetRefCount(t):
    return _TObj.Handle_TObj_ModelIterator_GetRefCount(t)
...
def Handle_TObj_Partition_ForceRelease(t):
    return _TObj.Handle_TObj_Partition_ForceRelease(t)

def Handle_TObj_Partition_GetRefCount(t):
    return _TObj.Handle_TObj_Partition_GetRefCount(t)
...
def Handle_TObj_SequenceIterator_ForceRelease(t):
    return _TObj.Handle_TObj_SequenceIterator_ForceRelease(t)

def Handle_TObj_SequenceIterator_GetRefCount(t):
    return _TObj.Handle_TObj_SequenceIterator_GetRefCount(t)
...
def Handle_TObj_HiddenPartition_ForceRelease(t):
    return _TObj.Handle_TObj_HiddenPartition_ForceRelease(t)

def Handle_TObj_HiddenPartition_GetRefCount(t):
    return _TObj.Handle_TObj_HiddenPartition_GetRefCount(t)
...
def Handle_TObj_OcafObjectIterator_ForceRelease(t):
    return _TObj.Handle_TObj_OcafObjectIterator_ForceRelease(t)

def Handle_TObj_OcafObjectIterator_GetRefCount(t):
    return _TObj.Handle_TObj_OcafObjectIterator_GetRefCount(t)
...
def Handle_TObj_ReferenceIterator_ForceRelease(t):
    return _TObj.Handle_TObj_ReferenceIterator_ForceRelease(t)

def Handle_TObj_ReferenceIterator_GetRefCount(t):
    return _TObj.Handle_TObj_ReferenceIterator_GetRefCount(t)
...
def Handle_TObj_HSequenceOfObject_ForceRelease(t):
    return _TObj.Handle_TObj_HSequenceOfObject_ForceRelease(t)

def Handle_TObj_HSequenceOfObject_GetRefCount(t):
    return _TObj.Handle_TObj_HSequenceOfObject_GetRefCount(t)
