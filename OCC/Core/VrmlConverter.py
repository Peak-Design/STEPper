...
PYTHONOCC_DEBUG_EXCEPTIONS = _VrmlConverter.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _VrmlConverter.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _VrmlConverter.get_readable_method_name(method_name)

def get_exception_type(error):
    return _VrmlConverter.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _VrmlConverter.process_opencascade_exception(error, method_name, class_name)
...
def Handle_VrmlConverter_Drawer_ForceRelease(t):
    return _VrmlConverter.Handle_VrmlConverter_Drawer_ForceRelease(t)

def Handle_VrmlConverter_Drawer_GetRefCount(t):
    return _VrmlConverter.Handle_VrmlConverter_Drawer_GetRefCount(t)
...
def Handle_VrmlConverter_LineAspect_ForceRelease(t):
    return _VrmlConverter.Handle_VrmlConverter_LineAspect_ForceRelease(t)

def Handle_VrmlConverter_LineAspect_GetRefCount(t):
    return _VrmlConverter.Handle_VrmlConverter_LineAspect_GetRefCount(t)
...
def Handle_VrmlConverter_PointAspect_ForceRelease(t):
    return _VrmlConverter.Handle_VrmlConverter_PointAspect_ForceRelease(t)

def Handle_VrmlConverter_PointAspect_GetRefCount(t):
    return _VrmlConverter.Handle_VrmlConverter_PointAspect_GetRefCount(t)
...
def Handle_VrmlConverter_Projector_ForceRelease(t):
    return _VrmlConverter.Handle_VrmlConverter_Projector_ForceRelease(t)

def Handle_VrmlConverter_Projector_GetRefCount(t):
    return _VrmlConverter.Handle_VrmlConverter_Projector_GetRefCount(t)
...
def Handle_VrmlConverter_ShadingAspect_ForceRelease(t):
    return _VrmlConverter.Handle_VrmlConverter_ShadingAspect_ForceRelease(t)

def Handle_VrmlConverter_ShadingAspect_GetRefCount(t):
    return _VrmlConverter.Handle_VrmlConverter_ShadingAspect_GetRefCount(t)
...
def Handle_VrmlConverter_IsoAspect_ForceRelease(t):
    return _VrmlConverter.Handle_VrmlConverter_IsoAspect_ForceRelease(t)

def Handle_VrmlConverter_IsoAspect_GetRefCount(t):
    return _VrmlConverter.Handle_VrmlConverter_IsoAspect_GetRefCount(t)
