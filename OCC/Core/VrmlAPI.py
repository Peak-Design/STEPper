...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_vrmlapi.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _VrmlAPI.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _VrmlAPI.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _VrmlAPI.get_readable_method_name(method_name)

def get_exception_type(error):
    return _VrmlAPI.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _VrmlAPI.process_opencascade_exception(error, method_name, class_name)
...
def Handle_VrmlAPI_CafReader_ForceRelease(t):
    return _VrmlAPI.Handle_VrmlAPI_CafReader_ForceRelease(t)

def Handle_VrmlAPI_CafReader_GetRefCount(t):
    return _VrmlAPI.Handle_VrmlAPI_CafReader_GetRefCount(t)
