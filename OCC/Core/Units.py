...
PYTHONOCC_DEBUG_EXCEPTIONS = _Units.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Units.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Units.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Units.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Units.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Units_Dimensions_ForceRelease(t):
    return _Units.Handle_Units_Dimensions_ForceRelease(t)

def Handle_Units_Dimensions_GetRefCount(t):
    return _Units.Handle_Units_Dimensions_GetRefCount(t)
...
def Handle_Units_Lexicon_ForceRelease(t):
    return _Units.Handle_Units_Lexicon_ForceRelease(t)

def Handle_Units_Lexicon_GetRefCount(t):
    return _Units.Handle_Units_Lexicon_GetRefCount(t)
...
def Handle_Units_Quantity_ForceRelease(t):
    return _Units.Handle_Units_Quantity_ForceRelease(t)

def Handle_Units_Quantity_GetRefCount(t):
    return _Units.Handle_Units_Quantity_GetRefCount(t)
...
def Handle_Units_Token_ForceRelease(t):
    return _Units.Handle_Units_Token_ForceRelease(t)

def Handle_Units_Token_GetRefCount(t):
    return _Units.Handle_Units_Token_GetRefCount(t)
...
def Handle_Units_Unit_ForceRelease(t):
    return _Units.Handle_Units_Unit_ForceRelease(t)

def Handle_Units_Unit_GetRefCount(t):
    return _Units.Handle_Units_Unit_GetRefCount(t)
...
def Handle_Units_UnitsDictionary_ForceRelease(t):
    return _Units.Handle_Units_UnitsDictionary_ForceRelease(t)

def Handle_Units_UnitsDictionary_GetRefCount(t):
    return _Units.Handle_Units_UnitsDictionary_GetRefCount(t)
...
def Handle_Units_UnitsSystem_ForceRelease(t):
    return _Units.Handle_Units_UnitsSystem_ForceRelease(t)

def Handle_Units_UnitsSystem_GetRefCount(t):
    return _Units.Handle_Units_UnitsSystem_GetRefCount(t)
...
def Handle_Units_ShiftedToken_ForceRelease(t):
    return _Units.Handle_Units_ShiftedToken_ForceRelease(t)

def Handle_Units_ShiftedToken_GetRefCount(t):
    return _Units.Handle_Units_ShiftedToken_GetRefCount(t)
...
def Handle_Units_ShiftedUnit_ForceRelease(t):
    return _Units.Handle_Units_ShiftedUnit_ForceRelease(t)

def Handle_Units_ShiftedUnit_GetRefCount(t):
    return _Units.Handle_Units_ShiftedUnit_GetRefCount(t)
...
def Handle_Units_UnitsLexicon_ForceRelease(t):
    return _Units.Handle_Units_UnitsLexicon_ForceRelease(t)

def Handle_Units_UnitsLexicon_GetRefCount(t):
    return _Units.Handle_Units_UnitsLexicon_GetRefCount(t)
...
def Handle_Units_QuantitiesSequence_ForceRelease(t):
    return _Units.Handle_Units_QuantitiesSequence_ForceRelease(t)

def Handle_Units_QuantitiesSequence_GetRefCount(t):
    return _Units.Handle_Units_QuantitiesSequence_GetRefCount(t)
...
def Handle_Units_TokensSequence_ForceRelease(t):
    return _Units.Handle_Units_TokensSequence_ForceRelease(t)

def Handle_Units_TokensSequence_GetRefCount(t):
    return _Units.Handle_Units_TokensSequence_GetRefCount(t)
...
def Handle_Units_UnitsSequence_ForceRelease(t):
    return _Units.Handle_Units_UnitsSequence_ForceRelease(t)

def Handle_Units_UnitsSequence_GetRefCount(t):
    return _Units.Handle_Units_UnitsSequence_GetRefCount(t)
