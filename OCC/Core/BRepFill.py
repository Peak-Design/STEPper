...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepFill.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepFill.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepFill.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepFill.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepFill.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepFill_CurveConstraint_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_CurveConstraint_ForceRelease(t)

def Handle_BRepFill_CurveConstraint_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_CurveConstraint_GetRefCount(t)
...
def Handle_BRepFill_LocationLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_LocationLaw_ForceRelease(t)

def Handle_BRepFill_LocationLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_LocationLaw_GetRefCount(t)
...
def Handle_BRepFill_PipeShell_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_PipeShell_ForceRelease(t)

def Handle_BRepFill_PipeShell_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_PipeShell_GetRefCount(t)
...
def Handle_BRepFill_SectionLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_SectionLaw_ForceRelease(t)

def Handle_BRepFill_SectionLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_SectionLaw_GetRefCount(t)
...
def Handle_BRepFill_ACRLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_ACRLaw_ForceRelease(t)

def Handle_BRepFill_ACRLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_ACRLaw_GetRefCount(t)
...
def Handle_BRepFill_Edge3DLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_Edge3DLaw_ForceRelease(t)

def Handle_BRepFill_Edge3DLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_Edge3DLaw_GetRefCount(t)
...
def Handle_BRepFill_EdgeOnSurfLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_EdgeOnSurfLaw_ForceRelease(t)

def Handle_BRepFill_EdgeOnSurfLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_EdgeOnSurfLaw_GetRefCount(t)
...
def Handle_BRepFill_NSections_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_NSections_ForceRelease(t)

def Handle_BRepFill_NSections_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_NSections_GetRefCount(t)
...
def Handle_BRepFill_ShapeLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_ShapeLaw_ForceRelease(t)

def Handle_BRepFill_ShapeLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_ShapeLaw_GetRefCount(t)
...
def Handle_BRepFill_DraftLaw_ForceRelease(t):
    return _BRepFill.Handle_BRepFill_DraftLaw_ForceRelease(t)

def Handle_BRepFill_DraftLaw_GetRefCount(t):
    return _BRepFill.Handle_BRepFill_DraftLaw_GetRefCount(t)
