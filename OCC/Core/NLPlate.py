...
PYTHONOCC_DEBUG_EXCEPTIONS = _NLPlate.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _NLPlate.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _NLPlate.get_readable_method_name(method_name)

def get_exception_type(error):
    return _NLPlate.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _NLPlate.process_opencascade_exception(error, method_name, class_name)
...
def Handle_NLPlate_HGPPConstraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HGPPConstraint_ForceRelease(t)

def Handle_NLPlate_HGPPConstraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HGPPConstraint_GetRefCount(t)
...
def Handle_NLPlate_HPG0Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG0Constraint_ForceRelease(t)

def Handle_NLPlate_HPG0Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG0Constraint_GetRefCount(t)
...
def Handle_NLPlate_HPG1Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG1Constraint_ForceRelease(t)

def Handle_NLPlate_HPG1Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG1Constraint_GetRefCount(t)
...
def Handle_NLPlate_HPG0G1Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG0G1Constraint_ForceRelease(t)

def Handle_NLPlate_HPG0G1Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG0G1Constraint_GetRefCount(t)
...
def Handle_NLPlate_HPG2Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG2Constraint_ForceRelease(t)

def Handle_NLPlate_HPG2Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG2Constraint_GetRefCount(t)
...
def Handle_NLPlate_HPG0G2Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG0G2Constraint_ForceRelease(t)

def Handle_NLPlate_HPG0G2Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG0G2Constraint_GetRefCount(t)
...
def Handle_NLPlate_HPG3Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG3Constraint_ForceRelease(t)

def Handle_NLPlate_HPG3Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG3Constraint_GetRefCount(t)
...
def Handle_NLPlate_HPG0G3Constraint_ForceRelease(t):
    return _NLPlate.Handle_NLPlate_HPG0G3Constraint_ForceRelease(t)

def Handle_NLPlate_HPG0G3Constraint_GetRefCount(t):
    return _NLPlate.Handle_NLPlate_HPG0G3Constraint_GetRefCount(t)
