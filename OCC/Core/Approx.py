...
PYTHONOCC_DEBUG_EXCEPTIONS = _Approx.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Approx.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Approx.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Approx.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Approx.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Approx_CurvlinFunc_ForceRelease(t):
    return _Approx.Handle_Approx_CurvlinFunc_ForceRelease(t)

def Handle_Approx_CurvlinFunc_GetRefCount(t):
    return _Approx.Handle_Approx_CurvlinFunc_GetRefCount(t)
...
def Handle_Approx_SweepFunction_ForceRelease(t):
    return _Approx.Handle_Approx_SweepFunction_ForceRelease(t)

def Handle_Approx_SweepFunction_GetRefCount(t):
    return _Approx.Handle_Approx_SweepFunction_GetRefCount(t)
...
def Handle_Approx_HArray1OfAdHSurface_ForceRelease(t):
    return _Approx.Handle_Approx_HArray1OfAdHSurface_ForceRelease(t)

def Handle_Approx_HArray1OfAdHSurface_GetRefCount(t):
    return _Approx.Handle_Approx_HArray1OfAdHSurface_GetRefCount(t)
...
def Handle_Approx_HArray1OfGTrsf2d_ForceRelease(t):
    return _Approx.Handle_Approx_HArray1OfGTrsf2d_ForceRelease(t)

def Handle_Approx_HArray1OfGTrsf2d_GetRefCount(t):
    return _Approx.Handle_Approx_HArray1OfGTrsf2d_GetRefCount(t)
