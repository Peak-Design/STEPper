...
PYTHONOCC_DEBUG_EXCEPTIONS = _GeomFill.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _GeomFill.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _GeomFill.get_readable_method_name(method_name)

def get_exception_type(error):
    return _GeomFill.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _GeomFill.process_opencascade_exception(error, method_name, class_name)
...
def Handle_GeomFill_Boundary_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_Boundary_ForceRelease(t)

def Handle_GeomFill_Boundary_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_Boundary_GetRefCount(t)
...
def Handle_GeomFill_CircularBlendFunc_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_CircularBlendFunc_ForceRelease(t)

def Handle_GeomFill_CircularBlendFunc_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_CircularBlendFunc_GetRefCount(t)
...
def Handle_GeomFill_CoonsAlgPatch_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_CoonsAlgPatch_ForceRelease(t)

def Handle_GeomFill_CoonsAlgPatch_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_CoonsAlgPatch_GetRefCount(t)
...
def Handle_GeomFill_Line_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_Line_ForceRelease(t)

def Handle_GeomFill_Line_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_Line_GetRefCount(t)
...
def Handle_GeomFill_LocationLaw_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_LocationLaw_ForceRelease(t)

def Handle_GeomFill_LocationLaw_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_LocationLaw_GetRefCount(t)
...
def Handle_GeomFill_SectionLaw_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_SectionLaw_ForceRelease(t)

def Handle_GeomFill_SectionLaw_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_SectionLaw_GetRefCount(t)
...
def Handle_GeomFill_SnglrFunc_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_SnglrFunc_ForceRelease(t)

def Handle_GeomFill_SnglrFunc_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_SnglrFunc_GetRefCount(t)
...
def Handle_GeomFill_SweepFunction_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_SweepFunction_ForceRelease(t)

def Handle_GeomFill_SweepFunction_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_SweepFunction_GetRefCount(t)
...
def Handle_GeomFill_TgtField_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_TgtField_ForceRelease(t)

def Handle_GeomFill_TgtField_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_TgtField_GetRefCount(t)
...
def Handle_GeomFill_TrihedronLaw_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_TrihedronLaw_ForceRelease(t)

def Handle_GeomFill_TrihedronLaw_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_TrihedronLaw_GetRefCount(t)
...
def Handle_GeomFill_BoundWithSurf_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_BoundWithSurf_ForceRelease(t)

def Handle_GeomFill_BoundWithSurf_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_BoundWithSurf_GetRefCount(t)
...
def Handle_GeomFill_ConstantBiNormal_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_ConstantBiNormal_ForceRelease(t)

def Handle_GeomFill_ConstantBiNormal_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_ConstantBiNormal_GetRefCount(t)
...
def Handle_GeomFill_CorrectedFrenet_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_CorrectedFrenet_ForceRelease(t)

def Handle_GeomFill_CorrectedFrenet_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_CorrectedFrenet_GetRefCount(t)
...
def Handle_GeomFill_CurveAndTrihedron_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_CurveAndTrihedron_ForceRelease(t)

def Handle_GeomFill_CurveAndTrihedron_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_CurveAndTrihedron_GetRefCount(t)
...
def Handle_GeomFill_Darboux_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_Darboux_ForceRelease(t)

def Handle_GeomFill_Darboux_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_Darboux_GetRefCount(t)
...
def Handle_GeomFill_DegeneratedBound_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_DegeneratedBound_ForceRelease(t)

def Handle_GeomFill_DegeneratedBound_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_DegeneratedBound_GetRefCount(t)
...
def Handle_GeomFill_DiscreteTrihedron_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_DiscreteTrihedron_ForceRelease(t)

def Handle_GeomFill_DiscreteTrihedron_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_DiscreteTrihedron_GetRefCount(t)
...
def Handle_GeomFill_DraftTrihedron_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_DraftTrihedron_ForceRelease(t)

def Handle_GeomFill_DraftTrihedron_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_DraftTrihedron_GetRefCount(t)
...
def Handle_GeomFill_EvolvedSection_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_EvolvedSection_ForceRelease(t)

def Handle_GeomFill_EvolvedSection_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_EvolvedSection_GetRefCount(t)
...
def Handle_GeomFill_Fixed_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_Fixed_ForceRelease(t)

def Handle_GeomFill_Fixed_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_Fixed_GetRefCount(t)
...
def Handle_GeomFill_Frenet_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_Frenet_ForceRelease(t)

def Handle_GeomFill_Frenet_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_Frenet_GetRefCount(t)
...
def Handle_GeomFill_LocationDraft_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_LocationDraft_ForceRelease(t)

def Handle_GeomFill_LocationDraft_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_LocationDraft_GetRefCount(t)
...
def Handle_GeomFill_LocationGuide_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_LocationGuide_ForceRelease(t)

def Handle_GeomFill_LocationGuide_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_LocationGuide_GetRefCount(t)
...
def Handle_GeomFill_NSections_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_NSections_ForceRelease(t)

def Handle_GeomFill_NSections_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_NSections_GetRefCount(t)
...
def Handle_GeomFill_SimpleBound_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_SimpleBound_ForceRelease(t)

def Handle_GeomFill_SimpleBound_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_SimpleBound_GetRefCount(t)
...
def Handle_GeomFill_TgtOnCoons_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_TgtOnCoons_ForceRelease(t)

def Handle_GeomFill_TgtOnCoons_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_TgtOnCoons_GetRefCount(t)
...
def Handle_GeomFill_TrihedronWithGuide_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_TrihedronWithGuide_ForceRelease(t)

def Handle_GeomFill_TrihedronWithGuide_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_TrihedronWithGuide_GetRefCount(t)
...
def Handle_GeomFill_UniformSection_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_UniformSection_ForceRelease(t)

def Handle_GeomFill_UniformSection_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_UniformSection_GetRefCount(t)
...
def Handle_GeomFill_GuideTrihedronAC_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_GuideTrihedronAC_ForceRelease(t)

def Handle_GeomFill_GuideTrihedronAC_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_GuideTrihedronAC_GetRefCount(t)
...
def Handle_GeomFill_GuideTrihedronPlan_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_GuideTrihedronPlan_ForceRelease(t)

def Handle_GeomFill_GuideTrihedronPlan_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_GuideTrihedronPlan_GetRefCount(t)
...
def Handle_GeomFill_HArray1OfLocationLaw_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_HArray1OfLocationLaw_ForceRelease(t)

def Handle_GeomFill_HArray1OfLocationLaw_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_HArray1OfLocationLaw_GetRefCount(t)
...
def Handle_GeomFill_HArray1OfSectionLaw_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_HArray1OfSectionLaw_ForceRelease(t)

def Handle_GeomFill_HArray1OfSectionLaw_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_HArray1OfSectionLaw_GetRefCount(t)
...
def Handle_GeomFill_HSequenceOfAx2_ForceRelease(t):
    return _GeomFill.Handle_GeomFill_HSequenceOfAx2_ForceRelease(t)

def Handle_GeomFill_HSequenceOfAx2_GetRefCount(t):
    return _GeomFill.Handle_GeomFill_HSequenceOfAx2_GetRefCount(t)
