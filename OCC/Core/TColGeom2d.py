...
PYTHONOCC_DEBUG_EXCEPTIONS = _TColGeom2d.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TColGeom2d.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TColGeom2d.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TColGeom2d.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TColGeom2d.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TColGeom2d_HArray1OfBSplineCurve_ForceRelease(t):
    return _TColGeom2d.Handle_TColGeom2d_HArray1OfBSplineCurve_ForceRelease(t)

def Handle_TColGeom2d_HArray1OfBSplineCurve_GetRefCount(t):
    return _TColGeom2d.Handle_TColGeom2d_HArray1OfBSplineCurve_GetRefCount(t)
...
def Handle_TColGeom2d_HArray1OfBezierCurve_ForceRelease(t):
    return _TColGeom2d.Handle_TColGeom2d_HArray1OfBezierCurve_ForceRelease(t)

def Handle_TColGeom2d_HArray1OfBezierCurve_GetRefCount(t):
    return _TColGeom2d.Handle_TColGeom2d_HArray1OfBezierCurve_GetRefCount(t)
...
def Handle_TColGeom2d_HArray1OfCurve_ForceRelease(t):
    return _TColGeom2d.Handle_TColGeom2d_HArray1OfCurve_ForceRelease(t)

def Handle_TColGeom2d_HArray1OfCurve_GetRefCount(t):
    return _TColGeom2d.Handle_TColGeom2d_HArray1OfCurve_GetRefCount(t)
...
def Handle_TColGeom2d_HSequenceOfBoundedCurve_ForceRelease(t):
    return _TColGeom2d.Handle_TColGeom2d_HSequenceOfBoundedCurve_ForceRelease(t)

def Handle_TColGeom2d_HSequenceOfBoundedCurve_GetRefCount(t):
    return _TColGeom2d.Handle_TColGeom2d_HSequenceOfBoundedCurve_GetRefCount(t)
...
def Handle_TColGeom2d_HSequenceOfCurve_ForceRelease(t):
    return _TColGeom2d.Handle_TColGeom2d_HSequenceOfCurve_ForceRelease(t)

def Handle_TColGeom2d_HSequenceOfCurve_GetRefCount(t):
    return _TColGeom2d.Handle_TColGeom2d_HSequenceOfCurve_GetRefCount(t)
