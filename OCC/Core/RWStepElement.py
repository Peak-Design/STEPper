...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_rwstepelement.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _RWStepElement.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _RWStepElement.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _RWStepElement.get_readable_method_name(method_name)

def get_exception_type(error):
    return _RWStepElement.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _RWStepElement.process_opencascade_exception(error, method_name, class_name)
