...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_pcdm.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _PCDM.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _PCDM.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _PCDM.get_readable_method_name(method_name)

def get_exception_type(error):
    return _PCDM.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _PCDM.process_opencascade_exception(error, method_name, class_name)
...
def Handle_PCDM_ReadWriter_ForceRelease(t):
    return _PCDM.Handle_PCDM_ReadWriter_ForceRelease(t)

def Handle_PCDM_ReadWriter_GetRefCount(t):
    return _PCDM.Handle_PCDM_ReadWriter_GetRefCount(t)
...
def Handle_PCDM_Reader_ForceRelease(t):
    return _PCDM.Handle_PCDM_Reader_ForceRelease(t)

def Handle_PCDM_Reader_GetRefCount(t):
    return _PCDM.Handle_PCDM_Reader_GetRefCount(t)
...
def Handle_PCDM_ReaderFilter_ForceRelease(t):
    return _PCDM.Handle_PCDM_ReaderFilter_ForceRelease(t)

def Handle_PCDM_ReaderFilter_GetRefCount(t):
    return _PCDM.Handle_PCDM_ReaderFilter_GetRefCount(t)
...
def Handle_PCDM_ReferenceIterator_ForceRelease(t):
    return _PCDM.Handle_PCDM_ReferenceIterator_ForceRelease(t)

def Handle_PCDM_ReferenceIterator_GetRefCount(t):
    return _PCDM.Handle_PCDM_ReferenceIterator_GetRefCount(t)
...
def Handle_PCDM_Writer_ForceRelease(t):
    return _PCDM.Handle_PCDM_Writer_ForceRelease(t)

def Handle_PCDM_Writer_GetRefCount(t):
    return _PCDM.Handle_PCDM_Writer_GetRefCount(t)
...
def Handle_PCDM_ReadWriter_1_ForceRelease(t):
    return _PCDM.Handle_PCDM_ReadWriter_1_ForceRelease(t)

def Handle_PCDM_ReadWriter_1_GetRefCount(t):
    return _PCDM.Handle_PCDM_ReadWriter_1_GetRefCount(t)
...
def Handle_PCDM_RetrievalDriver_ForceRelease(t):
    return _PCDM.Handle_PCDM_RetrievalDriver_ForceRelease(t)

def Handle_PCDM_RetrievalDriver_GetRefCount(t):
    return _PCDM.Handle_PCDM_RetrievalDriver_GetRefCount(t)
...
def Handle_PCDM_StorageDriver_ForceRelease(t):
    return _PCDM.Handle_PCDM_StorageDriver_ForceRelease(t)

def Handle_PCDM_StorageDriver_GetRefCount(t):
    return _PCDM.Handle_PCDM_StorageDriver_GetRefCount(t)
