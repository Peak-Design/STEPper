...
PYTHONOCC_DEBUG_EXCEPTIONS = _Prs3d.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _Prs3d.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _Prs3d.get_readable_method_name(method_name)

def get_exception_type(error):
    return _Prs3d.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _Prs3d.process_opencascade_exception(error, method_name, class_name)
...
def Handle_Prs3d_BasicAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_BasicAspect_ForceRelease(t)

def Handle_Prs3d_BasicAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_BasicAspect_GetRefCount(t)
...
def Handle_Prs3d_Drawer_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_Drawer_ForceRelease(t)

def Handle_Prs3d_Drawer_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_Drawer_GetRefCount(t)
...
def Handle_Prs3d_PresentationShadow_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_PresentationShadow_ForceRelease(t)

def Handle_Prs3d_PresentationShadow_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_PresentationShadow_GetRefCount(t)
...
def Handle_Prs3d_ArrowAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_ArrowAspect_ForceRelease(t)

def Handle_Prs3d_ArrowAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_ArrowAspect_GetRefCount(t)
...
def Handle_Prs3d_DatumAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_DatumAspect_ForceRelease(t)

def Handle_Prs3d_DatumAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_DatumAspect_GetRefCount(t)
...
def Handle_Prs3d_DimensionAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_DimensionAspect_ForceRelease(t)

def Handle_Prs3d_DimensionAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_DimensionAspect_GetRefCount(t)
...
def Handle_Prs3d_LineAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_LineAspect_ForceRelease(t)

def Handle_Prs3d_LineAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_LineAspect_GetRefCount(t)
...
def Handle_Prs3d_PlaneAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_PlaneAspect_ForceRelease(t)

def Handle_Prs3d_PlaneAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_PlaneAspect_GetRefCount(t)
...
def Handle_Prs3d_PointAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_PointAspect_ForceRelease(t)

def Handle_Prs3d_PointAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_PointAspect_GetRefCount(t)
...
def Handle_Prs3d_ShadingAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_ShadingAspect_ForceRelease(t)

def Handle_Prs3d_ShadingAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_ShadingAspect_GetRefCount(t)
...
def Handle_Prs3d_TextAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_TextAspect_ForceRelease(t)

def Handle_Prs3d_TextAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_TextAspect_GetRefCount(t)
...
def Handle_Prs3d_IsoAspect_ForceRelease(t):
    return _Prs3d.Handle_Prs3d_IsoAspect_ForceRelease(t)

def Handle_Prs3d_IsoAspect_GetRefCount(t):
    return _Prs3d.Handle_Prs3d_IsoAspect_GetRefCount(t)
