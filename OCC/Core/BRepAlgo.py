...
PYTHONOCC_DEBUG_EXCEPTIONS = _BRepAlgo.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BRepAlgo.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BRepAlgo.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BRepAlgo.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BRepAlgo.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BRepAlgo_AsDes_ForceRelease(t):
    return _BRepAlgo.Handle_BRepAlgo_AsDes_ForceRelease(t)

def Handle_BRepAlgo_AsDes_GetRefCount(t):
    return _BRepAlgo.Handle_BRepAlgo_AsDes_GetRefCount(t)
