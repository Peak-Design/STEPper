...
PYTHONOCC_DEBUG_EXCEPTIONS = _TPrsStd.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _TPrsStd.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _TPrsStd.get_readable_method_name(method_name)

def get_exception_type(error):
    return _TPrsStd.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _TPrsStd.process_opencascade_exception(error, method_name, class_name)
...
def Handle_TPrsStd_AISPresentation_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_AISPresentation_ForceRelease(t)

def Handle_TPrsStd_AISPresentation_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_AISPresentation_GetRefCount(t)
...
def Handle_TPrsStd_AISViewer_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_AISViewer_ForceRelease(t)

def Handle_TPrsStd_AISViewer_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_AISViewer_GetRefCount(t)
...
def Handle_TPrsStd_Driver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_Driver_ForceRelease(t)

def Handle_TPrsStd_Driver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_Driver_GetRefCount(t)
...
def Handle_TPrsStd_DriverTable_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_DriverTable_ForceRelease(t)

def Handle_TPrsStd_DriverTable_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_DriverTable_GetRefCount(t)
...
def Handle_TPrsStd_AxisDriver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_AxisDriver_ForceRelease(t)

def Handle_TPrsStd_AxisDriver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_AxisDriver_GetRefCount(t)
...
def Handle_TPrsStd_ConstraintDriver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_ConstraintDriver_ForceRelease(t)

def Handle_TPrsStd_ConstraintDriver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_ConstraintDriver_GetRefCount(t)
...
def Handle_TPrsStd_GeometryDriver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_GeometryDriver_ForceRelease(t)

def Handle_TPrsStd_GeometryDriver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_GeometryDriver_GetRefCount(t)
...
def Handle_TPrsStd_NamedShapeDriver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_NamedShapeDriver_ForceRelease(t)

def Handle_TPrsStd_NamedShapeDriver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_NamedShapeDriver_GetRefCount(t)
...
def Handle_TPrsStd_PlaneDriver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_PlaneDriver_ForceRelease(t)

def Handle_TPrsStd_PlaneDriver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_PlaneDriver_GetRefCount(t)
...
def Handle_TPrsStd_PointDriver_ForceRelease(t):
    return _TPrsStd.Handle_TPrsStd_PointDriver_ForceRelease(t)

def Handle_TPrsStd_PointDriver_GetRefCount(t):
    return _TPrsStd.Handle_TPrsStd_PointDriver_GetRefCount(t)
