...
PYTHONOCC_DEBUG_EXCEPTIONS = _XCAFView.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _XCAFView.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _XCAFView.get_readable_method_name(method_name)

def get_exception_type(error):
    return _XCAFView.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _XCAFView.process_opencascade_exception(error, method_name, class_name)
...
def Handle_XCAFView_Object_ForceRelease(t):
    return _XCAFView.Handle_XCAFView_Object_ForceRelease(t)

def Handle_XCAFView_Object_GetRefCount(t):
    return _XCAFView.Handle_XCAFView_Object_GetRefCount(t)
