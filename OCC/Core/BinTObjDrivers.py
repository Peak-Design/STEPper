...
https://dev.opencascade.org/doc/occt-7.9.0/refman/html/package_bintobjdrivers.html
"""
...
PYTHONOCC_DEBUG_EXCEPTIONS = _BinTObjDrivers.PYTHONOCC_DEBUG_EXCEPTIONS

def get_readable_class_name(class_name):
    return _BinTObjDrivers.get_readable_class_name(class_name)

def get_readable_method_name(method_name):
    return _BinTObjDrivers.get_readable_method_name(method_name)

def get_exception_type(error):
    return _BinTObjDrivers.get_exception_type(error)

def process_opencascade_exception(error, method_name, class_name):
    return _BinTObjDrivers.process_opencascade_exception(error, method_name, class_name)
...
def Handle_BinTObjDrivers_DocumentRetrievalDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_DocumentRetrievalDriver_ForceRelease(t)

def Handle_BinTObjDrivers_DocumentRetrievalDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_DocumentRetrievalDriver_GetRefCount(t)
...
def Handle_BinTObjDrivers_DocumentStorageDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_DocumentStorageDriver_ForceRelease(t)

def Handle_BinTObjDrivers_DocumentStorageDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_DocumentStorageDriver_GetRefCount(t)
...
def Handle_BinTObjDrivers_IntSparseArrayDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_IntSparseArrayDriver_ForceRelease(t)

def Handle_BinTObjDrivers_IntSparseArrayDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_IntSparseArrayDriver_GetRefCount(t)
...
def Handle_BinTObjDrivers_ModelDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_ModelDriver_ForceRelease(t)

def Handle_BinTObjDrivers_ModelDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_ModelDriver_GetRefCount(t)
...
def Handle_BinTObjDrivers_ObjectDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_ObjectDriver_ForceRelease(t)

def Handle_BinTObjDrivers_ObjectDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_ObjectDriver_GetRefCount(t)
...
def Handle_BinTObjDrivers_ReferenceDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_ReferenceDriver_ForceRelease(t)

def Handle_BinTObjDrivers_ReferenceDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_ReferenceDriver_GetRefCount(t)
...
def Handle_BinTObjDrivers_XYZDriver_ForceRelease(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_XYZDriver_ForceRelease(t)

def Handle_BinTObjDrivers_XYZDriver_GetRefCount(t):
    return _BinTObjDrivers.Handle_BinTObjDrivers_XYZDriver_GetRefCount(t)
